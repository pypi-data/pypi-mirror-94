...
def get_auth(
        ...
        ehelply_entity_identifier: str = Header(None),
    ...
    :return:
    """
    from ehelply_microservice_library.integrations.access import AuthModel
    my_auth = AuthModel(access_sdk=get_access(request=request).sdk, entity_identifier=ehelply_entity_identifier, project_uuid=ehelply_project)
    m2m = get_m2m(request=request)
    ...
    if x_secret_token and x_access_token:
        ...
        entity = access.sdk.get_entity_for_key(key_uuid=key.uuid)
