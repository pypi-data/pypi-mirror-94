""" Utility classes and functions used by qa.torch_models (forked from the simpletransformers library) """
...
def write_predictions_extended(
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        scores_diff_json[example.qas_id] = score_diff
        # note: always predict best_non_null_entry
...
def get_best_predictions(
    ...
    all_best = [
        {"id": id, "answer": answers[0]["text"], "probability": answers[0]["probability"]}
