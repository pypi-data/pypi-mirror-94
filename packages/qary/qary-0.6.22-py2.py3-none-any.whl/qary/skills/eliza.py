...
ELIZA_PATH = os.path.join(DATA_DIR, 'eliza_doctor.txt')
...
class Eliza:
    ...
    def respond(self, text):
        """ generate conversational responses to a user question or statement

        key/value will start at reasmb_index = 0 and will retrieve next value if key is repeated.
        >>> e = Eliza()
        >>> e.load(ELIZA_PATH)
        >>> e.respond("Perhaps this test will work.")
        "You don't seem quite certain."
        >>> e.respond("Perhaps this test will work too.")
        'Why the uncertain tone ?'
        >>> e.respond("Do you remember that time you helped me with my doctest")
        'Did you think I would forget that time I helped you with your doctest ?'
        >>> e.respond(None).split()[0] in "I'm Please Do What".split()
        True
        """
        if (text or '').lower() in self.quits:
            return None
...
class Skill:
    ...
    >>> b = Skill()
    >>> b.reply('Hello!')
    [BotReply(confidence=0.5, text="I'm not sure I understand you fully."...
    >>> b.reply('What should we talk about?')
    [BotReply(confidence=0.5, text='Why do you ask ?'...
    >>> b.reply("I'm super manic right now.")
    [BotReply(confidence=0.5, text='Is it because you are super manic right now that you came to me ?'...
    """
    name = os.path.basename(__file__)

    def __init__(self):
        self.eliza = Eliza()
        self.eliza.load(ELIZA_PATH)
    ...
    def reply(self, statement, context=None):
        ...
        >>> b = Skill()
        >>> b.reply('Hello Eliza')
        [BotReply(confidence=0.5, text='How do you do. Please state your problem.'...
        >>> b.reply('I am sad.')
        [BotReply(confidence=0.5, text='I am sorry to hear that you are sad .'...
        >>> b.reply("&%$nonsense!#%")
        [BotReply(confidence=0.5, text="I'm not sure I understand you fully."...
        """
        responses = []
