...
class LearningModule:
    ...
    def calculate_scored_points(self):
        ...
        for task in self.task_dict.values():
            ...
            if isinstance(task, (SingleChoiceTask, MultipleChoiceTask)):
                ...
                task_points = task.calculate_scored_points(solution_btn_available=True)
            self.scored_points += task_points
            self.task_points_dict['Aufgabe ' + str(task.task_id)] = str(task_points) + ' Punkte'
    ...
    def get_score(self):
        """Returns the overall score so that it can be transmitted to the learning platform
        """
