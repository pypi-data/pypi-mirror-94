...
class TestEndpoints(unittest.TestCase):
    ...
    def testUserEndpointManuscripts(self):
        self.assertEqual('59ef0bd5-3771-4ef7-a2b8-fe7c66966a9f', self.client.user.manuscripts()[0]['id'])
    ...
    def testManuscriptEndpointExport(self):
        manuscript = self.client.user.manuscripts(self.client.user.authenticated_user_id)[0]
        manuscript_export = self.client.manuscript.export(manuscript['id'])
        self.assertTrue(isinstance(manuscript_export, Dict))
    ...
    def testManuscript(self):
        manuscript = [x for x in self.user.manuscripts()][0]
        user = manuscript.author
