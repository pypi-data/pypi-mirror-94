...
class NAFDocument:
    ...
    def __init__(self, file_name=None, input_stream=None, language=None,
        ...
        if headers is not None and len(headers):
            ...
            # create naf header element and put it in the beginning of
            # the document
    ...
    def add_linguistic_processors(self, layer, name, version, begin_timestamp,
        ...
        :param hostname: name of the processing machine
    ...
    def add_word(self, word, wid, **kwargs):
        ...
        A word has the next parameters/attributes;
    ...
    def add_term(self, tid, pos=None, lemma=None, morphofeat=None,
        ...
        A Term has the next parameters/attributes:
        :param tid: a unique identifier
    ...
    def add_dependency(self, origen, to, rfunc):
        ...
        The dependency has the next parameters/attributes:
    ...
    def _indent(self, elem, level=0):
        ...
        if len(elem):
            ...
            # This seeks for the last child processed in for, is not a code
            # indentation error
    ...
    def validate_external_dtd(self, source):
    ...
    def write(self, output, encoding=None):
        """Write the document into a file.
        :param output: The output target for the document. Maybe a file type object, or a file name.
        :param encoding: The encoding of the output.
        """
        output.write(self.__str__(encoding=encoding))

    def __str__(self, encoding=None):
        if not encoding:
            encoding = self.encoding
        self._indent(self.root)
        return etree.tostring(self.root).decode(encoding)
