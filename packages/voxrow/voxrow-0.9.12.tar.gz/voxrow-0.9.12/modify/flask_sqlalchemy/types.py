...
class Password(TypeDecorator):
    ...
    def copy(self, **kw):
        return Password(self.impl.length)
    ...
    @classmethod
    def is_correct(cls, encrypted_password, password):
...
class Username(TypeDecorator):
    ...
    def process_bind_param(self, value, dialect):
        return Username.correction(value)

    def copy(self, **kw):
        return Username(self.impl.length)
