...
class Object(Bus):
    ...
    def eveloop_dispatch(self, detailed_signal, args):
        ...
        if self.__class__.__name__ in GLXCurses.GLXC.CHILDREN_CONTAINER:
            ...
            if (
                    hasattr(self, "child") and
                    self.child and
                    hasattr(self.child, "widget") and
                    self.child.widget and
                    hasattr(self.child.widget, "events_dispatch") and
                    self.child.widget.events_dispatch
            ):
