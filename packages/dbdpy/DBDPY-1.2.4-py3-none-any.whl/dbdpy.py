		...
		while "$getVar"+bot._style[0] in line:
			if nowloop==line:
				...
				try:
					...
					try:
						line=line.replace("$getVar"+bot._style[0]+line.split("$getVar"+bot._style[0])[-1].split(bot._style[1])[0]+bot._style[1],bot._db.get("global",line.split("$getVar"+bot._style[0])[-1].split(bot._style[1])[0].split(qbot._separator)[0],str(author.id)))
					except:
						break
		while "$getServerVar"+bot._style[0] in line:
			if nowloop==line:
				...
				try:
					...
					try:
						line=line.replace("$getServerVar"+bot._style[0]+line.split("$getServerVar"+bot._style[0])[-1].split(bot._style[1])[0]+bot._style[1],bot._db.get("server",line.split("$getServerVar"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[0],str(guild.id)))
					except:
						break
			...
			if nowloop==line:
				...
				try:
					...
					try:
						...
						try:
							line=line.replace("$getUserVar"+bot._style[0]+line.split("$getUserVar"+bot._style[0])[-1].split(bot._style[1])[0]+bot._style[1],bot._db.get("user",line.split("$getUserVar"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[0],str(author.id), str(guild.id)))
						except:
							break
		return line
		...
		while "$leaderboard"+bot._style[0] in line:
			if nowloop==line:
				...
				try:
					...
					topos=1
					topstr=""
					if line.split("$leaderboard"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[0]=="user":
						data=bot._db.data[line.split("$leaderboard"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[0]][line.split("$leaderboard"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[1].split("&")[1]]
					else:
						data=bot._db.data[line.split("$leaderboard"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[0]]
					for u in data:
						try:
							top[str(u)]=data[u][line.split("$leaderboard"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[1].split("&")[0]]
							topos+=1
						except:
							pass
					...
					for t, u in top:
						try:
							if topos<=int(line.split("$leaderboard"+bot._style[0])[-1].split(bot._style[1])[0].split(bot._separator)[2]):
				...
				if go==0:
					...
					try:
						...
						if line.startswith("$cooldown"+bot._style[0]):
							...
							await ctx.send(file=discord.File(bot._db.path+"vars.json"))
							...
							if line[-1]==bot._style[1]:
								...
								try:
									...
									bot._db.set("server",line[0],line[1],str(guild.id))
							...
							if line[-1]==bot._style[1]:
								...
								try:
									...
									bot._db.set("global",line[0],line[1],str(author.id))
							...
							if line[-1]==bot._style[1]:
								...
								try:
									...
									try:
										bot._db.set("user",line[0],line[1],line[2],str(guild.id))
									except:
										bot._db.set("user",line[0],line[1],str(author.id),str(guild.id))
