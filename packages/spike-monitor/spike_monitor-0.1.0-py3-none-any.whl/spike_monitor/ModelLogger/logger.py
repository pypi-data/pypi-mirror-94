from base_models import Log_info, Prediction, LogInput, LogPrediction, LogPredictionError
...
class Logger():
    ...
    def __init__(self,
        ...
        self.client = google.cloud.logging.Client(project=str(project_name))
    ...
    def log_input(self, input_data:dict, input_type:str):
        ...
        self.client.log_struct(log.dict())
    ...
    def log_prediction(self, 
        ...
        self.client.log_struct(model_id, log.dict())
        pass
