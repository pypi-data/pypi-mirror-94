...
sys.path.insert(0, os.path.join(__location__, "../opendebates"))
...
module_dir = os.path.join(__location__, "../plugins")
try:
...
# documentation.
html_theme_options = {"style_nav_header_background": "#3A435E"}
...
try:
    from OpenDebates import __version__ as version
except ImportError:
    pass
else:
    release = version
...
# of the sidebar.
html_logo = "_static/OpenDebatesLogo.png"
...
htmlhelp_basename = "opendebates-doc"
