...
class Audio(object):
    ...
    def de_json(cls, json_str: dict):
        ...
        performer = json_obj.get("performer")
        ...
        if json_obj.get("thumb") is not None:
            ...
            thumb = None
        return cls(file_id, file_unique_id, duration, performer, title, file_name,
                   mime_type, file_size, thumb)

    def __init__(self, file_id, file_unique_id, duration, performer, title, file_name,
                 mime_type, file_size, thumb):
