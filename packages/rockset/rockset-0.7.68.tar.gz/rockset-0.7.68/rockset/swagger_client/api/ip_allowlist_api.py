...
class IPAllowlistApi(object):
    ...
    def create(self, body, **kwargs):  # noqa: E501
        """Create IP Allowlist Network Policy  # noqa: E501

        Create a new entry to allow an IP address  # noqa: E501
        ...
        :param CreateIpAllowlistRequest body: JSON object (required)
    ...
    def create_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/orgs/self/ip/allowlist', 'POST',
            body_params,
            path_params,
            query_params,
            header_params,
            ...
            response_type='CreateIpAllowlistResponse',  # noqa: E501
    ...
    def delete(self, name, **kwargs):  # noqa: E501
        """Delete IP Allowlist Network Policy  # noqa: E501

        Delete an entry for IP allowlist network policy.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str name: name of the IP allowlist network policy (required)
    ...
    def delete_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/orgs/self/ip/allowlist/{name}', 'DELETE',
            body_params,
            path_params,
            query_params,
            header_params,
            post_params=form_params,
            files=local_var_files,
            response_type='DeleteIpAllowlistResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get(self, name, **kwargs):  # noqa: E501
        """Get IP Allowlist Network Policy  # noqa: E501

        Get details about a IP Allowlist network policy  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get(name, async=True)
        >>> result = thread.get()
    ...
    def get_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/orgs/self/ip/allowlist/{name}', 'GET',
            body_params,
            path_params,
            query_params,
            header_params,
            post_params=form_params,
            files=local_var_files,
            response_type='GetIpAllowlistResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list(self, **kwargs):  # noqa: E501
        """List IP Allowlist Entries  # noqa: E501
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListIpAllowlistsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
