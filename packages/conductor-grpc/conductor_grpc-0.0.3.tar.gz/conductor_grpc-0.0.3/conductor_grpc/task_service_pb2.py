...
# source: conductor_grpc/task_service.proto
...
from model import taskexeclog_pb2 as model_dot_taskexeclog__pb2
from model import taskresult_pb2 as model_dot_taskresult__pb2
from model import task_pb2 as model_dot_task__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='conductor_grpc/task_service.proto',
...
_POLLRESPONSE.fields_by_name['task'].message_type = model_dot_task__pb2._TASK
_TASKSINPROGRESSRESPONSE.fields_by_name['tasks'].message_type = model_dot_task__pb2._TASK
_PENDINGTASKRESPONSE.fields_by_name['task'].message_type = model_dot_task__pb2._TASK
_UPDATETASKREQUEST.fields_by_name['result'].message_type = model_dot_taskresult__pb2._TASKRESULT
_GETTASKLOGSRESPONSE.fields_by_name['logs'].message_type = model_dot_taskexeclog__pb2._TASKEXECLOG
_GETTASKRESPONSE.fields_by_name['task'].message_type = model_dot_task__pb2._TASK
...
PollRequest = _reflection.GeneratedProtocolMessageType('PollRequest', (_message.Message,), {
  ...
  '__module__' : 'conductor_grpc.task_service_pb2'
...
_TASKSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=model_dot_task__pb2._TASK,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
