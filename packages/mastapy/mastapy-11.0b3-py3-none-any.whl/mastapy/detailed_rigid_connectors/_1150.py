...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def two_d_spline_drawing(self) -> '_7191.SMTBitmap':
        ...
        return constructor.new(_7191.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None
