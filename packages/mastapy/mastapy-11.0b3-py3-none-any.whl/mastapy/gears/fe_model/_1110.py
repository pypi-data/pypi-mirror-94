...
from mastapy.gears.fe_model import _1108, _1107
...
class GearSetFEModel(_1138.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1108.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1108.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1107.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1107.GearFEModel))
        return value
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7186.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
