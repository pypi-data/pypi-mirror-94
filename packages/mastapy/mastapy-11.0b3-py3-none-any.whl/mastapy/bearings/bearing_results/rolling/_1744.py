...
class LoadedTaperRollerBearingRow(_1719.LoadedNonBarrelRollerBearingRow):
    ...
    @property
    def major_rib_normal_contact_stress(self) -> '_7191.SMTBitmap':
        ...
        return constructor.new(_7191.SMTBitmap)(self.wrapped.MajorRibNormalContactStress) if self.wrapped.MajorRibNormalContactStress else None
