...
class ConcentricPartGroupCombinationSystemDeflectionResults(_0.APIBase):
    ...
    @property
    def two_d_drawing(self) -> '_7191.SMTBitmap':
        ...
        return constructor.new(_7191.SMTBitmap)(self.wrapped.TwoDDrawing) if self.wrapped.TwoDDrawing else None

    @property
    def shaft_deflections_in_view_coordinate_system(self) -> 'List[_1920.ConcentricPartGroupCombinationSystemDeflectionShaftResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionsInViewCoordinateSystem, constructor.new(_1920.ConcentricPartGroupCombinationSystemDeflectionShaftResults))
        return value
