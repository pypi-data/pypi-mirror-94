...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2507
...
class CylindricalGearMeshSystemDeflection(_2421.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def chart_of_effective_change_in_operating_centre_distance(self) -> '_7191.SMTBitmap':
        ...
        return constructor.new(_7191.SMTBitmap)(self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance) if self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance else None
    ...
    @property
    def power_flow_results(self) -> '_3740.CylindricalGearMeshPowerFlow':
        ...
        return constructor.new(_3740.CylindricalGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_415.CylindricalGearMeshRating':
        ...
        return constructor.new(_415.CylindricalGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
    ...
    @property
    def gear_a(self) -> '_2409.CylindricalGearSystemDeflection':
        ...
        if _2409.CylindricalGearSystemDeflection.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2410.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2410.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2411.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2411.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_a_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2412.CylindricalPlanetGearSystemDeflection':
        ...
        if _2412.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_b(self) -> '_2409.CylindricalGearSystemDeflection':
        ...
        if _2409.CylindricalGearSystemDeflection.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2410.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2410.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2411.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2411.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def gear_b_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2412.CylindricalPlanetGearSystemDeflection':
        ...
        if _2412.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2409.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2409.CylindricalGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2507.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2507.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2507.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2507.MeshDeflectionResults))
        return value
