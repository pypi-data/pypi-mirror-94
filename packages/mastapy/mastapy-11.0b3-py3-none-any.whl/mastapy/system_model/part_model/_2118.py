...
from mastapy.math_utility import _1260, _1261
from mastapy.system_model.connections_and_sockets import (
    _1946, _1967, _1948, _1972
)
from mastapy.system_model.part_model import _2119, _2141
...
class Component(_2141.Part):
    ...
    @property
    def two_d_drawing_full_model(self) -> '_7191.SMTBitmap':
        ...
        return constructor.new(_7191.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def local_coordinate_system(self) -> '_1260.CoordinateSystem3D':
        ...
        return constructor.new(_1260.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None

    @property
    def component_connections(self) -> 'List[_1946.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1946.ComponentConnection))
        return value
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_1967.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1260.CoordinateSystem3D') -> '_1967.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1967.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1261.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1948.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1948.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_1972.Socket') -> 'List[_1972.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_1972.Socket))

    def connect_to_socket(self, socket: '_1972.Socket') -> '_2119.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_1972.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_1972.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2119.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2119.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
    ...
    def can_delete_connection(self, connection: '_1948.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_1972.Socket':
