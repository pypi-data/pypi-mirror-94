...
from mastapy.system_model.fe import (
    _2038, _2061, _2084, _2032,
    _2034, _2059, _2082, _2060,
    _2056, _2068, _2069, _2067,
    _2064, _2065, _2066
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2122, _2118, _2126
from mastapy.nodal_analysis import _63, _55, _59
from mastapy.nodal_analysis.component_mode_synthesis import _195
from mastapy.nodal_analysis.space_claim_link import _118
from mastapy.system_model import _1900
from mastapy.math_utility import _1260
from mastapy.materials import _204, _246
from mastapy.system_model.part_model.shaft_model import _2154
from mastapy.system_model.fe.links import _2091
from mastapy.math_utility.measured_vectors import _1327
from mastapy import _7186
...
class FESubstructure(_59.FEStiffness):
    '''FESubstructure
    ...
    @property
    def bearing_node_alignment(self) -> '_2038.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2038.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2038.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2032.AlignmentMethod':
        ...
        return constructor.new(_2032.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2032.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gravity_force_source(self) -> '_63.GravityForceSource':
        ...
        return constructor.new(_63.GravityForceSource)(value) if value else None
    ...
    @property
    def cms_model(self) -> '_195.CMSModel':
        ...
        return constructor.new(_195.CMSModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def space_claim_dimensions(self) -> '_118.SpaceClaimDimensions':
        ...
        return constructor.new(_118.SpaceClaimDimensions)(self.wrapped.SpaceClaimDimensions) if self.wrapped.SpaceClaimDimensions else None

    @property
    def alignment_to_component(self) -> '_1900.RelativeComponentAlignment[_2118.Component]':
        ...
        return constructor.new(_1900.RelativeComponentAlignment)[_2118.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2034.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2034.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1260.CoordinateSystem3D':
        ...
        return constructor.new(_1260.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_2059.FESubstructureExportOptions':
        ...
        return constructor.new(_2059.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def acoustic_radiation_efficiency(self) -> '_204.AcousticRadiationEfficiency':
        ...
        return constructor.new(_204.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None

    @property
    def sound_pressure_enclosure(self) -> '_246.SoundPressureEnclosure':
        ...
        return constructor.new(_246.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2082.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2082.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2154.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2154.Shaft))
        return value

    @property
    def links(self) -> 'List[_2091.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2091.FELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1327.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1327.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1327.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1327.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_2056.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2056.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2068.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2068.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2069.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2069.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2126.FEPart':
        ...
        return constructor.new(_2126.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7186.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2067.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2064.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2065.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2066.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_148.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7186.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2060.FESubstructureNode') -> 'List[_2091.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2091.FELink))
