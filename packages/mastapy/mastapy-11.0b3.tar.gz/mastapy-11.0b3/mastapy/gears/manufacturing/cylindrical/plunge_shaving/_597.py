...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _589, _595
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    @property
    def profile_modification_on_conjugate_shaver_chart_left_flank(self) -> '_7191.SMTBitmap':
        ...
        return constructor.new(_7191.SMTBitmap)(self.wrapped.ProfileModificationOnConjugateShaverChartLeftFlank) if self.wrapped.ProfileModificationOnConjugateShaverChartLeftFlank else None

    @property
    def profile_modification_on_conjugate_shaver_chart_right_flank(self) -> '_7191.SMTBitmap':
        ...
        return constructor.new(_7191.SMTBitmap)(self.wrapped.ProfileModificationOnConjugateShaverChartRightFlank) if self.wrapped.ProfileModificationOnConjugateShaverChartRightFlank else None
    ...
    @property
    def calculation_details(self) -> '_595.PlungeShaverGeneration':
        ...
        return constructor.new(_595.PlungeShaverGeneration)(self.wrapped.CalculationDetails) if self.wrapped.CalculationDetails else None
