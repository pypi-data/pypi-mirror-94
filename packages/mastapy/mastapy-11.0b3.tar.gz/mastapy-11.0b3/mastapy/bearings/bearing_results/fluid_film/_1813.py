...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1585.BearingRow':
        ...
        return constructor.new(_1585.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_7191.SMTBitmap':
        ...
        return constructor.new(_7191.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
