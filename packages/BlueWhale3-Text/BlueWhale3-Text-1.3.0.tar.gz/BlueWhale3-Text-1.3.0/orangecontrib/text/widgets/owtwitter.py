...
class OWTwitter(OWWidget):
    class APICredentialsDialog(OWWidget):
        ...
        def __init__(self, parent):
            ...
            self.submit_button = gui.button(self.controlArea, self, __("dialog.btn_ok"),
                                            self.accept)
    ...
    tweets_info = __("msg.tweets_info")
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Set API key button
        gui.button(self.controlArea, self, __("btn_twitter_api_key"),
        ...
        # Query input
        add_row(__("row.query_word_list"),
                ListEdit(self, 'word_list',
                         __("placeholder_multiple_line"), 80, self))

        # Search mode
        add_row(__("row.search_by"),
