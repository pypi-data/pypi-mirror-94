...
class OWCorpus(OWWidget, ConcurrentWidgetMixin):
    ...
    def __init__(self):
        ...
        ubox = gui.widgetBox(fbox, __("box.use_text_feature"), addSpace=False)
        ...
        ibox = gui.widgetBox(fbox, __("box.ignore_text_feature"), addSpace=False)
