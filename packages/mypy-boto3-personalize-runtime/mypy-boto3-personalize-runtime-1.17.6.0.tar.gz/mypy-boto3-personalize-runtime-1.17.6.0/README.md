...
[boto3.PersonalizeRuntime 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/personalize-runtime.html#PersonalizeRuntime) service
compatible with
