...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x0bprint.proto\x12\x10mindspore.prntpb\"H\n\x0bTensorProto\x12\x0c\n\x04\x64ims\x18\x01 \x03(\x03\x12\x13\n\x0btensor_type\x18\x02 \x02(\t\x12\x16\n\x0etensor_content\x18\x03 \x02(\x0c\"\x88\x01\n\x05Print\x12,\n\x05value\x18\x01 \x03(\x0b\x32\x1d.mindspore.prntpb.Print.Value\x1aQ\n\x05Value\x12\x0e\n\x04\x64\x65sc\x18\x01 \x01(\tH\x00\x12/\n\x06tensor\x18\x02 \x01(\x0b\x32\x1d.mindspore.prntpb.TensorProtoH\x00\x42\x07\n\x05value')
)
...
_TENSORPROTO = _descriptor.Descriptor(
  name='TensorProto',
  full_name='mindspore.prntpb.TensorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dims', full_name='mindspore.prntpb.TensorProto.dims', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='tensor_type', full_name='mindspore.prntpb.TensorProto.tensor_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tensor_content', full_name='mindspore.prntpb.TensorProto.tensor_content', index=2,
...
_PRINT_VALUE = _descriptor.Descriptor(
  name='Value',
  full_name='mindspore.prntpb.Print.Value',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='desc', full_name='mindspore.prntpb.Print.Value.desc', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='mindspore.prntpb.Print.Value.tensor', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='mindspore.prntpb.Print.Value.value',
...
_PRINT = _descriptor.Descriptor(
  name='Print',
  full_name='mindspore.prntpb.Print',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='mindspore.prntpb.Print.value', index=0,
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:mindspore.prntpb.TensorProto)
  })
...
Print = _reflection.GeneratedProtocolMessageType('Print', (_message.Message,), {
  ...
  'Value' : _reflection.GeneratedProtocolMessageType('Value', (_message.Message,), {
    ...
    '__module__' : 'print_pb2'
    # @@protoc_insertion_point(class_scope:mindspore.prntpb.Print.Value)
    })
  ,
  'DESCRIPTOR' : _PRINT,
  '__module__' : 'print_pb2'
  # @@protoc_insertion_point(class_scope:mindspore.prntpb.Print)
  })
