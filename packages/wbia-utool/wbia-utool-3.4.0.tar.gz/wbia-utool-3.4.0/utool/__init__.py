...
IMPORT_TUPLES = [
    ...
    ('util_arg', ['get_argval', 'get_argflag', 'argv_flag_dec', 'QUIET', 'VERBOSE']),
    ('util_assert', None),
    ('util_autogen', None),
    ...
    ('util_dev', ['get_stats_str', 'get_stats', 'myprint', 'get_object_nbytes']),
    (
        'util_decor',
        [
            'ignores_exc_tb',
    ...
    ('util_ipynb', None),
    ('util_logging', None),
    ('util_list', ['alloc_lists', 'list_index', 'npfind', 'index_of', 'flatten']),
    ('util_num', None),
    ('util_numpy', None),
    (
        'util_path',
