...
class AffiliationRetrieval(Retrieval):
    ...
    def __init__(self, aff_id, refresh=False, view="STANDARD"):
        ...
        view : str (optional, default=STANDARD)
            ...
            BASIC, LIGHT, STANDARD, where LIGHT includes all information
            of BASIC view and STANDARD includes all information of the
        ...
        """
        # Checks
        check_parameter_value(view, ('BASIC', 'LIGHT', 'STANDARD'), "view")
