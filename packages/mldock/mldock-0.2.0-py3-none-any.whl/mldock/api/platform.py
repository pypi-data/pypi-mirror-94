...
def generic_init(dir, helper_library_path, mldock_config, testing_framework, service, container_only):
    ...
    # generic copy
    if container_only:
        logger.info("Setting up container in workspace")
        _copy_boilerplate_to_dst(os.path.join(template_dir,'src/container/'), container_directory)
    else:
...
def sagemaker_init(dir, helper_library_path, mldock_config, no_prompt, testing_framework, service, container_only):
