...
['micone',
 ...
 'micone.pipelines.src.network_inference.network.make_network.processes',
...
{'': ['*'],
 ...
 'micone.pipelines': ['envs/micone-dada2/*',
                      ...
                      'src/network_inference/direct/daa/*',
                      'src/network_inference/direct/magma/*',
                      'src/network_inference/direct/magma/processes/*',
                      ...
                      'src/network_inference/network/make_network/*',
