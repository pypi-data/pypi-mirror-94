...
class StickProtocol():
    ...
    def get_pre_key_bundle(self, data, user_id):
        """
    ...
    def get_pre_key_bundles(self, currentUser, users_id):
        ...
        # else:
        #     users_id = Group.objects.get(id=data["group_id"]).get_all_users_ids()
    ...
    def verify_password_and_get_keys(self, data, user):
        ...
        if user.check_password(data['password']):
            ...
            user.save()
            # LimitedAccessToken.objects.get(phone=data['phone']).delete()
