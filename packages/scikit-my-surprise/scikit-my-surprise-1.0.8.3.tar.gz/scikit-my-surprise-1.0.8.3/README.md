**MySurprise** is simply @nicolashug 's [Surprise](http://surpriselib.com) with an online version of the SVD algorithm, as well as a few changes to data types to allow for floating-point rankings in some algorithms. 
