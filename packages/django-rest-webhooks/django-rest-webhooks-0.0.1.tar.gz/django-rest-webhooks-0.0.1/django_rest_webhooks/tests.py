...
from django_rest_webhooks import models, config, utils
from django_rest_webhooks import signals
from django_rest_webhooks.admin import HookForm
...
class RESTHooksTest(TestCase):
    ...
    @patch('django_rest_webhooks.models.client.post', autospec=True)
    ...
    @patch('django_rest_webhooks.models.client.post')
    ...
    @override_settings(HOOK_CUSTOM_MODEL='django_rest_webhooks.models.Hook')
