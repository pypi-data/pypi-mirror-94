...
class ContainerTransferDestinationContentsItem:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ContainerTransferDestinationContentsItem":
        d = src_dict.copy()
        container_transfer_destination_contents_item = ContainerTransferDestinationContentsItem()
