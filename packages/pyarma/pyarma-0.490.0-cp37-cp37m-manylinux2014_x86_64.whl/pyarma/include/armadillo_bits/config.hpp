...
#define ARMA_USE_HDF5_ALT
  ...
  #define ARMA_HDF5_INCLUDE_DIR /usr/local/include/
#endif
...
#define ARMA_AUX_LIBS /usr/local/lib/libopenblas.so;/usr/local/lib/libhdf5.so
#define ARMA_AUX_INCDIRS /usr/local/include

// 'tripwire' to confirm that this is an embedded version of Armadilllo
#define ARMA_TRIPWIRE
