...
[boto3.MarketplaceMetering 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/meteringmarketplace.html#MarketplaceMetering) service
compatible with
