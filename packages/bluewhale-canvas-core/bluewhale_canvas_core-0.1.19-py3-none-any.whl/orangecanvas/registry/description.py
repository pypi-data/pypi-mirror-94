...
class InputSignal(object):
    ...
    def __init__(self, name, type, handler, flags=Single + NonDefault,
                 id=None, doc=None, replaces=(), label=None):
...
class WidgetDescription(object):
    ...
    def __init__(self, name, id, category=None, version=None,
        ...
        if not qualified_name:
            ...
            raise ValueError(__("err_tip.supply_name"))
        ...
        inputs = [
            InputSignal(
                ...
                i.doc, i.replaces, label=i.label
            )
            for i in inputs
        ]
        outputs = [
...
class CategoryDescription(object):
    ...
    def __init__(self, name=None, version=None,
                 ...
                 icon=None, background=None, hidden=False, label=None
                 ):
        self.name = name
        self.version = version
        self.description = description
