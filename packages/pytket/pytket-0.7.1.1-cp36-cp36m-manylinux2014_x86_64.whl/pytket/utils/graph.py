...
class Graph:
    ...
    def save_DAG(self, name: str, format: str = "pdf") -> None:
        """
    ...
    def view_qubit_graph(self) -> None:
        """
    ...
    def save_qubit_graph(self, name: str, format: str = "pdf") -> None:
        """
