...
class Backend(ABC):
    ...
    def characterisation(self) -> Optional[dict]:
        ...
        :return: The characterisation that this backend targets if it exists. The characterisation
            object contains device-specific information such as gate error rates.
        :rtype: Optional[dict]
        """
    ...
    def __extension_name__(self) -> Optional[str]:
        """Retrieve the extension name of the backend if it belongs to a pytket-extension
        package.
    ...
    def __extension_version__(self) -> Optional[str]:
        """Retrieve the extension version of the backend if it belongs to a pytket-extension
        package.

        :return: The extension version of the backend if it belongs to a pytket-extension
            package.
        :rtype: Optional[str]
        """
        try:
