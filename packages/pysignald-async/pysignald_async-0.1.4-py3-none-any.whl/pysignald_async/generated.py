...
class SignaldGeneratedAPI(JSONProtocol):
    ...
    async def mark_read(
        ...
        timestamps: List of messages to mark as read. Example: 1612746778552
        """
    ...
    async def get_profile(
        ...
        account: the signald account to use.
        async_: return results from local store immediately, refreshing from server if needed. If false (default), block until all pending profiles have been retrieved..
