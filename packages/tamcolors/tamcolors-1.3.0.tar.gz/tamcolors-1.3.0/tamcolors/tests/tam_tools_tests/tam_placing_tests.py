...
class TAMPlacingTests(unittest.TestCase):
    ...
    def test__get_dimensions_wrapper_2(self):
        ...
        def func(x, y, w, h):
            return x, y, w, h
        self.assertEqual(func(1, 2, None, None, tam_io.tam_surface.TAMSurface(3, 4, "c", GRAY, LIGHT_RED)), (1, 2, 3, 4))

    def test__get_dimensions_wrapper_3(self):
        @tam_tools.tam_placing._get_dimensions
        def func(x, y, w, h):
            return x, y, w, h
        self.assertEqual(func(1, 2, 12, 15, tam_io.tam_surface.TAMSurface(30, 40, "c", GRAY, LIGHT_RED)), (1, 2, 30, 40))
