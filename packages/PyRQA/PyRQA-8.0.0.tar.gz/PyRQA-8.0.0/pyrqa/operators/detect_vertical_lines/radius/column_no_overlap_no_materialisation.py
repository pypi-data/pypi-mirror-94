...
def detect_vertical_lines(settings,
    ...
    :param return_vectors_buffers: Shall the OpenCL vectors buffers be returned? (Default: False)
    :return: return_vectors_buffers==False: Runtimes / return_vectors_buffers==True: OpenCL vectors buffer X dimension, OpenCL vectors buffer Y dimension, runtimes.
    """
