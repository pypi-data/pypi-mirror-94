...
def detect_vertical_lines(settings,
    ...
    :param return_vectors_buffers: Shall the OpenCL vector buffers be returned? (Default: False)
    :return: return_vectors_buffers==False: Runtimes / return_vectors_buffers==True: OpenCL vector buffer X dimension, OpenCL vector buffer X dimension, runtimes.
    """
    ...
    if return_vectors_buffers:
        return vectors_x_buffer, \
               vectors_y_buffer, \
               runtimes
