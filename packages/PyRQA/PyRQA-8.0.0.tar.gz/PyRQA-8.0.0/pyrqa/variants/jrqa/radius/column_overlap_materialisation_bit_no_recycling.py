...
from pyrqa.operators.create_matrix.radius.column_overlap_materialisation_bit import create_matrix
...
class ColumnOverlapMaterialisationBitNoRecycling(SettableSettings,
                                                 TimeSeriesVariant):
    """
