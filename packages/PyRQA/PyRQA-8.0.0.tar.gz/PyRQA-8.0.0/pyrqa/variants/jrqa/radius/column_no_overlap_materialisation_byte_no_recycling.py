...
from pyrqa.operators.create_matrix.radius.column_no_overlap_materialisation_byte import create_matrix
...
class ColumnNoOverlapMaterialisationByteNoRecycling(SettableSettings,
                                                    TimeSeriesVariant,
                                                    EmbeddedSeriesVariant):
    """
