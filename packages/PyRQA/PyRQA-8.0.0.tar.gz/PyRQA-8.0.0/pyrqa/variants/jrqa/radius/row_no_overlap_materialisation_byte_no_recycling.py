...
from pyrqa.operators.create_matrix.radius.row_no_overlap_materialisation_byte import create_matrix
...
class RowNoOverlapMaterialisationByteNoRecycling(SettableSettings,
                                                 TimeSeriesVariant,
                                                 EmbeddedSeriesVariant):
    """
