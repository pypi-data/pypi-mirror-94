...
from pyrqa.operators.detect_vertical_lines.radius.row_no_overlap_materialisation_bit_recycling import \
...
class RowNoOverlapMaterialisationBitRecycling(SettableSettings,
                                              TimeSeriesVariant,
                                              EmbeddedSeriesVariant):
    """
