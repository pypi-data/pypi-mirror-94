...
from pyrqa.operators.create_matrix.radius.column_no_overlap_materialisation_bit import create_matrix
...
class ColumnNoOverlapMaterialisationBitNoRecycling(SettableSettings,
                                                   TimeSeriesVariant,
                                                   EmbeddedSeriesVariant):
    """
