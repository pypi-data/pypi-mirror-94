...
from pyrqa.operators.detect_vertical_lines.radius.column_overlap_materialisation_byte_recycling import \
...
class ColumnOverlapMaterialisationByteRecycling(SettableSettings,
                                                TimeSeriesVariant):
    """
