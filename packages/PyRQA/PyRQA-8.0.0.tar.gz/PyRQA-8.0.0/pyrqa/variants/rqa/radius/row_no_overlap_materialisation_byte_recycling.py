...
from pyrqa.operators.detect_vertical_lines.radius.row_no_overlap_materialisation_byte_recycling import \
...
class RowNoOverlapMaterialisationByteRecycling(SettableSettings,
                                               TimeSeriesVariant,
                                               EmbeddedSeriesVariant):
    """
