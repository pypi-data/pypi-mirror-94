...
from pyrqa.operators.create_matrix.radius.row_no_overlap_materialisation_bit import create_matrix
...
class RowNoOverlapMaterialisationBitNoRecycling(SettableSettings,
                                                TimeSeriesVariant,
                                                EmbeddedSeriesVariant):
    """
