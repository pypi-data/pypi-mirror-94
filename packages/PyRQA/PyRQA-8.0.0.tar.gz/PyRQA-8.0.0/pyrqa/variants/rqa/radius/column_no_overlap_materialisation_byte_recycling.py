...
from pyrqa.operators.detect_vertical_lines.radius.column_no_overlap_materialisation_byte_recycling import \
...
class ColumnNoOverlapMaterialisationByteRecycling(SettableSettings,
                                                  TimeSeriesVariant,
                                                  EmbeddedSeriesVariant):
    """
