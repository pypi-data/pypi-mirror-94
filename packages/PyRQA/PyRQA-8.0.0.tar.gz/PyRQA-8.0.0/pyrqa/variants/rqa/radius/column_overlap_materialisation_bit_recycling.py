...
from pyrqa.operators.detect_vertical_lines.radius.column_overlap_materialisation_bit_recycling import \
...
class ColumnOverlapMaterialisationBitRecycling(SettableSettings,
                                               TimeSeriesVariant):
    """
