...
from pyrqa.operators.detect_vertical_lines.radius.column_no_overlap_no_materialisation import detect_vertical_lines
from pyrqa.operators.detect_diagonal_lines.radius.column_no_overlap_no_materialisation import detect_diagonal_lines
...
class ColumnNoOverlapNoMaterialisation(SettableSettings,
                                       TimeSeriesVariant,
                                       EmbeddedSeriesVariant):
    """
    ...
    def process_sub_matrix(self,
        ...
        detect_diagonal_lines_runtimes = detect_diagonal_lines(self.settings,
                                                               ...
                                                               vectors_x_buffer=vectors_x_buffer,
                                                               vectors_y_buffer=vectors_y_buffer)
