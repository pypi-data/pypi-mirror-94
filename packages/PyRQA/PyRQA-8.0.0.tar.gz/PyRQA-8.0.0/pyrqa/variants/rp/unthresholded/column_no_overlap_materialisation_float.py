...
from pyrqa.operators.create_matrix.unthresholded.column_no_overlap_materialisation_float import create_matrix
...
class ColumnNoOverlapMaterialisationFloat(SettableSettings,
                                          TimeSeriesVariant,
                                          EmbeddedSeriesVariant):
    """
