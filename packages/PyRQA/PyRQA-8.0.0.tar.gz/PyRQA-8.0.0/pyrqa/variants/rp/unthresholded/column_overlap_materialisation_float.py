...
from pyrqa.operators.create_matrix.unthresholded.column_overlap_materialisation_float import create_matrix
...
class ColumnOverlapMaterialisationFloat(SettableSettings,
                                        TimeSeriesVariant):
    """
