...
[boto3.AppIntegrationsService 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/appintegrations.html#AppIntegrationsService) service
compatible with
