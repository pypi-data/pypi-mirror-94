...
import Deutschconjugation.conjugator

# from Deutschconjugation import conjugator
# from Deutschconjugation import __version__

import sys
# sys.path.append('Deutschconjugation/')

# import Deutschconjugation.conjugator as conjugator
# import Deutschconjugation.__version__ as __version__
...
def modeSelection() -> None:
    ...
    if args.mode[0] == "c":
        ...
        z = Deutschconjugation.conjugator.conjugate(infinitive, pronoun, tense, getColorAvailability())
        print(z)
    if args.mode[0] == "a":
        args = get_args()
        Deutschconjugation.conjugator.allConjugate(
