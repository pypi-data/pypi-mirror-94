...
def gauss_newton_increment_nform(x: NpArrayT, y: NpArrayT,
...
def gauss_newton_increment_mform(x: NpArrayT, y: NpArrayT,
                                 k: NpArrayT, xa: NpArrayT,
                                 sei: NpArrayT, sai: NpArrayT,
                                 sa: NpArrayT) -> GaussNewtonT:
    """
...
def dof_infocont_retrnoise_smootherrr(sa: NpArrayT, se: NpArrayT,
...
def invert_function(func, **args):
   ...
   gnform   = default Gauss Newton form ('n' or 'm')
    ...
    def func_inverse(yy,
        ...
        result = internal_optimizer(y=yyy,
                                    xa=xa,
                                    fg=fg,
                                    sei=sei,
                                    sai=sai,
