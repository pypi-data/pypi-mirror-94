...
def __intp__(data, pt, dv, jacobean):
    ...
    """
    d0 = np.zeros(2, dtype=np.int)
    d1 = np.zeros(2, dtype=np.int)
    d2 = np.zeros(2, dtype=np.int)
    d3 = np.zeros(2, dtype=np.int)
    d4 = np.zeros(2, dtype=np.int)
    d5 = np.zeros(2, dtype=np.int)
    d6 = np.zeros(2, dtype=np.int)
    d7 = np.zeros(2, dtype=np.int)
    d8 = np.zeros(2, dtype=np.int)
    d9 = np.zeros(2, dtype=np.int)
    d10 = np.zeros(2, dtype=np.int)
    d11 = np.zeros(2, dtype=np.int)
    d12 = np.zeros(2, dtype=np.int)
    d13 = np.zeros(2, dtype=np.int)
