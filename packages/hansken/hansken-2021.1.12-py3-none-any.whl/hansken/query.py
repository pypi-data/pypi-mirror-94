...
class Facet:
    def __init__(self, field, size=100, scale=None, filter=None):
        self.field = field
        self.size = size
...
class TermFacet(Facet):
    def __init__(self, field, size=100, filter=None):
        """
        ...
        """
        super().__init__(field=field, size=size, filter=filter)


class RangeFacet(Facet):
    def __init__(self, field, scale, base=None, interval=None, min=None, max=None, filter=None):
        """
        ...
        super().__init__(field=field, filter=filter)
...
class GeohashFacet(Facet):
    def __init__(self, field, size=100, precision=1, southwest=None, northeast=None, filter=None):
        """
