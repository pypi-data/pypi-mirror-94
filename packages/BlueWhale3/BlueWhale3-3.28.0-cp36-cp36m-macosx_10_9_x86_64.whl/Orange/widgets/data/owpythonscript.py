...
class OWPythonScript(OWWidget):
    ...
    def __init__(self):
        ...
        self.execute_button = gui.button(self.controlArea, self, __('btn.run'), callback=self.commit)
        ...
        self.textBox = gui.vBox(self, __('box.python_script'))
        ...
        self.consoleBox = gui.vBox(self, __('box.console'))
