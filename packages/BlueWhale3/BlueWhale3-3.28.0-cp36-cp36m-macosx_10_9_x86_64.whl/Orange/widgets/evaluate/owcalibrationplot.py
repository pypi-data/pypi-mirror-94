...
class OWCalibrationPlot(widget.OWWidget):
    ...
    class Error(widget.OWWidget.Error):
        non_discrete_target = Msg(__("msg.calibration_plot_require_discrete_target"))
        empty_input = widget.Msg(__("msg.nothing_display"))
        nan_classes = \
            widget.Msg(__("msg.remove_unkown_class"))
        all_target_class = widget.Msg(
            __("msg.data_belong_target_class"))
        no_target_class = widget.Msg(
            __("msg.nodata_belong_target_class"))

    class Warning(widget.OWWidget.Warning):
        omitted_folds = widget.Msg(
            __("msg.not_shown_data_belong_test_fold"))
        omitted_nan_prob_points = widget.Msg(
            __("msg.model_cannot_compute"))
        no_valid_data = widget.Msg(__("msg.invalid_data_for_model"))
