...
setup(name='bcdi', version='0.0.10-alpha.2',
      ...
      scripts=['bcdi/algorithms/scripts/flatten_intensity.py',
               ...
               'bcdi/postprocessing/scripts/rocking_curves.py',
               ...
               'bcdi/preprocessing/scripts/interpolate_cdi.py',
               ...
               'bcdi/publication/scripts/plot_diffpattern_2d.py',
               'bcdi/publication/scripts/compa_simu_exp.py',
               'bcdi/publication/scripts/plot_strain.py',
               ...
               'bcdi/utils/scripts/center_of_rotation.py',
               ...
               'bcdi/xcca/scripts/xcca_3D_map_polar.py',
               'bcdi/xcca/scripts/xcca_3D_map_rect.py',
               'bcdi/xcca/scripts/xcca_3D_polar.py',
               'bcdi/xcca/scripts/xcca_3D_rect.py',
               ],
      # metadata
