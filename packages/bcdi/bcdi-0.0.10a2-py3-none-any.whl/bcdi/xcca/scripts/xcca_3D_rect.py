...
values. The 3D dataset is expected to be interpolated on an orthonormal grid. The voxels belonging to a slice at the
defined q value are used for the calculation without further interpolation.
