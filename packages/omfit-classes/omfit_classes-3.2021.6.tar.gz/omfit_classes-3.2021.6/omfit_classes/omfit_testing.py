...
def run_test_series(exit_at_end=False, post_gh_comment=False, post_gh_status=False, tests=None, test_plan_file=None, script_timeout=0):
    ...
    for test in test_plan['tests']:
        ...
        # Check github for a newer commit and abort if it's newer than the current ones
        ...
        try:
            ...
            # Disabling the alarm should happen before anything else as to not risk moving over
