...
class Footer:
    ...
    px = Px('''<div class="footer">
     ...
     css='''
      .footer { width:100%; height: |footerHeight|; text-align:right;
                position: fixed; bottom: 0; background-color: #ececec;
                border-top: 1px solid #c4c4c4; z-index: 10; font-size: 65% }
