    ...
    pxLogin = Px('''
      ...
      <form id="loginForm" name="loginForm" method="post" class="login"
       ...
       <center>
         <input type="submit" name="submit" var="label=_('app_connect')"
                value=":label" alt=":label"/></center>

       <!-- Forgot password ? -->
       <center class="lostPassword" if="cfg.activateForgotPassword">
         <a class="clickable"
         onclick="openPopup('askPasswordReinitPopup')">:_('forgot_password')</a>
       </center>

       <!-- Link to self-registration -->
       <center if="cfg.selfRegister">
     ...
     css='''
      .loginBox {
         ...
         background-color:|boxBgColor|; position:absolute; top:50%; left:50%;
         z-index:10; transform:translate(-50%,-50%); box-shadow:|loginShadow|
      }
      ...
      #loginForm input {
        ...
        padding:12px; margin:8px 0; color:|loginColor| }
      #loginForm input[type=submit] { width:calc(|loginWidth| + 20px);
        color:|submitColor|; background-color:|submitBgColor|;
        margin-top:30px; text-transform: uppercase }
      .lostPassword { padding:10px 0; font-size:80% }
