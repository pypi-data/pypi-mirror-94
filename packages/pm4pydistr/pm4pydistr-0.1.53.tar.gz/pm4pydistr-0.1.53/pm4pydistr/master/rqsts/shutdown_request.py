...
class ShutdownRequest(BasicMasterRequest):
    ...
    def run(self):
        uri = "http://" + self.target_host + ":" + self.target_port + "/doShutdown?keyphrase=" + KEYPHRASE + "&process=" + str(
            self.content) + "&session=" + str(self.session) + "&no_samples="+str(self.no_samples)
