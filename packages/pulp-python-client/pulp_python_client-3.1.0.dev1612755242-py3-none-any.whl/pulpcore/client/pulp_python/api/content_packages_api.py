...
class ContentPackagesApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str author__in: author__in
        :param str filename: filename
        :param str filename__contains: filename__contains
        :param str filename__in: filename__in
        :param str keywords__contains: keywords__contains
        :param str keywords__in: keywords__in
        :param int limit: Number of results to return per page.
        :param str name: name
        :param str name__in: name__in
        :param int offset: The initial index from which to return the results.
        :param str ordering: Which field to use when ordering the results.
        :param str packagetype: packagetype
        :param str packagetype__in: packagetype__in
