...
class SlackLogging(Slack):
    ...
    def __init__(self, slack: Slack = None, username: str = None, channel: str = None,
        ...
        self._url = ''
        self._channel = self.slack.SLACK_DEFAULT_CHANNEL or f'#{self.slack_username}'
        self._format = Format.blockquote
        self._suffix = ''

        self._warn_icon = Emoji.warning
        self._warn_url = ''
        self._warn_channel = self.slack.SLACK_WARN_CHANNEL or f'#{self.slack_username}-warn'
        self._warn_format = Format.blockquote
        self._warn_suffix = ' warn'

        self._info_icon = Emoji.information_source
        self._info_url = ''
        self._info_channel = self.slack.SLACK_INFO_CHANNEL or f'#{self.slack_username}-info'
        self._info_format = Format.blockquote
        self._info_suffix = ' info'

        self._debug_icon = Emoji.magnifying_glass
        self._debug_url = ''
        self._debug_channel = self.slack.SLACK_DEBUG_CHANNEL or f'#{self.slack_username}-debug'
        self._debug_format = Format.blockquote
        self._debug_suffix = ' debugger'

        self._error_icon = Emoji.sos
        self._error_url = ''
        self._error_channel = self.slack.SLACK_ERROR_CHANNEL or f'#{self.slack_username}-error'
        self._error_format = Format.blockquote
        self._error_suffix = ' error'

        self._critical_icon = Emoji.sos
        self._critical_url = ''
        self._critical_channel = self.slack.SLACK_CRITICAL_CHANNEL or f'#{self.slack_username}-critical'
