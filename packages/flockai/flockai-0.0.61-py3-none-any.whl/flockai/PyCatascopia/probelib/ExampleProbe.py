...
from flockai.PyCatascopia.Metrics import SimpleMetric, CounterMetric, DiffMetric
...
class ExampleProbe(Probe):
    def __init__(self, name="ExampleProbe", periodicity=5):
        ...
        self.myMetric3 = CounterMetric('myMetric3', '#', 'counter incrementing by 1 and resetting at 20', maxVal=20)
