...
class KeyboardMavic2DJI(KeyboardControlledDrone):
    ...
    def send_msg(self, msg, emitter_devices: list):
        ...
        get_time_now = lambda: cpu_probe.probe_alive_time.val if cpu_probe is not None else 0
    ...
    def run(self):
        ...
        while self.step(self.basic_time_step) != -1:
            ...
            flight_time = cpu_probe.probe_alive_time.val
            cpu_time = cpu_probe.cpu_time.val
            io_time = cpu_probe.io_time.val
