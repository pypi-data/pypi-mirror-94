...
class Entries:
    ...
    def associateInIndexes(self, words):
    ...
    def withKeyword(self, keyword, max=50):
        query = """
    ...
    def withBook(self, book, max=50):
        ...
        """
        variables = {"max": max,"book": str(book)}
