...
class AlarmDefinitionChild(Model):
    ...
    def __init__(self, *, low_alarm_value: float=None, low_warning_value: float=None, high_alarm_value: float=None, high_warning_value: float=None, off_threshold_value: float=None, classification: str=None, **kwargs) -> None:
