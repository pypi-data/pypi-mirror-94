...
class ActivityResponse(Model):
    ...
    :param activity_type: Required. Possible values include: 'None',
    ...
    :type activity_type: str or ~smartdiagnostics_sdk.models.enum
    :param group:
    ...
    def __init__(self, *, id: str, location, date_occurred, description: str, activity_type, activity_codes, activity_document, title: str, created, created_by: str, modified, modified_by: str, savings: float, hierarchy, group=None, indicator=None, evidence_indicator=None, **kwargs) -> None:
