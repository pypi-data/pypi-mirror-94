...
class GroupStatusResponse(Model):
    ...
    def __init__(self, *, name: str, id: str, alarm_count: int, warning_count: int, is_snoozed: bool, is_paused: bool, damage_score: float=None, alarm_severity: int=None, hierarchy=None, **kwargs) -> None:
