...
class ActivityCreateRequest(Model):
    ...
    def __init__(self, *, date_occurred, activity_type, title: str, description: str=None, activity_document=None, group_id: str=None, indicator_id: str=None, activity_code_ids=None, evidence_indicator_id: str=None, savings: float=None, **kwargs) -> None:
