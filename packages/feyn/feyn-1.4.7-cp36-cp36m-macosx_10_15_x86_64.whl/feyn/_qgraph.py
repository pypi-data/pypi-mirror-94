...
class QGraph:
    ...
    def _update_display(self, show):
        ...
        if show == "graph":
            ...
            show(qgraph[0], self[0].loss_value)
        elif show is None:
            pass
        else:
    ...
    def fit(self, data, n_samples:Optional[int]=None, loss_function=_feyn.DEFAULT_LOSS, show:Optional[FittingShowType]="graph", threads:int=1, sample_weights=None, criterion:str=None) -> "QGraph":
        """
    ...
    def sort(self, data, loss_function=_feyn.DEFAULT_LOSS, threads:int=1, sample_weights=None, criterion:str=None):
        """
