...
SnapDecisionTreeRegressor = DecisionTreeRegressor
SnapRandomForestRegressor = RandomForestRegressor
SnapBoostingMachineRegressor = BoostingMachineRegressor
SnapDecisionTreeClassifier = DecisionTreeClassifier
SnapRandomForestClassifier = RandomForestClassifier
SnapBoostingMachineClassifier = BoostingMachineClassifier
SnapSVMClassifier = SupportVectorMachine
SnapLogisticRegression = LogisticRegression
SnapLinearRegression = LinearRegression
