...
def test_Plqe_import():
    ...
    Header = 0
    Footer = 35
    data = an.Plqe(path_3mes_data, setup='CPT', filetype=FileType,
                   delimiter=Delimiter, header=Header, footer=Footer)
    ...
    data.calibrate()
    data.calc_plqe(exc_wl=[390, 435], pl_wl=[450, 740],
                   xlim=(350, 750), yscale='log')
    ...
    data = an.Plqe(path_5mes_data, setup='CPT', filetype=FileType,
                   delimiter=Delimiter, header=Header, footer=Footer,
                   combine_wl=860)
    ...
    data.calc_plqe(exc_wl=[640, 680], pl_wl=[880, 1350],
                   xlim=(600, 1500), yscale='log')
