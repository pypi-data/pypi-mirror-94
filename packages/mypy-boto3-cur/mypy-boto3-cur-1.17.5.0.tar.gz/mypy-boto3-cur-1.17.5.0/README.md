...
[boto3.CostandUsageReportService 1.17.5](https://boto3.amazonaws.com/v1/documentation/api/1.17.5/reference/services/cur.html#CostandUsageReportService) service
compatible with
