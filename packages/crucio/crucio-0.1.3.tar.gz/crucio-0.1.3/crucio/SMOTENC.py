...
class SMOTENC:
    ...
    def balance(self, df : pd.DataFrame, target : str)-> pd.DataFrame:
        ...
        for i,minority_class in enumerate(minority_classes):
            ...
            for _ in range(difference):
                ...
                neighbours_indexes = self.get_k_neighbours(example,minority_samples) 
                ...
                for feature,_ in enumerate(example):
                    if type(example[feature])!=str:
                        ...
                        new_example.append(self.most_common(neighbours_features))
                #add it to df
    ...
    def get_k_neighbours(self,example,minority_sample):
        '''
    ...
    def most_common(self,neighbours_features):
        '''
            Getting the most common categorical value in K Nearest Neighbours.
        '''
        word_counter = {}
