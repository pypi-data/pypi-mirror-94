...
class SLS:
    ...
    def balance(self, df : pd.DataFrame, target : str):
        ...
        for i,minority_class in enumerate(minority_classes):
            ...
            for minority_sample in minority_samples:
                ...
                minority_nearest_neighbours = self.get_k_neighbours(minority_sample,minority_samples)
                ...
                positive_instances_example = self.get_k_neighbours_positive_number(minority_sample,minority_class)
                positive_instances_neighb = self.get_k_neighbours_positive_number(selected_neighbour,minority_class)
    ...
    def get_k_neighbours(self,example,minority_samples):
        '''
    ...
    def get_k_neighbours_positive_number(self,example,minority_class):
        '''
