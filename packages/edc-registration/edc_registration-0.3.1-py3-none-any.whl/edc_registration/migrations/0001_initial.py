    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "identity_type",
                    edc_model_fields.fields.IdentityTypeField(
                        blank=True,
                        choices=[
                            ("OMANG", "Omang"),
                ...
                (
                    ...
                    models.CharField(
                        default=None,
                        editable=False,
                        help_text="A uuid (or some other text value) to be added to bypass the unique constraint of just firstname, initials, and dob.The default constraint proves limiting since the source model usually has some otherattribute in additional to first_name, initials and dob which is not captured in this model",
                        max_length=36,
                        null=True,
                        verbose_name="-",
                    ),
