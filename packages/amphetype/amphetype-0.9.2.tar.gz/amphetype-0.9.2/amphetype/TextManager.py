...
Amphetype is a layout-agnostic typing program that measures your speed and progress while identifying typing problems. This is just a default text since your database is empty. Go to the "Sources" tab and try adding some texts. There's already several great texts that come with Amphetype. Later on you can generate a new type of texts (called "Lessons") from your statistics directly.
Good luck!""")
