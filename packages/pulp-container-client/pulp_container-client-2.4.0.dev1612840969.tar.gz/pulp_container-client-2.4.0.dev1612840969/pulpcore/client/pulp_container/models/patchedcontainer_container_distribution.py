...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, content_guard=None, name=None, pulp_labels=None, base_path=None, repository=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
