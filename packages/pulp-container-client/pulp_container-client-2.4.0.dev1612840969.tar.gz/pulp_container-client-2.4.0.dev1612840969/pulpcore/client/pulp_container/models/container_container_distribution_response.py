...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, content_guard=None, pulp_created=None, pulp_href=None, name=None, pulp_labels=None, base_path=None, repository=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
