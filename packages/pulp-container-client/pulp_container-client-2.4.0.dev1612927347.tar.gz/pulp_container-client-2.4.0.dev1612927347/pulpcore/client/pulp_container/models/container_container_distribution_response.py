...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_created=None, pulp_labels=None, name=None, repository_version=None, pulp_href=None, content_guard=None, repository=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
