...
def getStraightLineCurrentIntegral(hx, hy, hz, ax, ay, az, bx, by, bz):
    ...
    wx0 = weight(0.0, ay, ly, hy, az, lz, hz)
    wx0_5 = weight(0.5, ay, ly, hy, az, lz, hz)
    wx1 = weight(1.0, ay, ly, hy, az, lz, hz)

    wy0 = weight(0.0, ax, lx, hx, az, lz, hz)
    wy0_5 = weight(0.5, ax, lx, hx, az, lz, hz)
    wy1 = weight(1.0, ax, lx, hx, az, lz, hz)

    wz0 = weight(0.0, ax, lx, hx, ay, ly, hy)
    wz0_5 = weight(0.5, ax, lx, hx, ay, ly, hy)
    wz1 = weight(1.0, ax, lx, hx, ay, ly, hy)
