...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.35.0-alpha.1612818270+7f8624c4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.35.0-alpha.1612818270+7f8624c4`
                """)
            else:
                raise
