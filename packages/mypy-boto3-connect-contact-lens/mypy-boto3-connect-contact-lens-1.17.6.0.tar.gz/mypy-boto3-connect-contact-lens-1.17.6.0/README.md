...
[boto3.ConnectContactLens 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/connect-contact-lens.html#ConnectContactLens) service
compatible with
