...
class ChoreData(object):
    def __init__(self, parsed_json):
        ...
        self.next_execution_assigned_to_user_id = parse_int(parsed_json.get(
...
class GrocyApiClient(object):
    ...
    def get_tasks(self) -> List[TaskResponse]:
        parsed_json = self._do_get_request("objects/tasks", params={'done': '0'})
    ...
    def delete_entity(self, entity_type: str, id):
        self._do_delete_request(f"objects/{entity_type}/{id}")
