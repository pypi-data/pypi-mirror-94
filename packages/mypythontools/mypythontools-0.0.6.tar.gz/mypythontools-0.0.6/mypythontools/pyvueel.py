...
def run_gui(multiprocessing=False, log_file_path=None, gui_folder=None):
    ...
    Args:
        ...
        gui_folder ((str, Path, None)), optional): Where the web asset is. If None, default is used. Defaults to None.
    """
