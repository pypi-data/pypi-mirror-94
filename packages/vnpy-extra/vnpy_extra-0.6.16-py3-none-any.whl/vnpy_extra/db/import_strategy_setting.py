    ...
    for num, (strategy_name, json_settings) in enumerate(strategy_setting_dic.items(), start=1):
        ...
        for is_9999 in [False, True]:
            ...
            if is_cta:
                ...
                if is_9999:
                    symbols = [change_main_contract(_) for _ in symbols]

                stg_obj: StrategyTemplate = create_instance(
                    module_name, strategy_class_name,
                    strategy_engine=None, strategy_name=strategy_class_name, vt_symbols=symbols,
            ...
            if is_9999:
                ...
                short_name = None
                shown_name = None
                backtest_status = StrategyBacktestStatusEnum.RollingBacktest.value
            else:
