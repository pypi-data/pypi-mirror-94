...
class ClientDatabase:
    ...
    def get_history(self, from_who=None, to_who=None):
        ...
        if from_who:
            query = query.filter(or_(self.MessageHistory.from_user ==
                                     from_who, self.MessageHistory.from_user == to_who))
        if to_who:
            # query = query.filter_by(to_user=to_who or from_who)
            query = query.filter(or_(
                self.MessageHistory.to_user == from_who, self.MessageHistory.to_user == to_who))
