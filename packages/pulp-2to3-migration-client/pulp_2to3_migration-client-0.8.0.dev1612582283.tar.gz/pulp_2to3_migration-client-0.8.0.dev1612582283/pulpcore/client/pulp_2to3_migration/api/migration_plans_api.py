...
class MigrationPlansApi(object):
    ...
    def reset(self, pulp_2to3_migration_migration_plan_href, pulp2to3_migration_migration_plan, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reset(pulp_2to3_migration_migration_plan_href, pulp2to3_migration_migration_plan, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.reset_with_http_info(pulp_2to3_migration_migration_plan_href, pulp2to3_migration_migration_plan, **kwargs)  # noqa: E501

    def reset_with_http_info(self, pulp_2to3_migration_migration_plan_href, pulp2to3_migration_migration_plan, **kwargs):  # noqa: E501
        """Reset Pulp 3 data for plugins specified in the migration plan  # noqa: E501

        Trigger an asynchronous task to remove data from Pulp 3 related to the plugins specified in the migration plan.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reset_with_http_info(pulp_2to3_migration_migration_plan_href, pulp2to3_migration_migration_plan, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('pulp2to3_migration_migration_plan' not in local_var_params or  # noqa: E501
                                                        local_var_params['pulp2to3_migration_migration_plan'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `pulp2to3_migration_migration_plan` when calling `reset`")  # noqa: E501
