...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.5.0-alpha.1612818267+e2441aeb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.5.0-alpha.1612818267+e2441aeb`
                """)
            else:
                raise
