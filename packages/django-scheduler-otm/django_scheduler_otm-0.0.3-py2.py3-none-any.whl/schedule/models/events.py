...
class Event(models.Model):
    ...
    other models.
    '''
    plot_id = models.CharField(_("plot_id"), max_length=20, db_index=True)
    start = models.DateTimeField(_("start"), db_index=True)
    end = models.DateTimeField(_("end"), db_index=True, help_text=_(
    ...
    def get_occurrence(self, date):
        ...
        if rule:
            next_occurrence = rule.after(tzinfo.normalize(
    ...
    def _get_occurrence_list(self, start, end):
        ...
        if self.rule is not None:
            ...
            occurrences = []
            if self.end_recurring_period and pytz.UTC.localize(self.end_recurring_period) < pytz.UTC.localize(end):
            ...
            if pytz.UTC.localize(self.start) < pytz.UTC.localize(end) and pytz.UTC.localize(self.end) > pytz.UTC.localize(start):
    ...
    def occurrences_after(self, after=None, max_occurrences=None):
        ...
        trickies = list(self.occurrence_set.filter(
            original_start__lte=after, start__gte=after).order_by('start'))
...
class EventRelationManager(models.Manager):
    ...
    def get_events_for_object(self, content_object, distinction='', inherit=True):
        ...
        if inherit:
            ...
            inherit_q = Q()
        event_q = Q(dist_q, eventrelation__content_type=ct,
