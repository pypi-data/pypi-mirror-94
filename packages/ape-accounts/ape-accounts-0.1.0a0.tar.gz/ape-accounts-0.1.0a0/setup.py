...
setup(
    ...
    description=(
        "Plugin for [Ape Ethereum Framework](https://github.com/ApeWorX/ape)"
        " for working with local accounts"
    ),
    long_description=long_description,
    long_description_content_type="text/markdown",
    author="ApeWorX Ltd.",
    author_email="admin@apeworx.io",
    url="https://github.com/ApeWorX/ape-accounts",
    include_package_data=True,
    install_requires=[],  # NOTE: Add 3rd party libraries here
    python_requires=">=3.6, <4",
    extras_require=extras_require,
    py_modules=["ape_accounts"],
    license="Apache-2.0",
    zip_safe=False,
    keywords="ethereum",
