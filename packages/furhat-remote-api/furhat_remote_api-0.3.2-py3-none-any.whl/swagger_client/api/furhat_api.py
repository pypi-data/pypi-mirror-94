...
"""
    ...
    This is the Furhat Remote API, use it to generate a server. Or generate a client. Find out more at https://docs.furhat.io/remote-api  # noqa: E501
...
class FurhatApi(object):
    ...
    def furhat_face_post(self, **kwargs):  # noqa: E501
        ...
        Changes the texture or model, based on the model/texture name. Case sensitive. Names can be retrieved from the web interface  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str model: Change the model of the robot
        :param str texture: Change the texture of the robot
        :return: Status
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def furhat_face_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['model', 'texture']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def furhat_gesture_post(self, **kwargs):  # noqa: E501
        ...
        :param bool _async: Whether to perform the gesture asynchronously (default true)
    ...
    def furhat_gesture_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name', '_async', 'definition']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def furhat_say_post(self, **kwargs):  # noqa: E501
        ...
        :param bool _async: Whether to perform the speech asynchronously (default true)
    ...
    def furhat_say_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['text', 'url', '_async', 'lipsync', 'abort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
