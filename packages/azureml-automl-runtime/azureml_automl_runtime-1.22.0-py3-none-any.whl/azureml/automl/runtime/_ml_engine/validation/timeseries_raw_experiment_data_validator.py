...
from .raw_experiment_data_validator import RawExperimentDataValidator
...
class TimeseriesRawExperimentDataValidator(RawExperimentDataValidator):
    ...
    def __init__(self, automl_settings: AutoMLBaseSettings) -> None:
        super(TimeseriesRawExperimentDataValidator, self).__init__(automl_settings)
    ...
    def _check_validation_data_or_config_provided(self, raw_experiment_data: RawExperimentData) -> None:
        ...
        """
        # TODO: Refactor logic from _ts_cv_valid_worker.py (for checking validation config)
        pass
    ...
    def get_tabular_data_validator(self) -> MaterializedTabularDataValidator:
        ...
        return TimeseriesMaterializedTabularDataValidator(primary_metric=self._automl_settings.primary_metric)
