...
[boto3.IoT1ClickDevicesService 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/iot1click-devices.html#IoT1ClickDevicesService) service
compatible with
