...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.0.0', 'pymssql~=2.1,>=2.1.5'],
        setup_requires=['setuptools', 'wheel'],
        extras_require={'odbc': ['apache-airflow-providers-odbc']},
        classifiers=[
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-microsoft-mssql/1.0.1/',
