...
from solace.messaging.config.publisher_back_pressure_configuration import PublisherBackPressureConfiguration


class MessagePublisherBuilder(PublisherBackPressureConfiguration, PropertyBasedConfiguration, ABC):
