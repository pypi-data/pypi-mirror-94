...
def _send_file(url, data, params, experiment_id, config, headers):
    # type: (str, Any, Dict[str, str], str, Config, Dict[str, Any]) -> Response
    LOGGER.debug("Uploading files %r to %s with params %s", data, url, params)

    headers.update({"X-COMET-DEBUG-EXPERIMENT-KEY": experiment_id})
