...
class ExpaiModelExplainer:
    ...
    def what_if(self, old_sample: dict = None, new_sample: dict = None):
        assert old_sample is not None and new_sample is not None, "You must provide an old and new sample to use this module"
