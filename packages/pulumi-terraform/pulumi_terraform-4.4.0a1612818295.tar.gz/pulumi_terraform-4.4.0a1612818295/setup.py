...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '4.4.0-alpha.1612818295+d73a3466'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 4.4.0-alpha.1612818295+d73a3466`
                """)
