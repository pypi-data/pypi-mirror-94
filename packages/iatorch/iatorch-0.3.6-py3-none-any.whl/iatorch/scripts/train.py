...
def train_image_folder(
    ...
    seed=None,
    # logging
    tracking_uri='sqlite:///mlruns.db', experiment_name='Default', run_name='noname', user=None,
    # etc.
    silence=False,
):
    '''
...
@click.option('-o', '--optimizer', default='Adam', type=str, show_default=True, help='Select a Optimizer')
...
@click.option('--monitor', default='var/loss', type=str, show_default=True, help='Monitored Value, e.g. var_loss, var_accuracy')
...
@click.option('--tracking_uri', default='sqlite:///mlruns.db', type=str, show_default=True, help='MLflow trackinng uri')
@click.option('-n', '--experiment-name', default='Default', show_default=True, help='Project Name, e.g. sound/cooktop, vision/ddrotor')
@click.option('-r', '--run-name', default='noname', show_default=True, help='Run Name for Logging, e.g. hparams_tuning')
