...
from pycarus.geometry.pcd import affine, farthest_point_sampling, jitter_pcd, normalize_pcd, rotate
from pycarus.geometry.pcd import scale, translate
...
class FarthestPointSampler:
    ...
    def __call__(self, pcd: torch.Tensor) -> torch.Tensor:
        ...
        """
        return farthest_point_sampling(pcd, self.num_points)
