...
setup(
  name = 'ExtractC',         # How you named your package folder (MyLib)
  packages = ['ExtractC'],   # Chose the same as "name"
  ...
  url = 'https://github.com/trongbui1105/ExtractCard.git',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/trongbui1105/ExtractCard/archive/0.1.5.tar.gz',    # I explain this later on
