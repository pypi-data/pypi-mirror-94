            ...
            if repeat > 0:
                ...
                if print_table:
                    ...
                    if print_detail:
                        ...
                        print(
                            f'Function {func_name} -> {repeat} trials {number} function calls: average trial {avg_trial_time_string}, average function call {avg_func_call_time_string}')
