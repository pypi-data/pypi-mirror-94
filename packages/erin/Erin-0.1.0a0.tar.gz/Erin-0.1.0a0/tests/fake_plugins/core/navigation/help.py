...
from tests.fake_plugins.core.navigation.paginator import Pages
...
class HelpPaginator(Pages):
    ...
    def prepare_embed(self, entries, page, *, first=False):
        ...
        if self.is_bot:
            value = self.bot.config["help"]["support_text"]
...
class PaginatedHelpCommand(commands.HelpCommand):
    ...
    async def send_command_help(self, command):
        ...
        embed = discord.Embed(colour=self.context.bot.config["help"]["color"])
