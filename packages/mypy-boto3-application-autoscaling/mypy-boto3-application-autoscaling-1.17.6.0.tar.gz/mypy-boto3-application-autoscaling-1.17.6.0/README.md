...
[boto3.ApplicationAutoScaling 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/application-autoscaling.html#ApplicationAutoScaling) service
compatible with
