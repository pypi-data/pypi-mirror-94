...
setup(
    ...
    packages=[
        p for p in find_namespace_packages(where='src') 
        if 'model' not in p
    ],
    package_dir={'': 'src'},
    classifiers=[
    ...
    scripts=[
        'src/akerbp/mlops/deploy_training_service.sh', 
        'src/akerbp/mlops/deploy_prediction_service.sh',
    ...
    package_data={'': [
        ...
        'mlops/utils/bitbucket-pipelines.yml'
        ]},
)