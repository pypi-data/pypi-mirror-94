...
def set_up_requirements(model_req_file):
    """
    ...
    if "akerbp/mlops" in get_repo_origin():
...
def get_platform_functions(deployment_platform):
    if deployment_platform == 'cdf':
        ...
        raise ValueError(m)
    return deploy_function, test_function