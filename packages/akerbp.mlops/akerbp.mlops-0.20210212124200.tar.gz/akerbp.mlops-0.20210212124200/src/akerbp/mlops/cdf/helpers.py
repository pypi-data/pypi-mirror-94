...
def create_function(
    ...
    try:
        ...
        pass
    env_vars = dict(SERVICE_NAME=SERVICE_NAME, ENV=ENV)
...
def query_file_versions(directory_prefix, external_id_prefix, metadata):
    """
    Find all file versions that match a query. Only versions that were uploaded
    are considered
