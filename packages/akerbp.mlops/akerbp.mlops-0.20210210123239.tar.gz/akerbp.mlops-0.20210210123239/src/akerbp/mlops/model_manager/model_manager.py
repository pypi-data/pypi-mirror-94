...
from akerbp.mlops.cdf.helpers import count_file_versions, download_folder
from akerbp.mlops.cdf.helpers import upload_folder, query_file_versions
...
def upload_new_model_version(model_name, env, folder, metadata):
    ...
    version = count_file_versions(filter, directory_prefix='/mlops') + 1
