...
@click.option ('--customattr','-cattr', type=click.Path(exists=True, resolve_path=True, readable=True), help = "CUSTOM CSR File" )
...
def cli(verbose, isaspec, grpspec, customspec, customattr, workdir, probeinst):
    ...
    csr_gen.csr_gen(isa_file, grpspec, custom_file, customattr, bsv_dir,
