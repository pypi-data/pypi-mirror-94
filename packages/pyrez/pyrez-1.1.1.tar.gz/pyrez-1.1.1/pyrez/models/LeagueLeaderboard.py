...
class LeagueLeaderboard(APIResponse):
    def __init__(self, **kwargs):
        ...
        self.losses = kwargs.get("Losses", 0) or 0
        ...
        self.rankStatConquest = kwargs.get("Rank_Stat_Conquest", 0) or 0
        self.rankStatDuel = kwargs.get("Rank_Stat_Duel", 0) or 0
        self.rankStatJoust = kwargs.get("Rank_Stat_Joust", 0) or 0
        self.leagueSeason = kwargs.get("Season", 0) or 0
        self.tier = kwargs.get("Tier", 0) or 0
        self.trend = kwargs.get("Trend", 0) or 0
        self.wins = kwargs.get("Wins", 0) or 0
