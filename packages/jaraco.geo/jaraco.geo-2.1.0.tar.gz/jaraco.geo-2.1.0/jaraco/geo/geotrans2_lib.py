...
import os
import ctypes
from ctypes import c_long, c_double, POINTER, c_int, Structure, c_char

_libraries = {}
dllname = ['geotrans2-32.dll', 'geotrans2-64.dll']['AMD64' in sys.version]
dllname = os.path.join(os.path.dirname(__file__), dllname)
# dllname = (
#     r'c:\users\jaraco\projects\geotrans2.4.2\geotrans2\win\geotrans2.dll'
_libraries['geotrans2.dll'] = ctypes.CDLL(dllname)
...
Convert_Ellipsoid_To_Geoid_Height = _libraries[
    'geotrans2.dll'
].Convert_Ellipsoid_To_Geoid_Height
Convert_Ellipsoid_To_Geoid_Height.restype = c_long
Convert_Ellipsoid_To_Geoid_Height.argtypes = [
    c_double,
    c_double,
    c_double,
    POINTER(c_double),
]
Convert_Ellipsoid_To_MSL_EGM96_VG_NS_Height = _libraries[
    'geotrans2.dll'
].Convert_Ellipsoid_To_MSL_EGM96_VG_NS_Height
Convert_Ellipsoid_To_MSL_EGM96_VG_NS_Height.restype = c_long
Convert_Ellipsoid_To_MSL_EGM96_VG_NS_Height.argtypes = [
    c_double,
    c_double,
    c_double,
    POINTER(c_double),
]
Convert_Ellipsoid_To_MSL_EGM84_10D_BL_Height = _libraries[
    'geotrans2.dll'
].Convert_Ellipsoid_To_MSL_EGM84_10D_BL_Height
Convert_Ellipsoid_To_MSL_EGM84_10D_BL_Height.restype = c_long
Convert_Ellipsoid_To_MSL_EGM84_10D_BL_Height.argtypes = [
    c_double,
    c_double,
    c_double,
    POINTER(c_double),
]
Convert_Ellipsoid_To_MSL_EGM84_10D_NS_Height = _libraries[
    'geotrans2.dll'
].Convert_Ellipsoid_To_MSL_EGM84_10D_NS_Height
Convert_Ellipsoid_To_MSL_EGM84_10D_NS_Height.restype = c_long
Convert_Ellipsoid_To_MSL_EGM84_10D_NS_Height.argtypes = [
    c_double,
    c_double,
    c_double,
    POINTER(c_double),
...
Transverse_Cylindrical_Equal_Area_Parameters = (
    Transverse_Cylindrical_Equal_Area_Structure
)
...
Get_Coordinate_System.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Coordinate_Type),
]
...
Get_Datum_Seven_Parameters.argtypes = [
    c_long,
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
...
Get_Datum_Three_Parameters.argtypes = [
    c_long,
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
...
Get_Datum_Valid_Rectangle.argtypes = [
    c_long,
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
...
Set_Geocentric_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Geocentric_Tuple_Structure,
]
Get_Geocentric_Coordinates = _libraries['geotrans2.dll'].Get_Geocentric_Coordinates
Get_Geocentric_Coordinates.restype = c_long
Get_Geocentric_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Geocentric_Tuple),
]
...
Get_Geodetic_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Geodetic_Parameters),
]
Set_Geodetic_Coordinates = _libraries['geotrans2.dll'].Set_Geodetic_Coordinates
Set_Geodetic_Coordinates.restype = c_long
Set_Geodetic_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Geodetic_Tuple_Structure,
]
Get_Geodetic_Coordinates = _libraries['geotrans2.dll'].Get_Geodetic_Coordinates
Get_Geodetic_Coordinates.restype = c_long
Get_Geodetic_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Geodetic_Tuple),
]
Set_GEOREF_Coordinates = _libraries['geotrans2.dll'].Set_GEOREF_Coordinates
Set_GEOREF_Coordinates.restype = c_long
Set_GEOREF_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    GEOREF_Tuple_Structure,
]
Get_GEOREF_Coordinates = _libraries['geotrans2.dll'].Get_GEOREF_Coordinates
Get_GEOREF_Coordinates.restype = c_long
Get_GEOREF_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(GEOREF_Tuple),
]
Set_Albers_Equal_Area_Conic_Params = _libraries[
    'geotrans2.dll'
].Set_Albers_Equal_Area_Conic_Params
Set_Albers_Equal_Area_Conic_Params.restype = c_long
Set_Albers_Equal_Area_Conic_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Albers_Equal_Area_Conic_Structure,
]
Get_Albers_Equal_Area_Conic_Params = _libraries[
    'geotrans2.dll'
].Get_Albers_Equal_Area_Conic_Params
Get_Albers_Equal_Area_Conic_Params.restype = c_long
Get_Albers_Equal_Area_Conic_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Albers_Equal_Area_Conic_Parameters),
]
Set_Albers_Equal_Area_Conic_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Albers_Equal_Area_Conic_Coordinates
Set_Albers_Equal_Area_Conic_Coordinates.restype = c_long
Set_Albers_Equal_Area_Conic_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Albers_Equal_Area_Conic_Tuple_Structure,
]
Get_Albers_Equal_Area_Conic_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Albers_Equal_Area_Conic_Coordinates
Get_Albers_Equal_Area_Conic_Coordinates.restype = c_long
Get_Albers_Equal_Area_Conic_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Albers_Equal_Area_Conic_Tuple),
]
Set_Azimuthal_Equidistant_Params = _libraries[
    'geotrans2.dll'
].Set_Azimuthal_Equidistant_Params
Set_Azimuthal_Equidistant_Params.restype = c_long
Set_Azimuthal_Equidistant_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Azimuthal_Equidistant_Structure,
]
Get_Azimuthal_Equidistant_Params = _libraries[
    'geotrans2.dll'
].Get_Azimuthal_Equidistant_Params
Get_Azimuthal_Equidistant_Params.restype = c_long
Get_Azimuthal_Equidistant_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Azimuthal_Equidistant_Parameters),
]
Set_Azimuthal_Equidistant_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Azimuthal_Equidistant_Coordinates
Set_Azimuthal_Equidistant_Coordinates.restype = c_long
Set_Azimuthal_Equidistant_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Azimuthal_Equidistant_Tuple_Structure,
]
Get_Azimuthal_Equidistant_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Azimuthal_Equidistant_Coordinates
Get_Azimuthal_Equidistant_Coordinates.restype = c_long
Get_Azimuthal_Equidistant_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Azimuthal_Equidistant_Tuple),
]
...
Get_Cassini_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Cassini_Parameters),
]
Set_Cassini_Coordinates = _libraries['geotrans2.dll'].Set_Cassini_Coordinates
Set_Cassini_Coordinates.restype = c_long
Set_Cassini_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Cassini_Tuple_Structure,
]
Get_Cassini_Coordinates = _libraries['geotrans2.dll'].Get_Cassini_Coordinates
Get_Cassini_Coordinates.restype = c_long
Get_Cassini_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Cassini_Tuple),
]
Set_Cylindrical_Equal_Area_Params = _libraries[
    'geotrans2.dll'
].Set_Cylindrical_Equal_Area_Params
Set_Cylindrical_Equal_Area_Params.restype = c_long
Set_Cylindrical_Equal_Area_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Cylindrical_Equal_Area_Structure,
]
Get_Cylindrical_Equal_Area_Params = _libraries[
    'geotrans2.dll'
].Get_Cylindrical_Equal_Area_Params
Get_Cylindrical_Equal_Area_Params.restype = c_long
Get_Cylindrical_Equal_Area_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Cylindrical_Equal_Area_Parameters),
]
Set_Cylindrical_Equal_Area_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Cylindrical_Equal_Area_Coordinates
Set_Cylindrical_Equal_Area_Coordinates.restype = c_long
Set_Cylindrical_Equal_Area_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Cylindrical_Equal_Area_Tuple_Structure,
]
Get_Cylindrical_Equal_Area_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Cylindrical_Equal_Area_Coordinates
Get_Cylindrical_Equal_Area_Coordinates.restype = c_long
Get_Cylindrical_Equal_Area_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Cylindrical_Equal_Area_Tuple),
]
...
Get_Eckert6_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Eckert6_Parameters),
]
Set_Eckert6_Coordinates = _libraries['geotrans2.dll'].Set_Eckert6_Coordinates
Set_Eckert6_Coordinates.restype = c_long
Set_Eckert6_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Eckert6_Tuple_Structure,
]
Get_Eckert6_Coordinates = _libraries['geotrans2.dll'].Get_Eckert6_Coordinates
Get_Eckert6_Coordinates.restype = c_long
Get_Eckert6_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Eckert6_Tuple),
]
Set_Equidistant_Cylindrical_Params = _libraries[
    'geotrans2.dll'
].Set_Equidistant_Cylindrical_Params
Set_Equidistant_Cylindrical_Params.restype = c_long
Set_Equidistant_Cylindrical_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Equidistant_Cylindrical_Structure,
]
Get_Equidistant_Cylindrical_Params = _libraries[
    'geotrans2.dll'
].Get_Equidistant_Cylindrical_Params
Get_Equidistant_Cylindrical_Params.restype = c_long
Get_Equidistant_Cylindrical_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Equidistant_Cylindrical_Parameters),
]
Set_Equidistant_Cylindrical_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Equidistant_Cylindrical_Coordinates
Set_Equidistant_Cylindrical_Coordinates.restype = c_long
Set_Equidistant_Cylindrical_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Equidistant_Cylindrical_Tuple_Structure,
]
Get_Equidistant_Cylindrical_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Equidistant_Cylindrical_Coordinates
Get_Equidistant_Cylindrical_Coordinates.restype = c_long
Get_Equidistant_Cylindrical_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Equidistant_Cylindrical_Tuple),
]
...
Set_Miller_Cylindrical_Params = _libraries[
    'geotrans2.dll'
].Set_Miller_Cylindrical_Params
Set_Miller_Cylindrical_Params.restype = c_long
Set_Miller_Cylindrical_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Miller_Cylindrical_Structure,
]
Get_Miller_Cylindrical_Params = _libraries[
    'geotrans2.dll'
].Get_Miller_Cylindrical_Params
Get_Miller_Cylindrical_Params.restype = c_long
Get_Miller_Cylindrical_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Miller_Cylindrical_Parameters),
]
Set_Miller_Cylindrical_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Miller_Cylindrical_Coordinates
Set_Miller_Cylindrical_Coordinates.restype = c_long
Set_Miller_Cylindrical_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Miller_Cylindrical_Tuple_Structure,
]
Get_Miller_Cylindrical_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Miller_Cylindrical_Coordinates
Get_Miller_Cylindrical_Coordinates.restype = c_long
Get_Miller_Cylindrical_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Miller_Cylindrical_Tuple),
]
...
Set_Oblique_Mercator_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Oblique_Mercator_Structure,
]
...
Get_Oblique_Mercator_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Oblique_Mercator_Parameters),
]
Set_Oblique_Mercator_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Oblique_Mercator_Coordinates
Set_Oblique_Mercator_Coordinates.restype = c_long
Set_Oblique_Mercator_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Oblique_Mercator_Tuple_Structure,
]
Get_Oblique_Mercator_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Oblique_Mercator_Coordinates
Get_Oblique_Mercator_Coordinates.restype = c_long
Get_Oblique_Mercator_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Oblique_Mercator_Tuple),
]
Set_Orthographic_Params = _libraries['geotrans2.dll'].Set_Orthographic_Params
Set_Orthographic_Params.restype = c_long
Set_Orthographic_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Orthographic_Structure,
]
Get_Orthographic_Params = _libraries['geotrans2.dll'].Get_Orthographic_Params
Get_Orthographic_Params.restype = c_long
Get_Orthographic_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Orthographic_Parameters),
]
...
Set_Orthographic_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
...
Set_Polar_Stereo_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
...
Get_Polar_Stereo_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Polar_Stereo_Tuple),
]
...
Get_Polyconic_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Polyconic_Tuple),
]
...
Get_Sinusoidal_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Sinusoidal_Parameters),
]
Set_Sinusoidal_Coordinates = _libraries['geotrans2.dll'].Set_Sinusoidal_Coordinates
Set_Sinusoidal_Coordinates.restype = c_long
Set_Sinusoidal_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Sinusoidal_Tuple_Structure,
]
Get_Sinusoidal_Coordinates = _libraries['geotrans2.dll'].Get_Sinusoidal_Coordinates
Get_Sinusoidal_Coordinates.restype = c_long
Get_Sinusoidal_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Sinusoidal_Tuple),
]
Set_Stereographic_Params = _libraries['geotrans2.dll'].Set_Stereographic_Params
Set_Stereographic_Params.restype = c_long
Set_Stereographic_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Stereographic_Structure,
]
Get_Stereographic_Params = _libraries['geotrans2.dll'].Get_Stereographic_Params
Get_Stereographic_Params.restype = c_long
Get_Stereographic_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Stereographic_Parameters),
]
Set_Stereographic_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Stereographic_Coordinates
Set_Stereographic_Coordinates.restype = c_long
Set_Stereographic_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Stereographic_Tuple_Structure,
]
Get_Stereographic_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Stereographic_Coordinates
Get_Stereographic_Coordinates.restype = c_long
Get_Stereographic_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Stereographic_Tuple),
]
Set_Transverse_Cylindrical_Equal_Area_Params = _libraries[
    'geotrans2.dll'
].Set_Transverse_Cylindrical_Equal_Area_Params
Set_Transverse_Cylindrical_Equal_Area_Params.restype = c_long
Set_Transverse_Cylindrical_Equal_Area_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Transverse_Cylindrical_Equal_Area_Structure,
]
Get_Transverse_Cylindrical_Equal_Area_Params = _libraries[
    'geotrans2.dll'
].Get_Transverse_Cylindrical_Equal_Area_Params
Get_Transverse_Cylindrical_Equal_Area_Params.restype = c_long
Get_Transverse_Cylindrical_Equal_Area_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Transverse_Cylindrical_Equal_Area_Parameters),
]
Set_Transverse_Cylindrical_Equal_Area_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Transverse_Cylindrical_Equal_Area_Coordinates
Set_Transverse_Cylindrical_Equal_Area_Coordinates.restype = c_long
Set_Transverse_Cylindrical_Equal_Area_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Transverse_Cylindrical_Equal_Area_Tuple_Structure,
]
Get_Transverse_Cylindrical_Equal_Area_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Transverse_Cylindrical_Equal_Area_Coordinates
Get_Transverse_Cylindrical_Equal_Area_Coordinates.restype = c_long
Get_Transverse_Cylindrical_Equal_Area_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Transverse_Cylindrical_Equal_Area_Tuple),
]
Set_Transverse_Mercator_Params = _libraries[
    'geotrans2.dll'
].Set_Transverse_Mercator_Params
Set_Transverse_Mercator_Params.restype = c_long
Set_Transverse_Mercator_Params.argtypes = [
    File_Interactive,
    Input_Output,
    Transverse_Mercator_Structure,
]
Get_Transverse_Mercator_Params = _libraries[
    'geotrans2.dll'
].Get_Transverse_Mercator_Params
Get_Transverse_Mercator_Params.restype = c_long
Get_Transverse_Mercator_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Transverse_Mercator_Parameters),
]
Set_Transverse_Mercator_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Transverse_Mercator_Coordinates
Set_Transverse_Mercator_Coordinates.restype = c_long
Set_Transverse_Mercator_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Transverse_Mercator_Tuple_Structure,
]
Get_Transverse_Mercator_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Transverse_Mercator_Coordinates
Get_Transverse_Mercator_Coordinates.restype = c_long
Get_Transverse_Mercator_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Transverse_Mercator_Tuple),
]
...
Set_Van_der_Grinten_Params.argtypes = [
    File_Interactive,
    Input_Output,
...
Get_Van_der_Grinten_Params.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Van_der_Grinten_Parameters),
]
Set_Van_der_Grinten_Coordinates = _libraries[
    'geotrans2.dll'
].Set_Van_der_Grinten_Coordinates
Set_Van_der_Grinten_Coordinates.restype = c_long
Set_Van_der_Grinten_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    Van_der_Grinten_Tuple_Structure,
]
Get_Van_der_Grinten_Coordinates = _libraries[
    'geotrans2.dll'
].Get_Van_der_Grinten_Coordinates
Get_Van_der_Grinten_Coordinates.restype = c_long
Get_Van_der_Grinten_Coordinates.argtypes = [
    File_Interactive,
    Input_Output,
    POINTER(Van_der_Grinten_Tuple),
]
...
Get_Conversion_Errors.argtypes = [
    File_Interactive,
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
...
__all__ = [
    ...
    'Get_Transverse_Cylindrical_Equal_Area_Params',
    'BNG_Tuple_Structure',
    'NEYS_FIRST_STDP_ERROR',
    'RETURN_MSG_LENGTH',
    'ELLIPSE_INVALID_INDEX_ERROR',
    'AZEQ_EASTING_ERROR',
    'MGRS_NO_ERROR',
    'Get_Bonne_Params',
    'DATUM_CODE_LENGTH',
    'GARS_STR_15_MIN_ERROR',
    'GEOREF_LON_ERROR',
    'Local_Cartesian_Tuple',
    'ENGINE_STR_LAT_MIN_ERROR',
    'GNOM_INV_F_ERROR',
    ...
    'Polar_Stereo_Structure',
    'LAMBERT_2_SCALE_FACTOR_ERROR',
    'Get_Neys_Coordinates',
    'ALBERS_EASTING_ERROR',
    ...
    'TCEA_LAT_ERROR',
    'Get_Miller_Cylindrical_Coordinates',
    'ENGINE_INVALID_CODE_ERROR',
    'ALBERS_CENT_MER_ERROR',
    'CYEQ_NORTHING_ERROR',
    'GRIN_EASTING_ERROR',
    'Get_UTM_Params',
    'Lambert_Conformal_Conic_2_Tuple',
    'BNG_ELLIPSOID_ERROR',
    'DATUM_INVALID_SRC_INDEX_ERROR',
    'Set_Equidistant_Cylindrical_Params',
    'Eckert4_Tuple',
    'GARS_PRECISION_ERROR',
    'ELLIPSE_NOT_INITIALIZED_ERROR',
    ...
    'Cylindrical_Equal_Area_Tuple_Structure',
    'YELLOW',
    'ENGINE_ELLIPSOID_OVERFLOW',
    'Orthographic_Structure',
    'ENGINE_INVALID_DIRECTION',
    'AZEQ_ORIGIN_LAT_ERROR',
    'EQCY_NORTHING_ERROR',
    'Sinusoidal_Structure',
    'MERC_A_ERROR',
    'LOCCART_ORIENTATION_ERROR',
    'MGRS_ZONE_ERROR',
    'SINU_NORTHING_ERROR',
    'Get_Conversion_Errors',
    'Bonne',
    'ENGINE_NOT_USERDEF_ERROR',
    'Get_Mercator_Coordinates',
    'Set_Transverse_Cylindrical_Equal_Area_Coordinates',
    'Sinusoidal',
    'ECK6_CENT_MER_ERROR',
    'Orthographic_Tuple',
    'ELLIPSE_INITIALIZE_ERROR',
    'Precision',
    'GARS_LAT_ERROR',
    'GARS_Tuple_Structure',
    'ELLIPSE_IN_USE_ERROR',
    'TCEA_INV_F_ERROR',
    'Get_Ellipsoid_Name',
    'NZMG_NO_ERROR',
    'Lambert_Conformal_Conic_2',
    'File',
    'Cassini',
    'Miller_Cylindrical_Tuple_Structure',
    'Orthographic_Tuple_Structure',
    ...
    'No_Height',
    'Set_Precision',
    'ENGINE_INPUT_WARNING',
    'MERC_NO_ERROR',
    'ENGINE_OUTPUT_WARNING',
    'OMERC_INV_F_ERROR',
    'CYEQ_NO_ERROR',
    'Geodetic_Tuple_Structure',
    'Remove_Ellipsoid',
    ...
    'Albers_Equal_Area_Conic_Structure',
    'ENGINE_STRING_ERROR',
    'ELLIPSE_NOT_USERDEF_ERROR',
    'Bonne_Tuple_Structure',
    'Get_BNG_Coordinates',
    'Set_Lambert_Conformal_Conic_1_Coordinates',
    'Cassini_Parameters',
    'ALBERS_FIRST_STDP_ERROR',
    'Three_Param_Datum_Type',
    'TCEA_ORIGIN_LAT_ERROR',
    'MSL_EGM84_10D_NS_Height',
    'ENGINE_DATUM_WARNING',
    'Get_Cassini_Params',
    'LAMBERT_2_LON_ERROR',
    ...
    'Eckert4_Parameters',
    'Azimuthal_Equidistant_Tuple_Structure',
    'ENGINE_DATUM_DOMAIN_ERROR',
    'LAMBERT_2_FIRST_STDP_ERROR',
    'TCEA_NORTHING_ERROR',
    'MOLL_NORTHING_ERROR',
    'POLY_A_ERROR',
    ...
    'Get_Neys_Params',
    'TCEA_EASTING_ERROR',
    'ENGINE_ELLIPSE_IN_USE_ERROR',
    'ELLIPSE_INVALID_CODE_ERROR',
    'LAMBERT_1_EASTING_ERROR',
    'NEYS_NO_ERROR',
    'ENGINE_ZONE_ERROR',
    'Cassini_Structure',
    'LAMBERT_2_INV_F_ERROR',
    'MERC_EASTING_ERROR',
    'MERC_INV_F_ERROR',
    ...
    'Set_Lambert_Conformal_Conic_2_Params',
    'ENGINE_GEOID_ERROR',
    'LAMBERT_2_SECOND_STDP_ERROR',
    'LAMBERT_2_EASTING_ERROR',
    ...
    'MGRS_PRECISION_ERROR',
    'Get_Lambert_Conformal_Conic_1_Params',
    'LAMBERT_2_CENT_MER_ERROR',
    'BNG_EASTING_ERROR',
    'Set_Albers_Equal_Area_Conic_Params',
    'Equidistant_Cylindrical_Tuple_Structure',
    'USNG_HEMISPHERE_ERROR',
    'CASS_LAT_ERROR',
    'MILL_LON_ERROR',
    'Get_Eckert6_Coordinates',
    'Get_Geodetic_Params',
    'CASS_NO_ERROR',
    'Set_GARS_Coordinates',
    'Get_Eckert4_Params',
    ...
    'CASS_CENT_MER_ERROR',
    'ENGINE_PROJECTION_ERROR',
    'Geodetic_Parameters',
    'SINU_EASTING_ERROR',
    'Get_Coordinate_System_Index',
    'ALBERS_SECOND_STDP_ERROR',
    'Datum_Type',
    'LOCCART_LON_ERROR',
    'UPS_Tuple_Structure',
    'LAMBERT_1_CENT_MER_ERROR',
    'NEYS_LAT_ERROR',
    'ENGINE_HEMISPHERE_ERROR',
    'TRANMERC_NO_ERROR',
    'Get_Albers_Equal_Area_Conic_Params',
    'Coordinate_Types',
    'LAMBERT_1_SCALE_FACTOR_ERROR',
    'SINU_NO_ERROR',
    'MSL_EGM84_10D_BL_Height',
    'ORTH_INV_F_ERROR',
    'Get_Eckert6_Params',
    'ENGINE_FIRST_SECOND_ERROR',
    'Set_USNG_Coordinates',
    'Get_Gnomonic_Params',
    'Set_BNG_Coordinates',
    'ECK4_NO_ERROR',
    'Bonne_Parameters',
    ...
    'UTM_Parameters',
    'COORD_SYS_CODE_LENGTH',
    'MILL_NORTHING_ERROR',
    'GARS',
    'TCEA_SCALE_FACTOR_ERROR',
    'ENGINE_ORIGIN_LON_ERROR',
    'LAMBERT_1_NORTHING_ERROR',
    'POLAR_NO_ERROR',
    'Define_Datum_Types',
    'Van_der_Grinten_Tuple',
    'ECK4_INV_F_ERROR',
    'Get_USNG_Coordinates',
    'Eckert6_Parameters',
    'Get_Azimuthal_Equidistant_Params',
    'Transverse_Cylindrical_Equal_Area_Structure',
    'UPS_Tuple',
    ...
    'GEOREF_STR_ERROR',
    'ENGINE_LAT2_ERROR',
    'ENGINE_DATUM_SIGMA_ERROR',
    'Set_Local_Cartesian_Params',
    'ENGINE_ELLIPSOID_CODE_ERROR',
    'Set_Eckert6_Params',
    'Set_Bonne_Params',
    'USNG',
    ...
    'BONN_NORTHING_ERROR',
    'Get_UPS_Coordinates',
    'ENGINE_ELLIPSOID_ERROR',
    'OMERC_LAT_ERROR',
    'ENGINE_EASTING_ERROR',
    'Miller_Cylindrical_Structure',
    'ALBERS_HEMISPHERE_ERROR',
    'CASS_A_ERROR',
    'MILL_A_ERROR',
    'ENGINE_RADIUS_ERROR',
    ...
    'LAMBERT_1_INV_F_ERROR',
    'STEREO_EASTING_ERROR',
    'MGRS_Tuple_Structure',
    'ENGINE_DATUM_ERROR',
    'ECK4_EASTING_ERROR',
    'Miller_Cylindrical',
    'ENGINE_INVALID_AREA_ERROR',
    'Mollweide_Tuple_Structure',
    'Get_MGRS_Coordinates',
    'ENGINE_CENT_MER_ERROR',
    'ALBERS_NO_ERROR',
    'GNOM_EASTING_ERROR',
    ...
    'Transverse_Mercator_Tuple_Structure',
    'Neys_Tuple',
    'ELLIPSOID_NAME_LENGTH',
    'Mollweide_Tuple',
    'Coordinate_Type',
    'STEREO_ORIGIN_LAT_ERROR',
    'USNG_Tuple_Structure',
    'ENGINE_STR_LON_MIN_ERROR',
    'Set_Conversion_Errors',
    'Equidistant_Cylindrical_Tuple',
    'DATUM_ROTATION_ERROR',
    'Eckert4_Structure',
    'OMERC_NO_ERROR',
    'LAMBERT_2_LAT_ERROR',
    'Eckert4',
    ...
    'ENGINE_LAT1_LAT2_ERROR',
    'ENGINE_ZONE_OVERRIDE_ERROR',
    'OMERC_LAT1_ERROR',
    'GARS_STR_LON_ERROR',
    'EQCY_CENT_MER_ERROR',
    ...
    'ENGINE_LAT_WARNING',
    'Transverse_Mercator',
    'NEYS_SCALE_FACTOR_ERROR',
    'Polar_Stereo',
    'Get_Cylindrical_Equal_Area_Coordinates',
    'UTM_NORTHING_ERROR',
    'POLAR_ORIGIN_LON_ERROR',
    'MSL_EGM96_VG_NS_Height',
    'LOCCART_ORIGIN_LON_ERROR',
    'Ten_Thousandth_of_Second',
    ...
    'Seven_Param_Datum',
    'Convert_Ellipsoid_To_Geoid_Height',
    'ALBERS_ORIGIN_LAT_ERROR',
    'NEYS_CENT_MER_ERROR',
    'Cylindrical_Equal_Area_Structure',
    'GEOREF',
    'Output',
    'POLAR_LON_ERROR',
    'MERC_LAT_OF_TRUE_SCALE_ERROR',
