...
"""Setup.py for the apache-airflow-backport-providers-mysql package."""
...
def do_setup():
    """Perform the package apache-airflow-backport-providers-mysql setup."""
    setup(
        name='apache-airflow-backport-providers-mysql',
