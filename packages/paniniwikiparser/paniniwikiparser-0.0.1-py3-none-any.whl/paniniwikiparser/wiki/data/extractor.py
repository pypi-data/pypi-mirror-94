...
ROOT_DIR = os.path.dirname(os.path.abspath("wikiextractor.py"))
dbinsertion_path=ROOT_DIR+"\paniniwikiparser\wiki\db"
common_path=ROOT_DIR+"\paniniwikiparser\common"
data_path=ROOT_DIR+"\paniniwikiparser\wiki\data"

sys.path.insert(0,dbinsertion_path)
