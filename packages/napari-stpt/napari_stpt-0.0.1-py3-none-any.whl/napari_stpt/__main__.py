...
def main():
    with napari.gui_qt():
        ...
        hbox = QHBoxLayout()
        hbox.addWidget(QLabel("Data folder:"))
        global search_folder
        search_folder = QLineEdit('N:/stpt/')
        search_folder.setMaximumWidth(250)
        hbox.addWidget(search_folder)
        bSelectFolder = QPushButton('Set folder')
        ...
        hbox.addWidget(QLabel("Output pixel size:"))
        global pixel_size
        pixel_size = QLineEdit("7.5")
        ...
        hbox = QHBoxLayout()
        hbox.addWidget(QLabel("Load channels:"))
        cb_C1 = QCheckBox('1')
