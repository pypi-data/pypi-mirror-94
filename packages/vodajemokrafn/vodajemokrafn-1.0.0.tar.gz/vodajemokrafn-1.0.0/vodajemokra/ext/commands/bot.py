...
from vodajemokra.client import Client
from vodajemokra.auth import Auth
from vodajemokra.typedefs import MaybeCoro, ListOrTuple
...
class Bot(GroupMixin, Client):
    ...
    This class is a subclass of :class:`vodajemokra.Client` and as a result
    anything that you can do with a :class:`vodajemokra.Client` you can do with
    this bot.
    ...
    command_prefix
        ...
        as its first parameter and :class:`vodajemokra.FriendMessage` or
        :class:`vodajemokra.PartyMessage` as its second parameter and returns
    ...
    async def get_prefix(self, message: Message) -> Any:
        ...
        Parameters
        ----------
        message: Union[:class:`vodajemokra.FriendMessage`, :class:`vodajemokra.PartyMessage`]
