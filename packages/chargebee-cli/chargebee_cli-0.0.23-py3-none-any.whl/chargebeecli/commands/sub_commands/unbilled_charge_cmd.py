...
from chargebeecli.processors.unbilled_chrages.unbilled_charge import UnbilledCharge
from chargebeecli.util.theme_util import get_active_theme


@click.command("unbilled_charge", help='endpoint to perform operation on [unbilled_charge] resource')
@click.pass_context
...
def cmd(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    UnbilledCharge(export_format=export_format, export_path=export_path, file_name=export_filename,
