...
from chargebeecli.processors.coupon_sets.coupon_sets import CouponSet
from chargebeecli.util.theme_util import get_active_theme


@click.command("coupon_set", help='endpoint to perform operation on [coupon_set] resource')
@click.pass_context
...
def cmd(ctx,id,  operation, columns, format, export_filename, export_format, export_path):
    CouponSet(export_format=export_format, export_path=export_path, file_name=export_filename,
