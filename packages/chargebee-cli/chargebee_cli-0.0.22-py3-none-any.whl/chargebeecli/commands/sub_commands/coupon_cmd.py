...
from chargebeecli.processors.coupons.coupons import Coupons
from chargebeecli.util.theme_util import get_active_theme


@click.command("coupon", help='endpoint to perform operation on coupon resource')
@click.pass_context
...
def cmd(ctx, id ,operation, columns, format, export_filename, export_format, export_path):
    Coupons(export_format=export_format, export_path=export_path, file_name=export_filename,
