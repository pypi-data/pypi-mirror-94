...
from chargebeecli.processors.hosted_pages.hosted_pages import HostedPage
from chargebeecli.util.theme_util import get_active_theme


@click.command("hosted_page", help='endpoint to perform operation on [hosted_page] resource')
@click.pass_context
...
def cmd(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    HostedPage(export_format=export_format, export_path=export_path, file_name=export_filename,
