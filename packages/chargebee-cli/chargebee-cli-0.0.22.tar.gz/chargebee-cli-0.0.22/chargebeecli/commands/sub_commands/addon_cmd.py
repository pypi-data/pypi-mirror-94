...
from chargebeecli.processors.addons.addons import Addons
from chargebeecli.util.theme_util import get_active_theme


@click.command("addon", help='endpoint to perform operation on addon resource')
@click.pass_context
...
def cmd(ctx, id, operation, columns, format, export_filename, export_format, export_path):
    Addons(export_format=export_format, export_path=export_path, file_name=export_filename,
