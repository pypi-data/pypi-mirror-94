...
class ComponentRunHelper:
    ...
    @track(_get_logger)
    def _handle_component_run_result(self, component_run_success,
                                     command_execution, conda_environment_name, env_log_path):
        """
        ...
        if self.use_docker and not component_run_success and command_execution:
            _prepare_debug_config_for_component(
                self.component, command_execution, self.snapshot_path, conda_environment_name)
        ...
        with self.logger:
            try:
                ...
                component_run_status = self._handle_component_run_result(
                    component_run_success, command_execution,
                    component_environment.conda_environment_name if component_environment else None, env_log_path)
...
def _prepare_debug_config_for_component(component, command_execution, snapshot_path, conda_environment_name):
    """
