...
from .exceptions import wrap_methods_with_decorator
...
class DesignerServiceClient(SDKClient):
    ...
    def __init__(
        ...
        self.component = ComponentOperations(
            self._client, self.config, self._serialize, self._deserialize)
        wrap_methods_with_decorator(self.component)
        ...
        self.runs = RunsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        wrap_methods_with_decorator(self.runs)
