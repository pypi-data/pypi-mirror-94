...
class PipelineData(object):
    ...
    :param dataset_output_options: output dataset options, contains source_glob, and relative path_on_datastore
    :type dataset_output_options: DatasetOutputOptions
    """
    def __init__(self, name, datastore=None, output_name=None, output_mode="mount", output_path_on_compute=None,
                 dataset_output_options: DatasetOutputOptions = None, output_overwrite=None, is_directory=None,
                 dataset_registration: DatasetRegistration = None):
        import re
        ...
        self._dataset_output_options = dataset_output_options

        if self._output_mode not in ["mount", "upload", None]:
