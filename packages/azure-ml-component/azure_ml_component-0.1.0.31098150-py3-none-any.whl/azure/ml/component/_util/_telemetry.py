    ...
    def _get_telemetry_value_from_workspace(workspace: Workspace):
        ...
        * tenant_id
        ...
        try:
            ...
            workspace_id = workspace._workspace_id
            if workspace_id in WorkspaceTelemetryMixin._workspace_tenant_ids:
                tenant_id = WorkspaceTelemetryMixin._workspace_tenant_ids[workspace_id]
            else:
                from azureml._base_sdk_common.common import fetch_tenantid_from_aad_token
                tenant_id = fetch_tenantid_from_aad_token(workspace._auth_object._get_arm_token())
                WorkspaceTelemetryMixin._workspace_tenant_ids[workspace_id] = tenant_id
            telemetry_values['tenant_id'] = tenant_id
