...
from azure.ml.component.dsl._utils import _sanitize_python_class_name, logger, BackUpFiles, _log_file_skip, \
    ...
    _has_dsl_component_str, _get_component_path_and_name_from_source, _relative_to, timer_decorator, _source_exists, \
...
from azure.ml.component._util._utils import _sanitize_python_variable_name, \
    _sanitize_python_variable_name_with_value_check, _str_to_bool, _try_to_get_workspace
    ...
    def create(self):
        ...
        with open(self.template, encoding=FILE_ENCODING) as file:
            ...
            if '_TEST_ENV' in os.environ:
                # TODO: After splitting component.run in single thread, change mode to conda.
                ut_code = ut_code.replace("mode='docker'", "mode='host'")
