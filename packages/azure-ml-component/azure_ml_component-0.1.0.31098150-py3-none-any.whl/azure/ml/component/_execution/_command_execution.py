...
class CommandExecution:
    ...
    def __init__(self, command, command_environment, logger, cwd=None, environment_variables={}, volumes=None):
        """
    ...
    def local_run(self):
        ...
        command = _convert_to_shell_execution_command(
            self.command, self.command_environment.conda_environment_name)
