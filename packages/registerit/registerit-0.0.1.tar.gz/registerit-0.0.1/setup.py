...
setup(
    ...
    url='https://github.com/alexioannides/registerme',
    project_urls={
        'Source': 'https://github.com/alexioannides/registerme',
        'Documentation': 'https://github.com/alexioannides/registerme'
    },
    package_dir={'': 'src'},
    ...
    entry_points={
        'console_scripts': [
            'registerme=registerme.cli.cli:cli'
        ]
    },
    classifiers=[
