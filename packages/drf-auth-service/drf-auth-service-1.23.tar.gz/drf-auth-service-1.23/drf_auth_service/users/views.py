...
class UserViewSet(
    ...
    @action(detail=True, methods=['POST'], serializer_create_class=settings.SERIALIZERS.USER_CONFIRM_SERIALIZER,
    ...
    def user_confirm(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        ActivationCode.make_user_active(self.get_object())
        return Response(BaseBackend.get_jwt_response(self.get_object()))
