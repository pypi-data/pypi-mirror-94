...
[boto3.CustomerProfiles 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/customer-profiles.html#CustomerProfiles) service
compatible with
