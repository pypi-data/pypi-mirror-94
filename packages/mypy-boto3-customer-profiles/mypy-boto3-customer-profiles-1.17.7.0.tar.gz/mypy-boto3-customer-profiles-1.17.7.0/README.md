...
[boto3.CustomerProfiles 1.17.7](https://boto3.amazonaws.com/v1/documentation/api/1.17.7/reference/services/customer-profiles.html#CustomerProfiles) service
compatible with
