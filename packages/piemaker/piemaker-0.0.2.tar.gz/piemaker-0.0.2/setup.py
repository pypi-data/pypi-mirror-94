...
setuptools.setup(
    name="piemaker", # Put your username here!
    version="0.0.2", # The version of your package!
    author="Quantumgames", # Your name here!
    author_email="alex.evans@gm.fsd38.ab.ca", # Your e-mail here!
    description="testtttt", # A short description here!
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/jetmaster101/piemaker", # Link your package website here! (most commonly a GitHub repo)
