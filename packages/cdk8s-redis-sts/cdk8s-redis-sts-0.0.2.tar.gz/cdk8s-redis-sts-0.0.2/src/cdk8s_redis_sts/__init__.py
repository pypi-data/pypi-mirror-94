...
class MyRedis(
    ...
    jsii_type="@Hunter-Thompson/cdk8s-redis-sts.MyRedis",
):
    """
...
@jsii.data_type(
    jsii_type="@Hunter-Thompson/cdk8s-redis-sts.ResourceQuantity",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@Hunter-Thompson/cdk8s-redis-sts.ResourceRequirements",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@Hunter-Thompson/cdk8s-redis-sts.StsOpts",
    jsii_struct_bases=[],
    name_mapping={
        "image": "image",
        "namespace": "namespace",
