...
DB_URL = "mongodb://root:GCxM!)Sr4Xky[~_E@titipakorn.xyz:27000"
...
if __name__ == "__main__":
    ...
    test_string2 = "อยากถามเอไอเอสว่าเอาเน็ตสมัยไหนมาให้ใช้กระตุกมากๆ ทั้งเกมทั้งยูทูป เรียนอีก บางทีหลุดด้วย"
    ...
    result, sentiment = do_sentiment_whole_news(test_string2)
    print(result)
    print(sentiment)
