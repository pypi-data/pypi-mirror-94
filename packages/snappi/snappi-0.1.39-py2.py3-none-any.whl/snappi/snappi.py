...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureVlan, CaptureCustom, CaptureEthernet, CaptureIpv4, CaptureFilter]
        return self._getitem(key)
...
class FlowBitPatternList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowBitList, FlowBitCounter, FlowBitPattern]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowUdp, FlowCustom, FlowEthernetPause, FlowTcp, FlowVlan, FlowIpv6, FlowGtpv2, FlowArp, FlowPpp, FlowIgmpv1, FlowGre, FlowGtpv1, FlowHeader, FlowVxlan, FlowIpv4, FlowPfcPause, FlowEthernet]
        return self._getitem(key)
