...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureFilter, CaptureVlan, CaptureIpv4, CaptureEthernet, CaptureCustom]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowTcp, FlowGre, FlowCustom, FlowEthernetPause, FlowVxlan, FlowHeader, FlowGtpv2, FlowPfcPause, FlowEthernet, FlowUdp, FlowIgmpv1, FlowPpp, FlowVlan, FlowGtpv1, FlowArp, FlowIpv4, FlowIpv6]
        return self._getitem(key)
