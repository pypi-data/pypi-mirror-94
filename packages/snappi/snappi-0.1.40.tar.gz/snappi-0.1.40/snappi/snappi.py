...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureFilter, CaptureVlan, CaptureCustom, CaptureIpv4, CaptureEthernet]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowHeader, FlowIpv4, FlowGre, FlowPfcPause, FlowUdp, FlowGtpv1, FlowPpp, FlowVlan, FlowTcp, FlowEthernet, FlowEthernetPause, FlowGtpv2, FlowIpv6, FlowArp, FlowCustom, FlowVxlan, FlowIgmpv1]
        return self._getitem(key)
