...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureEthernet, CaptureVlan, CaptureCustom, CaptureIpv4, CaptureFilter]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowUdp, FlowPfcPause, FlowGre, FlowPpp, FlowArp, FlowGtpv1, FlowEthernetPause, FlowHeader, FlowEthernet, FlowCustom, FlowIpv4, FlowVlan, FlowGtpv2, FlowVxlan, FlowTcp, FlowIgmpv1, FlowIpv6]
        return self._getitem(key)
