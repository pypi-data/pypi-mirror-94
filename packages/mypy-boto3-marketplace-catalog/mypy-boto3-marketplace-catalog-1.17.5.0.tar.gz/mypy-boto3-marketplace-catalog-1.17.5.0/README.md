...
[boto3.MarketplaceCatalog 1.17.5](https://boto3.amazonaws.com/v1/documentation/api/1.17.5/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
