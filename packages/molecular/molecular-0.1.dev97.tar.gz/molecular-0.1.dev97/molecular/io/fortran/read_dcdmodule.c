 ...
 * Generation date: Sun Feb  7 22:44:10 2021
...
/* See f2py2e/rules.py */
extern void F_FUNC_US(read_dcd_header,READ_DCD_HEADER)(string,int*,int*,size_t);
...
/****************************** read_dcd_header ******************************/
static char doc_f2py_rout_read_dcd_read_dcd_header[] = "\
nstr,natom = read_dcd_header(fname)\n\nWrapper for ``read_dcd_header``.\
\n\nParameters\n----------\n"
...
"natom : int";
/* extern void F_FUNC_US(read_dcd_header,READ_DCD_HEADER)(string,int*,int*,size_t); */
static PyObject *f2py_rout_read_dcd_read_dcd_header(const PyObject *capi_self,
                           PyObject *capi_args,
...
f2py_start_clock();
    ...
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "O|:read_dcd.read_dcd_header",\
        capi_kwlist,&fname_capi))
        return NULL;
/*frompyobj*/
  /* Processing variable fname */
  slen(fname) = 256;
  f2py_success = string_from_pyobj(&fname,&slen(fname),"",fname_capi,"string_from_pyobj failed in converting 1st argument `fname' of read_dcd.read_dcd_header to C string");
  if (f2py_success) {
...
#endif
/*callfortranroutine*/
        (*f2py_func)(fname,&nstr,&natom,slen(fname));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
        ...
        capi_buildvalue = Py_BuildValue("ii",nstr,natom);
/*closepyobjfrom*/
...
static FortranDataDef f2py_routine_defs[] = {
  {"read_dcd_header",-1,{{-1}},0,(char *)F_FUNC_US(read_dcd_header,READ_DCD_HEADER),(f2py_init_func)f2py_rout_read_dcd_read_dcd_header,doc_f2py_rout_read_dcd_read_dcd_header},
