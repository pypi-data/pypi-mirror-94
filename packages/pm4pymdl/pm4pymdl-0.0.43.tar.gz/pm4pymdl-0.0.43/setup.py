...
setup(
    ...
    packages=['pm4pymdl', 'pm4pymdl.algo', 'pm4pymdl.algo.mvp', 'pm4pymdl.algo.mvp.utils',
              ...
              'pm4pymdl.objects.xoc.importer', 'pm4pymdl.objects.xoc.importer.versions', 'pm4pymdl.objects.ocel',
              'pm4pymdl.objects.ocel.exporter', 'pm4pymdl.objects.ocel.importer', 'pm4pymdl.objects.sqlite',
