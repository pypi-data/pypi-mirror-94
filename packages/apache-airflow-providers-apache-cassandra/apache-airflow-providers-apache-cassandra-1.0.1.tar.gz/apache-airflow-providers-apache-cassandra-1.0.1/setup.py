...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.0.0', 'cassandra-driver>=3.13.0,<3.21.0'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-apache-cassandra/1.0.1/',
