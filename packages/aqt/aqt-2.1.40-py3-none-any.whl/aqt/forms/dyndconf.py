...
# Form implementation generated from reading ui file 'qt/aqt/forms/dyndconf.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(tr(TR.ACTIONS_FILTER))
        self.label_5.setText(tr(TR.DECKS_LIMIT_TO))
        self.label_2.setText(tr(TR.ACTIONS_SEARCH))
        self.label.setText(tr(TR.DECKS_CARDS_SELECTED_BY))
        self.filter2group.setTitle(tr(TR.DECKS_FILTER_2))
        self.label_6.setText(tr(TR.DECKS_LIMIT_TO))
        self.label_3.setText(tr(TR.ACTIONS_SEARCH))
        self.label_4.setText(tr(TR.DECKS_CARDS_SELECTED_BY))
        self.groupBox_2.setTitle(tr(TR.ACTIONS_OPTIONS))
        self.resched.setText(tr(TR.DECKS_RESCHEDULE_CARDS_BASED_ON_MY_ANSWERS))
        self.secondFilter.setText(tr(TR.DECKS_ENABLE_SECOND_FILTER))
        self.label_7.setText(tr(TR.DECKS_REPEAT_FAILED_CARDS_AFTER))
        self.label_8.setText(tr(TR.DECKS_MINUTES))
        self.stepsOn.setText(tr(TR.DECKS_CUSTOM_STEPS_IN_MINUTES))
