...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.previewButton.setShortcut("Ctrl+Shift+P")
        ...
        self.actionReschedule.setShortcut("Ctrl+Alt+R")
        ...
        self.actionUndo.setShortcut("Ctrl+Alt+Z")
        ...
        self.actionTags.setShortcut("Ctrl+Shift+F")
        ...
        self.actionRemove_Tags.setShortcut("Ctrl+Shift+D")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.searchButton.setText(tr(TR.ACTIONS_SEARCH))
        self.previewButton.setText(tr(TR.ACTIONS_PREVIEW))
        self.filter.setText(tr(TR.BROWSING_FILTER))
        self.menuEdit.setTitle(tr(TR.QT_ACCEL_EDIT))
        self.menuJump.setTitle(tr(TR.QT_ACCEL_GO))
        self.menu_Help.setTitle(tr(TR.QT_ACCEL_HELP))
        self.menu_Cards.setTitle(tr(TR.QT_ACCEL_CARDS))
        self.menuFlag.setTitle(tr(TR.BROWSING_FLAG))
        self.menu_Notes.setTitle(tr(TR.QT_ACCEL_NOTES))
        self.actionReschedule.setText(tr(TR.QT_ACCEL_RESCHEDULE))
        self.actionSelectAll.setText(tr(TR.QT_ACCEL_SELECT_ALL))
        self.actionUndo.setText(tr(TR.QT_ACCEL_UNDO))
        self.actionInvertSelection.setText(tr(TR.QT_ACCEL_INVERT_SELECTION))
        self.actionFind.setText(tr(TR.QT_ACCEL_FIND))
        self.actionNote.setText(tr(TR.QT_ACCEL_NOTE))
        self.actionNextCard.setText(tr(TR.QT_ACCEL_NEXT_CARD))
        self.actionPreviousCard.setText(tr(TR.QT_ACCEL_PREVIOUS_CARD))
        self.actionGuide.setText(tr(TR.QT_ACCEL_GUIDE))
        self.actionChangeModel.setText(tr(TR.BROWSING_CHANGE_NOTE_TYPE2))
        self.actionSelectNotes.setText(tr(TR.QT_ACCEL_SELECT_NOTES))
        self.actionFindReplace.setText(tr(TR.QT_ACCEL_FIND_AND_REPLACE))
        self.actionTags.setText(tr(TR.QT_ACCEL_FILTER))
        self.actionCardList.setText(tr(TR.BROWSING_CARD_LIST))
        self.actionFindDuplicates.setText(tr(TR.QT_ACCEL_FIND_DUPLICATES))
        self.actionReposition.setText(tr(TR.BROWSING_REPOSITION))
        self.actionFirstCard.setText(tr(TR.BROWSING_FIRST_CARD))
        self.actionLastCard.setText(tr(TR.BROWSING_LAST_CARD))
        self.actionClose.setText(tr(TR.ACTIONS_CLOSE))
        self.action_Info.setText(tr(TR.QT_ACCEL_INFO))
        self.actionAdd_Tags.setText(tr(TR.BROWSING_ADD_TAGS2))
        self.actionRemove_Tags.setText(tr(TR.BROWSING_REMOVE_TAGS))
        self.actionToggle_Suspend.setText(tr(TR.BROWSING_TOGGLE_SUSPEND))
        self.actionDelete.setText(tr(TR.ACTIONS_DELETE))
        self.actionAdd.setText(tr(TR.BROWSING_ADD_NOTES))
        self.actionChange_Deck.setText(tr(TR.BROWSING_CHANGE_DECK2))
        self.actionRed_Flag.setText(tr(TR.ACTIONS_RED_FLAG))
        self.actionOrange_Flag.setText(tr(TR.ACTIONS_ORANGE_FLAG))
        self.actionGreen_Flag.setText(tr(TR.ACTIONS_GREEN_FLAG))
        self.actionBlue_Flag.setText(tr(TR.ACTIONS_BLUE_FLAG))
        self.actionSidebar.setText(tr(TR.BROWSING_SIDEBAR))
        self.actionClear_Unused_Tags.setText(tr(TR.BROWSING_CLEAR_UNUSED_TAGS))
        self.actionManage_Note_Types.setText(tr(TR.BROWSING_MANAGE_NOTE_TYPES))
        self.actionToggle_Mark.setText(tr(TR.BROWSING_TOGGLE_MARK))
        self.actionExport.setText(tr(TR.QT_ACCEL_EXPORT_NOTES))
