...
# Form implementation generated from reading ui file 'qt/aqt/forms/reschedule.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(tr(TR.BROWSING_RESCHEDULE))
        self.asNew.setText(tr(TR.BROWSING_PLACE_AT_END_OF_NEW_CARD))
        self.asRev.setText(tr(TR.BROWSING_PLACE_IN_REVIEW_QUEUE_WITH_INTERVAL))
        self.label_4.setText(tr(TR.SCHEDULING_DAYS))
