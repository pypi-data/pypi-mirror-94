...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_31.setText(tr(TR.SCHEDULING_OPTIONS_GROUP))
        self.confOpts.setText(tr(TR.ACTIONS_MANAGE))
        self.label_24.setText(tr(TR.SCHEDULING_STARTING_EASE))
        self.label_8.setText(tr(TR.SCHEDULING_ORDER))
        self.label_5.setText(tr(TR.SCHEDULING_EASY_INTERVAL))
        self.label_4.setText(tr(TR.SCHEDULING_GRADUATING_INTERVAL))
        self.label_6.setText(tr(TR.SCHEDULING_NEW_CARDSDAY))
        self.label_2.setText(tr(TR.SCHEDULING_STEPS_IN_MINUTES))
        self.bury.setText(tr(TR.SCHEDULING_BURY_RELATED_NEW_CARDS_UNTIL_THE))
        self.label_9.setText(tr(TR.SCHEDULING_DAYS))
        self.label_7.setText(tr(TR.SCHEDULING_DAYS))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), tr(TR.SCHEDULING_NEW_CARDS))
        self.label_20.setText(tr(TR.SCHEDULING_EASY_BONUS))
        self.label_33.setText(tr(TR.SCHEDULING_INTERVAL_MODIFIER))
        self.label_37.setText(tr(TR.SCHEDULING_MAXIMUM_REVIEWSDAY))
        self.label_3.setText(tr(TR.SCHEDULING_MAXIMUM_INTERVAL))
        self.label_23.setText(tr(TR.SCHEDULING_DAYS))
        self.buryRev.setText(tr(TR.SCHEDULING_BURY_RELATED_REVIEWS_UNTIL_THE_NEXT))
        self.hardFactorLabel.setText(tr(TR.SCHEDULING_HARD_INTERVAL))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), tr(TR.SCHEDULING_REVIEWS))
        self.label_17.setText(tr(TR.SCHEDULING_STEPS_IN_MINUTES))
        self.label.setText(tr(TR.SCHEDULING_NEW_INTERVAL))
        self.label_10.setText(tr(TR.SCHEDULING_LEECH_THRESHOLD))
        self.label_11.setText(tr(TR.SCHEDULING_LAPSES2))
        self.label_12.setText(tr(TR.SCHEDULING_LEECH_ACTION))
        self.label_13.setText(tr(TR.SCHEDULING_MINIMUM_INTERVAL))
        self.label_14.setText(tr(TR.SCHEDULING_DAYS))
        self.leechAction.setItemText(0, tr(TR.ACTIONS_SUSPEND_CARD))
        self.leechAction.setItemText(1, tr(TR.SCHEDULING_TAG_ONLY))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), tr(TR.SCHEDULING_LAPSES))
        self.label_25.setText(tr(TR.SCHEDULING_IGNORE_ANSWER_TIMES_LONGER_THAN))
        self.label_26.setText(tr(TR.SCHEDULING_SECONDS))
        self.showTimer.setText(tr(TR.SCHEDULING_SHOW_ANSWER_TIMER))
        self.autoplaySounds.setText(tr(TR.SCHEDULING_AUTOMATICALLY_PLAY_AUDIO))
        self.replayQuestion.setText(tr(TR.SCHEDULING_ALWAYS_INCLUDE_QUESTION_SIDE_WHEN_REPLAYING))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), tr(TR.SCHEDULING_GENERAL))
        self.label_22.setText(tr(TR.SCHEDULING_DESCRIPTION_TO_SHOW_ON_OVERVIEW_SCREEN))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), tr(TR.SCHEDULING_DESCRIPTION))
