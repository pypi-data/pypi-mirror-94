...
class TestDeviceCertBuilder(unittest.TestCase):
    ...
    def _mock_protocol(self):
        ...
        mock_protocol.read_ecc_serialnumber.return_value = ECC_SERIAL
        mock_protocol.read_public_key.return_value = self.devkey_response
        mock_protocol.sign_digest.return_value = self.devsign_response
    ...
    def test_build_device_cert(self):
        ...
        mock_protocol = self._mock_protocol()

        device_cert = build_device_cert(SIGNER_CA_CERT_FILE,
                                        SIGNER_CA_KEY_FILE, mock_protocol,
                                        DEVICE_CSR_FILE_CERT_BUILD, DEVICE_CERT_FILE, force=True)
    ...
    def test_build_device_csr(self):
        ...
        generated_csr = build_device_csr(mock_protocol, DEVICE_CSR_FILE_CSR_BUILD, DEVICE_COMMON_NAME, force=True)
