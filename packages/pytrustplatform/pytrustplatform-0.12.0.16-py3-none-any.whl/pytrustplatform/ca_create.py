...
def ca_create_root(root_ca_key_path, root_ca_cert_path, force=False,
    ...
    if org_name == DEFAULT_ORGANIZATION_NAME or common_name == DEFAULT_ROOT_COMMON_NAME:
        logger.warning("Default organization name '%s' and/or common name '%s' used for root certificate",
                       DEFAULT_ORGANIZATION_NAME, DEFAULT_ROOT_COMMON_NAME)
...
def ca_create_signer_csr(signer_ca_key_path, signer_ca_csr_path, force=False,
    ...
    if org_name == DEFAULT_ORGANIZATION_NAME or common_name == DEFAULT_SIGNER_COMMON_NAME:
        logger.warning("Default organization name '%s' and/or common name '%s' used for signer certificate",
                       DEFAULT_ORGANIZATION_NAME, DEFAULT_SIGNER_COMMON_NAME)
