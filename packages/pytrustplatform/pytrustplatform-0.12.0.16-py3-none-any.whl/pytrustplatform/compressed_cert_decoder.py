"""
.. module:: compressed_cert
   :synopsis: A useful module indeed.

.. moduleauthor:: Lars Haring
...
class CompressedCertificateData():
    ...
    def read_from_kit(self, protocol):
        """
        ...
        self.ecc_serial_number = binascii.a2b_hex(protocol.read_ecc_serialnumber())
        self.compressed_signer_cert = binascii.a2b_hex(protocol.read_ecc_slot(12, 72))
        self.compressed_device_cert = binascii.a2b_hex(protocol.read_ecc_slot(10, 72))
        self.device_pkey = binascii.a2b_hex(protocol.read_public_key())
        padded_signer_key = binascii.a2b_hex(protocol.read_ecc_slot(11, 72))
    ...
    def read_from_kit_slot5(self, protocol):
        """
        ...
        self.device_eui48 = binascii.a2b_hex(protocol.read_ecc_slot(5, 36)[:12])
        self.logger.debug(binascii.b2a_hex(self.device_eui48))
