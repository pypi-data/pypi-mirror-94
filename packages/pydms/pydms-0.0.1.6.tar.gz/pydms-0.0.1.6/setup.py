...
setuptools.setup(
    executable=True,
    name="pydms",  # Replace with your own username
    version=version,
    author="Wang Pei",
    author_email="1535376447@qq.com",
    description="python distributed micro-services building tools.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="http://github.com/Peiiii/pydms",
    packages=packages,
    package_dir={'pydms': 'pydms'},
    install_requires=[
        'fire'
    ],
    entry_points={
        'console_scripts': [
            'pydms = pydms.clitools.cli:main',
        ]
    },
