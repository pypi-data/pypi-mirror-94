{
  ...
  "An error occured during AJAX request. Could not load view.": [
    null, 
    "AJAX-kutsussa tapahtui virhe. Näkymää ei voitu ladata."
  ], 
  ...
  "Please select the file to upload again": [
    null, 
    "Ole hyvä ja valitse uudelleen ladattava aineisto"
  ], 
  "Remove": [
    null, 
    "Poista"
  ...
  "You can rearrange the resources by dragging them using the arrow icon. Drag the resource to the right and place it to the desired location on the list. When you are done, click the \"Save order\" -button.": [
    null, 
    "Voit asettaa resurssit uuteen järjestykseen raahaamalla niitä nuoli-ikonista. Vedä resurssi oikealle ja aseta se haluttuun kohtaan listalla. Kun olet valmis, klikkaa painiketta \"Tallenna järjestys\"."
  ], 
  "error loading view": [
    null, 
