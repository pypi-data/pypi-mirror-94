{
  ...
  "An error occured during AJAX request. Could not load view.": [
    null, 
    "Ocurrió un error en la petición AJAX. No se puede cargar la vista."
  ], 
  ...
  "You can rearrange the resources by dragging them using the arrow icon. Drag the resource to the right and place it to the desired location on the list. When you are done, click the \"Save order\" -button.": [
    null, 
    "Puedes reorganizar los recursos arrastrándolos, utilizando para ello el icono de la flecha. Arrastre el recurso a la derecha y suéltelo en la posición deseada de la lista. Cuando hayas terminado, haz click en el botón \"Guardar orden\"."
  ], 
  "error loading view": [
    null, 
