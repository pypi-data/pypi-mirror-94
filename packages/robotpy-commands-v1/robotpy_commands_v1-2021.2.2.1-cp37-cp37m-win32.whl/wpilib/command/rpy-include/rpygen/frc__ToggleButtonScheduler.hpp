...
using PyBasefrc__ToggleButtonScheduler = 
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__ToggleButtonScheduler : PyBasefrc__ToggleButtonScheduler<PyTrampolineBase, CxxBase> {
    using PyBasefrc__ToggleButtonScheduler<PyTrampolineBase, CxxBase>::PyBasefrc__ToggleButtonScheduler;
