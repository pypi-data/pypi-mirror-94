...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__PressedButtonScheduler : PyBasefrc__PressedButtonScheduler<PyTrampolineBase, CxxBase> {
    using PyBasefrc__PressedButtonScheduler<PyTrampolineBase, CxxBase>::PyBasefrc__PressedButtonScheduler;
