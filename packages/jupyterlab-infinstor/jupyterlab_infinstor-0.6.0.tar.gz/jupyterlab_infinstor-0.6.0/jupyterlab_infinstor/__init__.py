    ...
    def create_mlflow_experiment(self, experiment_name):
        for retry in range(2):
            ...
            try:
                ...
                print(f'HTTP error occurred in get-by-name: {http_err}')
                break
            except Exception as err:
                print(f'Other error occurred in get-by-name: {err}')
                login_expired = False
                for lineb in response.iter_lines():
                    line = str(lineb)
                    try:
                        ...
                        print("addperiodicruns: Login expired. Retrying")
                        login_expired = True
                if login_expired == True:
                    perform_infinstor_login(builtins.cognito_username, builtins.cognito_password)
                    continue
                ...
                print('addperiodicruns: get-by-name success')
        ...
        for retry in range(2):
            ...
            try:
                ...
                print('addperiodicruns: create_mlflow_experiment success!')
            ...
            try:
                ...
                for lineb in response.iter_lines():
                    ...
                    try:
                        ...
                        print("deleteperiodicruns: Login expired. Retrying")
                        login_expired = True
                if login_expired == True:
                    perform_infinstor_login(builtins.cognito_username, builtins.cognito_password)
                    continue
                ...
                print('deleteperiodicruns success!')
                self.finish(json.dumps({"success": True}))
                break
