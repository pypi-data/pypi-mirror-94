from fastutil import gpu_util, loguru_util, logging_util, message_util, task_util, task_plan, model_util
from loguru import logger
from fastutil import cleaner
import argparse
...
@model_util.log_record(config_module=logging_util, save_dir='log/' + model_util.get_ver_id(), check_commit=True)
@logger.catch()
def test_task(a):
