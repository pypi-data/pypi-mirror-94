...
class SupercellStep(object):
    ...
    my_description['description'] : tuple
        A description of the Supercell step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return supercell_step.Supercell(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return supercell_step.TkSupercell(canvas=canvas, **kwargs)
