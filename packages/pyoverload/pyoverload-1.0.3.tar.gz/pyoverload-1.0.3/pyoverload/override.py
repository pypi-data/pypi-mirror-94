        ...
        class override_wrapper:
            ...
            def __call__(self, *args, **kwargs):
                if len(args) > 0:
                    ...
                    if not kwargs and len(args) == 1 and Functional(f):
                        fname = f.__name__.split('[')[0]
                ...
                if len(self.func_list) == 1:
                    ...
                    try:
                        ...
                        if (
                            Functional(ret) and ret.__name__.endswith('[params]') or 
                            iterable(ret) and all([Functional(x) and x.__name__.endswith('[params]') for x in ret])
                        ):
                            dec_list.clear()
