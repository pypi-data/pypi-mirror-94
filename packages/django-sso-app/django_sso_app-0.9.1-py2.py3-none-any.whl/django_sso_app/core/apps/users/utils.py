...
from ..profiles.utils import update_profile, create_update_profile_subscriptions
...
def create_local_user_from_remote_backend(remote_user_object, can_subscribe=False):
    ...
    _active_subscriptions, _disabled_subscriptions = create_update_profile_subscriptions(new_user.sso_app_profile,
                                                                                         remote_object_profile)
...
def update_local_user_from_remote_backend(remote_user_object, profile, commit=True):
    ...
    _active_subscriptions, _disabled_subscriptions = create_update_profile_subscriptions(profile, remote_object_profile)
