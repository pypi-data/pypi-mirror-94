...
class PostInstall(install):
    pkgs = ' git+https://github.com/hbldh/bleak.git@00038b6171beb96fbc9058899f9750cfd0306c7b#egg=bleak'
...
setup(
    ...
    install_requires=[
        'aio-mqtt>=0.2.0',
        # 'bleak @ http://github.com/hbldh/bleak/tarball/dbus-next-2#egg=bleak-0.11.0',
    ],
    classifiers=[
