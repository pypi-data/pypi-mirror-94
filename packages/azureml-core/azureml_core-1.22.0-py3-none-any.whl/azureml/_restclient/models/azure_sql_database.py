...
class AzureSqlDatabase(Model):
    ...
    def __init__(self, server_name=None, database_name=None, endpoint=None, user_id=None, user_password=None, port_number=None, credential_type=None, client_id=None, tenant_id=None, is_cert_auth=None, certificate=None, thumbprint=None, client_secret=None, authority_url=None, resource_uri=None, subscription_id=None, resource_group=None, service_data_access_auth_identity=None):
