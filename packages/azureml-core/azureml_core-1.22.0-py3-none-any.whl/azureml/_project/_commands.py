...
def create_workspace(auth, resource_group_name, workspace_name, subscription_id,
    ...
    :param primary_user_assigned_identity: The resource id of the user assined identity that used to represent
            the workspace
    ...
    :param default_gpu_compute_target: A configuration that will be used to create a GPU compute.
        If None, no compute will be created.
    :param user_assigned_identity_for_cmk_encryption: The resource id of the user assined identity that needs to be used to access the 
        customer manage key
