...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.6.1-alpha.1612818254+c2c141d7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.6.1-alpha.1612818254+c2c141d7`
                """)
            else:
                raise
