...
[boto3.KinesisVideoMedia 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/kinesis-video-media.html#KinesisVideoMedia) service
compatible with
