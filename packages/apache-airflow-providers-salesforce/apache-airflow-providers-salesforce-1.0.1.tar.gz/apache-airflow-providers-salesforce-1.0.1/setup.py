...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.0.0', 'simple-salesforce>=1.0.0', 'tableauserverclient'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-salesforce/1.0.1/',
