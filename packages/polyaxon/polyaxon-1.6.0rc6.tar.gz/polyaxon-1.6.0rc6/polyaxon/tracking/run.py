...
class Run(RunClient):
    ...
    def __init__(
        ...
        self._track_logs = track_logs if track_logs is not None else self._is_offline
        ...
        if (
            ...
            and (settings.CLIENT_CONFIG.is_managed or self._is_offline)
    ...
    def _set_exit_handler(
        ...
        if settings.CLIENT_CONFIG.is_managed:
            self._register_wait()
        elif self._is_offline or is_new_instance:
