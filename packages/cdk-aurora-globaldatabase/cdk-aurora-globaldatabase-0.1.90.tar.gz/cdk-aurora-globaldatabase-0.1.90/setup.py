    ...
    """
{
    ...
    "package_data": {
        "cdk_aurora_globaldatabase._jsii": [
            "cdk-aurora-globaldatabase@0.1.90.jsii.tgz"
        ],
        "cdk_aurora_globaldatabase": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-ec2>=1.84.0, <2.0.0",
        "aws-cdk.aws-iam>=1.84.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.84.0, <2.0.0",
        "aws-cdk.aws-logs>=1.84.0, <2.0.0",
        "aws-cdk.aws-rds>=1.84.0, <2.0.0",
        "aws-cdk.core>=1.84.0, <2.0.0",
        "aws-cdk.custom-resources>=1.84.0, <2.0.0",
