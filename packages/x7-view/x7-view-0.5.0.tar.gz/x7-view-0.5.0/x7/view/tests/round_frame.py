"""Ttk Frame with rounded corners, from:
https://svn.python.org/projects/python/trunk/Demo/tkinter/ttk/roundframe.py
...
frame.pack(fill='x')
b1 = ttk.Button(image=img1)
b1.pack()
b2 = ttk.Button(image=img2)
b2.pack()
