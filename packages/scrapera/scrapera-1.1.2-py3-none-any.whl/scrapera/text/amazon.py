...
class AmazonReviewScraper:
    ...
    async def _main_exec(self, query, num_pages, num_review_pages, sleep, out_path):
        async with aiosqlite.connect(out_path) as db:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                coros = [self._get_links(session, query, page, qid, sleep) for page in range(1, num_pages + 2, 1)]
    ...
    def scrape(self, query, num_product_pages, num_review_pages, out_path=None, proxies=None):
        ...
        sleep: [Optional] float, Amount of time to sleep between requests
