...
class PulpAnsibleGalaxyApiV3CollectionVersionsApi(object):
    ...
    def list(self, path, **kwargs):  # noqa: E501
        ...
        :return: list[CollectionVersionResponse]
    ...
    def list_with_http_info(self, path, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[CollectionVersionResponse], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp_ansible/galaxy/{path}/api/v3/metadata/collection_versions/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='list[CollectionVersionResponse]',  # noqa: E501
