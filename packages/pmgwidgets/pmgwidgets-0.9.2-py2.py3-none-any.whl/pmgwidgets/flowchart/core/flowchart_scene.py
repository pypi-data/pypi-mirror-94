...
from pmgwidgets.flowchart.core.flow_content import FlowContentForFunction, flowcontent_types
from pmgwidgets.flowchart.core.flow_items import CustomPort, CustomLine, CustomMidPoint, CustomRect
from pmgwidgets.flowchart.core.flow_node import Node
from pmgwidgets.flowchart.core.nodemanager import NodeManagerWidget
from pmgwidgets.utilities.uilogics.undomanager import UndoManager
from qtpy.QtCore import QSize, QCoreApplication, QLineF, Qt, QPointF, QThread, Signal
from qtpy.QtGui import QPen, QColor, QKeyEvent, QWheelEvent, QCloseEvent
from qtpy.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QToolButton, QSpacerItem, QSizePolicy, QGraphicsView, \
