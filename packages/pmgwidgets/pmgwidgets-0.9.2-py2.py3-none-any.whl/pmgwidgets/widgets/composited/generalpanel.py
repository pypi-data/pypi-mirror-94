...
from qtpy.QtWidgets import QSpacerItem, QSizePolicy, QDialog, QFrame, QVBoxLayout, QHBoxLayout, QPushButton, \
    QDialogButtonBox
from qtpy.QtCore import Signal
from typing import Any, List, Tuple, Dict, Callable, Union, Optional

from pmgwidgets.widgets.extended import (BaseExtendedWidget, PMGCheckCtrl, PMGColorCtrl, PMGEvalCtrl, PMGComboCtrl,
                                         PMGFileCtrl,
...
try:
    from pmgwidgets.widgets.extended import PMGTimeSeriesShow
except ImportError:
    PMGTimeSeriesShow = None

from pmgwidgets.utilities.uilogics.codechecking import iter_isinstance, ErrorReporter
...
if __name__ == '__main__':
    import sys
    from qtpy.QtWidgets import QApplication, QWidget, QPushButton, QDialogButtonBox
