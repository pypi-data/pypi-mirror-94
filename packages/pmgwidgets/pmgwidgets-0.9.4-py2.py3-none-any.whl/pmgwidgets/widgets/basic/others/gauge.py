...
from qtpy.QtCore import QTimer, Qt, QRectF, QPoint
from qtpy.QtGui import QPainter, QLinearGradient, QFontMetricsF, QPen, QFontMetrics, QRadialGradient, QConicalGradient, \
    QColor, QPolygon
from qtpy.QtWidgets import QWidget, QLCDNumber, QApplication
