...
from qtpy.QtCore import QThread, QObject, Signal, Qt, QUrl
from qtpy.QtGui import QCloseEvent, QKeyEvent, QIcon, QDesktopServices, QColor
from qtpy.QtWidgets import QWidget, QHBoxLayout, QVBoxLayout, QPushButton, QCheckBox, QTextEdit, QApplication, \
    QMessageBox

logger = logging.getLogger(__name__)

from pmgwidgets.utilities.platform.openprocess import PMGProcess
