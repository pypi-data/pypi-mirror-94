...
from pmgwidgets.widgets.basic.texts.statusreport import show_error
from qtpy.QtCore import QSize, QCoreApplication, QLineF, Qt, QThread, Signal
from qtpy.QtGui import QColor, QKeyEvent, QWheelEvent, QCloseEvent
...
if __name__ == '__main__':
    from pmgwidgets.flowchart.core.flow_content import PMGFlowContent
    import cgitb
