...
from qtpy.QtGui import QCloseEvent, QKeyEvent, QIcon
from qtpy.QtWidgets import QWidget, QHBoxLayout, QVBoxLayout, QPushButton, QCheckBox, QTextEdit
...
if __name__ == '__main__':
    ...
    w = PMGInstantBootConsoleWidget(r'C:\Users\12957\Documents\Developing\Python\PyMiner_dev_kit\bin'
                                    r'\pmgwidgets\widgets\basic\others\scripts\test1_instant_boot.py')
    w.show()
