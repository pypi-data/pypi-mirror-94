...
setup(
    ...
    description="A fair loss function",  # Optional
    ...
    url="https://pypi.org/project/fair-loss/",  # Optional
    ...
    keywords="pytorch loss fair",  # Optional
    # When your source code is in a subdirectory under the project root, e.g.
    # `src/`, it is necessary to specify the `package_dir` argument.
    py_modules=["fair_loss"],
