...
class CustomTagMetadata(betterproto.Message):
    ...
    kind: "__metadata_v2__.MetadataKind" = betterproto.message_field(1)
    # Metadata key to define the path to retrieve the tag value.
    metadata_key: "__metadata_v2__.MetadataKey" = betterproto.message_field(2)
...
from ...metadata import v2 as __metadata_v2__
