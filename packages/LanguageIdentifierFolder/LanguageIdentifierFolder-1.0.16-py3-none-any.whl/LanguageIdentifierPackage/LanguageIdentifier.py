from LanguageIdentifierPackage.LSTMLID import LSTMLIDModel
import torch
...
# print(str(pickle.loads(pkgutil.get_data('LanguageIdentifierFolder', 'LID_mixed_model.pkl'))))
# d = os.path.join(os.path.dirname(sys.modules['LanguageIdentifierFolder'].__file__), 'LID_mixed_model.pkl')
# lid = LanguageIdentifierFolder(d)
