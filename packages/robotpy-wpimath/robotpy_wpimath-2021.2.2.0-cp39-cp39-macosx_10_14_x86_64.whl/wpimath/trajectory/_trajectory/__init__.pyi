...
class TrajectoryConfig():
    ...
    def __init__(self, maxVelocity: meters_per_second, maxAcceleration: meters_per_second_squared) -> None: 
        ...
        """
    @typing.overload
    def addConstraint(self, constraint: constraints.CentripetalAccelerationConstraint) -> None: 
        """
        ...
        """
    @typing.overload
    def addConstraint(self, constraint: constraints.DifferentialDriveKinematicsConstraint) -> None: ...
    @typing.overload
    def addConstraint(self, constraint: constraints.DifferentialDriveVoltageConstraint) -> None: ...
    @typing.overload
    def addConstraint(self, constraint: constraints.MecanumDriveKinematicsConstraint) -> None: ...
