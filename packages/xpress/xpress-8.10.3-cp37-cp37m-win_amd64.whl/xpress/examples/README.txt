...
Either way, please verify that the XPRESS environment variable is set to the directory containing the license file xpauth.xpr.
...
detected by the module provided that the XPRESS variable is not set.
