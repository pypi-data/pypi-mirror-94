...
class AstroWeather:
    ...
    async def get_forecast(
        ...
        # return await self._forecast_data(time_zone, latitude, longitude, hours_to_show)
    ...
    async def _forecast_data(
        ...
        # time_zone is currently not used within the calculations and therefore
        # defaults to 0. Timezone Offset is currently calculated based on system time
