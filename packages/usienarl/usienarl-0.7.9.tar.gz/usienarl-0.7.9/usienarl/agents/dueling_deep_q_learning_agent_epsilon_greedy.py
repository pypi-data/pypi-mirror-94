...
class DuelingDeepQLearningAgentEpsilonGreedy(Agent):
    """
    Dueling Double Deep Q-Learning agent with epsilon greedy exploration policy.
    It is supplied with a Dueling Double Deep Q-Learning model (DDDQN).
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DuelingDeepQLearningAgentEpsilonGreedy, self).__init__(name)
