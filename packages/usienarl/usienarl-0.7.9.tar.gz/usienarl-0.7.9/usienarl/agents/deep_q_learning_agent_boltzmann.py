...
class DeepQLearningAgentBoltzmann(Agent):
    """
    Deep Q-Learning agent with Boltzmann sampling exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DeepQLearningAgentBoltzmann, self).__init__(name)
