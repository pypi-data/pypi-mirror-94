...
from usienarl.models import DeepQLearning


class DeepQLearningAgentEpsilonGreedy(Agent):
    """
    Deep Q-Learning agent with epsilon greedy exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DeepQLearningAgentEpsilonGreedy, self).__init__(name)
