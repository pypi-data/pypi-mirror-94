...
class TabularQLearningAgentDirichlet(Agent):
    """
    Tabular Q-Learning agent with Dirichlet sampling exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(TabularQLearningAgentDirichlet, self).__init__(name)
