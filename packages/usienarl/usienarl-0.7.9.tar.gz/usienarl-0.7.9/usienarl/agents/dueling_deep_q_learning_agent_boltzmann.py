...
class DuelingDeepQLearningAgentBoltzmann(Agent):
    """
    Dueling Double Deep Q-Learning agent with Boltzmann sampling exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DuelingDeepQLearningAgentBoltzmann, self).__init__(name)
