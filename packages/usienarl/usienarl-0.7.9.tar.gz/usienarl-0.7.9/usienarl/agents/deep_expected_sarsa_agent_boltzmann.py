...
class DeepExpectedSARSAAgentBoltzmann(Agent):
    """
    Deep Expected SARSA agent with Boltzmann sampling exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DeepExpectedSARSAAgentBoltzmann, self).__init__(name)
