...
class TabularExpectedSARSAAgentDirichlet(Agent):
    """
    Tabular Expected SARSA agent with Dirichlet sampling exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(TabularExpectedSARSAAgentDirichlet, self).__init__(name)
