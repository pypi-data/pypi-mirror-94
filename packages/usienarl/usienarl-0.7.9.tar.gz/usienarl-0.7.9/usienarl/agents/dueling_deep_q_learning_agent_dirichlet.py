...
class DuelingDeepQLearningAgentDirichlet(Agent):
    """
    Dueling Double Deep Q-Learning agent with Dirichlet sampling exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DuelingDeepQLearningAgentDirichlet, self).__init__(name)
