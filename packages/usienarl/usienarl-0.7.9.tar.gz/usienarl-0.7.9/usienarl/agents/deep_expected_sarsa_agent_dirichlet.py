...
class DeepExpectedSARSAAgentDirichlet(Agent):
    """
    Deep Expected SARSA agent with Dirichlet sampling exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DeepExpectedSARSAAgentDirichlet, self).__init__(name)
