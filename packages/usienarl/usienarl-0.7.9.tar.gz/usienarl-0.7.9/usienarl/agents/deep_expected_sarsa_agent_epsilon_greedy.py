...
class DeepExpectedSARSAAgentEpsilonGreedy(Agent):
    """
    Deep Expected SARSA agent with epsilon greedy exploration policy.
    It is supplied with a Deep Expected SARSA model.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(DeepExpectedSARSAAgentEpsilonGreedy, self).__init__(name)
