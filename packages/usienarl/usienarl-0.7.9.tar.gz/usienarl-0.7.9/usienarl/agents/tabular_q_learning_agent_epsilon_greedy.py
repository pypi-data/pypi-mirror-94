...
from usienarl.models import TabularQLearning


class TabularQLearningAgentEpsilonGreedy(Agent):
    """
    Tabular Q-Learning agent with epsilon greedy exploration policy.
    ...
    def __init__(self,
        ...
        # Generate base agent
        super(TabularQLearningAgentEpsilonGreedy, self).__init__(name)
