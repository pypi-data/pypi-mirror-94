...
def run_experiment(logger: logging.Logger,
    ...
    # Compute the actual standard deviation for each indicator (make sure the denominator is never zero)
    ...
    logger.info("Standard deviation of average total reward over all experiments: " + str("%.3f" % stdv_average_total_reward) + ", which is a " + str("%.2f" % ((100 * stdv_average_total_reward) / (average_average_total_reward + 1e-8))) + "% of the average")
    ...
    logger.info("Standard deviation of max total reward over all experiments " + str("%.3f" % stdv_max_total_reward) + ", which is a " + str("%.2f" % ((100 * stdv_max_total_reward) / (average_max_total_reward + 1e-8))) + "% of the average")
    ...
    logger.info("Standard deviation of average scaled reward over all experiments: " + str("%.3f" % stdv_average_scaled_reward) + ", which is a " + str("%.2f" % ((100 * stdv_average_scaled_reward) / (average_average_scaled_reward + 1e-8))) + "% of the average")
    ...
    logger.info("Standard deviation of max scaled reward over all experiments " + str("%.3f" % stdv_max_scaled_reward) + ", which is a " + str("%.2f" % ((100 * stdv_max_scaled_reward) / (average_max_scaled_reward + 1e-8))) + "% of the average")
    ...
    logger.info("Standard deviation of training episodes over all experiments: " + str("%.3f" % stdv_training_episodes) + ", which is a " + str("%.2f" % ((100 * stdv_training_episodes) / (average_training_episodes + 1e-8))) + "% of the average")
