...
class CalculatorBase:
    ...
    def calc_recent_ret(dates:             pd.core.series.Series,
        ...
        recent_1w_ret = sr.loc[:last_date][-1] / sr.loc[:max(begin_date_dic['w1'],_begin_date)][-1] - 1
        recent_1m_ret = sr.loc[:last_date][-1] / sr.loc[:max(begin_date_dic['m1'],_begin_date)][-1] - 1
        recent_3m_ret = sr.loc[:last_date][-1] / sr.loc[:max(begin_date_dic['m3'],_begin_date)][-1] - 1
        recent_6m_ret = sr.loc[:last_date][-1] / sr.loc[:max(begin_date_dic['m6'],_begin_date)][-1] - 1
        recent_1y_ret = sr.loc[:last_date][-1] / sr.loc[:max(begin_date_dic['y1'],_begin_date)][-1] - 1
        recent_3y_ret = sr.loc[:last_date][-1] / sr.loc[:max(begin_date_dic['y3'],_begin_date)][-1] - 1
        recent_5y_ret = sr.loc[:last_date][-1] / sr.loc[:max(begin_date_dic['y5'],_begin_date)][-1] - 1
