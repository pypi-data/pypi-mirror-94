...
from sqlalchemy.dialects.mysql import DOUBLE, DATE, TINYINT, DATETIME, MEDIUMTEXT, YEAR, SMALLINT, BIGINT
...
class EmBondCleanPrice(Base):
    ...
    THEORY = Column('theory', DOUBLE(asdecimal=False), nullable=False)  # 理论价(中国债券信息网)
