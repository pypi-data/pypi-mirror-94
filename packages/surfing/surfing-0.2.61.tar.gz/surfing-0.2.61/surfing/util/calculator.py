...
class Calculator:
    ...
    def get_stat_result(dates: pandas.core.series.Series,
                        ...
                        frequency:str='1D'): #['1D','1W','2W','1M']
        res = CalculatorBase.get_stat_result(dates=dates,values=values,frequency=frequency)
    ...
    def get_benchmark_stat_result(dates: pandas.core.series.Series,
                                  ...
                                  frequency:str='1D'):#['1D','1W','2W','1M']
        res = CalculatorBase.get_stat_result(dates=dates,values=values,benchmark_values=benchmark_values,frequency=frequency)
