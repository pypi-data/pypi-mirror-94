"""A simple cli that uses terminaltables to convert CSV into table in plain text.
...
setup(
    ...
    description='CSV to Grid Table in Markdown',
    ...
    extras_require={
        'dev': ['check-manifest'],
        'test': ['shutilwhich', 'pep8', 'pylint', 'pytest'],
    },
