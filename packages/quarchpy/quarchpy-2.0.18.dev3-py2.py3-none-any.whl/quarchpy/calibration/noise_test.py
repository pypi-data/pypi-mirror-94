...
Takes: channels to check, limits of the channels,
Returns: PASS/FAIL + report of each test

StartTime 500, EndTime 2000, 5v max current: <3mv, 12v max current < 3mv, 5v power
"""
import sys
...
import os, time
import datetime
#from quarchpy.calibration.calibrationUtil import get_check_valid_calPath #sb db circular dependancy needs sorted.
