...
class QTL2525 (PowerModule):
    ...
    def setConnections(self,loadConnection,hostPowerConnection,reset=False):
        inputPort = "a"
        outputPort = "b"
        loadConnectionPortDict = {"12V": "1", "5V": "2", "3V3_AUX": "3"}
        hostConnectionPortDict = {"12V": "4", "5V": "5", "3V3_AUX": "6"}
        ...
        # else connections are incorrect
            ...
            self.switchbox.sendCommand("connect " + inputPort + " " + loadConnectionPortDict[loadConnection])
            self.switchbox.sendCommand("connect " + outputPort + " " + hostConnectionPortDict[hostPowerConnection])
    ...
    def wait_for_up_time(self, desired_up_time=600):
        ...
        if current_up_time < desired_up_time:
            skip_uptime_wait = listSelection(title="Up Time", message=("Has the Module been on for more than " + str(desired_up_time) + " seconds?"),selectionList="Yes,No", tableHeaders=["Options"], nice=True)
    ...
    class QTL2525_12V_LeakageCalibration (QTL2525Calibration):
        ...
        def init(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.CALIBRATION_CONTROL_ADDR + " 0x00F5")
            # clear the multiplier register by setting it to zero
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.V12_LEAKAGE_MULTIPLIER_ADDR + " 0x0000")
        ...
        def readCoefficients(self):
            ...
            coefficients["multiplier"] = self.powerModule.dut.sendCommand("read " + QTL2525.V12_LEAKAGE_MULTIPLIER_ADDR)
            return coefficients

        def writeCoefficients(self,coefficents):

            # write 12v leakage multiplier
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.V12_LEAKAGE_MULTIPLIER_ADDR + " " + coefficents["multiplier"])
    ...
    class QTL2525_5V_LeakageCalibration (QTL2525Calibration):
        ...
        def init(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.CALIBRATION_CONTROL_ADDR + " 0x00F5")
            # clear the multiplier register by setting it to zero
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.V5_LEAKAGE_MULTIPLIER_ADDR + " 0x0000")
        ...
        def readCoefficients(self):
            ...
            coefficients["multiplier"] = self.powerModule.dut.sendCommand("read " + QTL2525.V5_LEAKAGE_MULTIPLIER_ADDR)
            return coefficients

        def writeCoefficients(self,coefficents):

            # write 3.3v leakage multiplier
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.V5_LEAKAGE_MULTIPLIER_ADDR + " " + coefficents["multiplier"])
    ...
    class QTL2525_5V_HighCurrentCalibration (QTL2525Calibration):
        ...
        def setCoefficients(self):
            ...
            # once we've completed low and high current we can set leakage on the fixture
            result = self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.V5_LEAKAGE_MULTIPLIER_ADDR + " " + self.powerModule.calibrations["3.3V"]["Leakage"].multiplier.hexString(4))
    ...
    class QTL2525_3V3_AUX_LeakageCalibration (QTL2525Calibration):
        ...
        def init(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.CALIBRATION_CONTROL_ADDR + " 0x00F5")
            # clear the multiplier register by setting it to zero
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.V3_3_AUX_LEAKAGE_MULTIPLIER_ADDR + " 0x0000")
        ...
        def readCoefficients(self):
            ...
            coefficients["multiplier"] = self.powerModule.dut.sendCommand("read " + QTL2525.V3_3_AUX_LEAKAGE_MULTIPLIER_ADDR)
            return coefficients

        def writeCoefficients(self,coefficents):

            # write 3.3v Aux leakage multiplier
            self.powerModule.dut.sendAndVerifyCommand("write " + QTL2525.V3_3_AUX_LEAKAGE_MULTIPLIER_ADDR + " " + coefficents["multiplier"])
