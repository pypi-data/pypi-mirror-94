...
[boto3.EC2InstanceConnect 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/ec2-instance-connect.html#EC2InstanceConnect) service
compatible with
