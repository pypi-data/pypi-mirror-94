...
def pack(module, clz, name, path, labels=None, files=None, opts=None):
...
@click.option('--labels', help='comma separated list of key:val pairs')
@click.option('--files', help='comma separated list of file paths to add')
def pack_from_s3(module, clz, name, bucket, path, labels=None, files=None, opts=None):
