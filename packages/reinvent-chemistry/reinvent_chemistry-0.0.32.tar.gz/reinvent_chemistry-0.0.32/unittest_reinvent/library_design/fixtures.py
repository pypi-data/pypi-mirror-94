REACTION_SUZUKI = ["[*;$(c2aaaaa2),$(c2aaaa2):1]-!@[*;$(c2aaaaa2),$(c2aaaa2):2]>>[#6;H0;D3;$([#6](~[#6])~[#6]):1]B(O)O.[#6;H0;D3;$([#6](~[#6])~[#6]):2][Cl]"]
SCAFFOLD_SUZUKI = '[*]c1ccc2c(n1)c(c(cn2)c3cnn(c3)C4CCC(CC4)N(C)C(=O)C)OC'
DECORATION_SUZUKI = '[*]c1ncncc1'
SCAFFOLD_NO_SUZUKI = 'CC(=O)N(C)C1CCC(CC1)n2cc(cn2)c3cnc4ccc(nc4c3O[*])c5c[nH]nc5'
...
SUZUKI_NEGISHI_REDUCTIVE_AMINATION = ["[*;$(c2aaaaa2),$(c2aaaa2):1]-!@[*;$(c2aaaaa2),$(c2aaaa2):2]>>[#6;H0;D3;$([#6](~[#6])~[#6]):1]B(O)O.[#6;H0;D3;$([#6](~[#6])~[#6]):2][Cl]",
...
FAILING1 = ['[#6;!$(C(C=*)(C=*));!$([#6]~[O,N,S]);$([#6]~[#6]):1][C:2](=[O:3])[N;D3;$(N(C=[O,S]));!$(N~[O,P,S,N]):4]([#6;!$(C=*);!$([#6](~[O,N,S])N);$([#6]~[#6]):5])[#6;!$(C=*);!$([#6](~[O,N,S])N);$([#6]~[#6]):6]>>[#6:1][C:2](=[O:3])[O;D1].[N:4]']
SUZUKI_1 = '[*;$(c2aaaaa2),$(c2aaaa2):1]-!@[*;$(c2aaaaa2),$(c2aaaa2):2]>>[#6;H0;D3;$([#6](~[#6])~[#6]):1]B(O)O.[#6;H0;D3;$([#6](~[#6])~[#6]):2][Cl]'
FRAGMENT_REACTION_SUZUKI = ["[*;$(c2aaaaa2),$(c2aaaa2):1]-!@[*;$(c2aaaaa2),$(c2aaaa2):2]>>[*:1][*].[*:2][*]"]
