...
class TestTransfer(unittest.TestCase):
    ...
    def test_gs_to_s3(self):
        ...
        client.gs_to_s3(gs_uri=f'gs://{setup.bucket_name}/{setup.bucket_blob_name}',
                        s3_region=setup.s3_region,
                        s3_access_key=setup.s3_access_key,
                        s3_secret_key=setup.s3_secret_key,
    ...
    def test_s3_to_gs(self):
        ...
        client = transfer.Client(project=setup.project)
        client.s3_to_gs(s3_region=setup.s3_region,
                        s3_access_key=setup.s3_access_key,
                        s3_secret_key=setup.s3_secret_key,
                        s3_bucket=setup.s3_bucket,
                        s3_object=setup.s3_object,
                        gs_bucket=setup.bucket_name,
