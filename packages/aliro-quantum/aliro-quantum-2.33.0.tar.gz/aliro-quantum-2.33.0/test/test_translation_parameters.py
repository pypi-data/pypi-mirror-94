...
from aliro_quantum.models.translation_parameters import TranslationParameters  # noqa: E501
...
class TestTranslationParameters(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = aliro_quantum.models.translation_parameters.TranslationParameters()  # noqa: E501
        if include_optional :
            return TranslationParameters(
                input_circuit = aliro_quantum.models.circuit.Circuit(
                    body = '0', 
                    depth = 56, 
                    jobs = [
