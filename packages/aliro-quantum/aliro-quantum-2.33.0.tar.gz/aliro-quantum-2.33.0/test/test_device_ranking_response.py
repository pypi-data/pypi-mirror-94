...
from aliro_quantum.models.device_ranking_response import DeviceRankingResponse  # noqa: E501
from aliro_quantum.rest import ApiException

class TestDeviceRankingResponse(unittest.TestCase):
    """DeviceRankingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DeviceRankingResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = aliro_quantum.models.device_ranking_response.DeviceRankingResponse()  # noqa: E501
        if include_optional :
            return DeviceRankingResponse(
                recommendations = [
                    aliro_quantum.models.device_ranking_response_recommendations.DeviceRankingResponse_recommendations(
                        heading = '0', 
                        subheading = '0', 
                        devices = [
    ...
    def testDeviceRankingResponse(self):
        """Test DeviceRankingResponse"""
