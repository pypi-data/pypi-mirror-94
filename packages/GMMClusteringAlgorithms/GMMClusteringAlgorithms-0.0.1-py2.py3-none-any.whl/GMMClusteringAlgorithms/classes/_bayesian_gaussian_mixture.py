...
class BayesianGaussianMixture(GaussianMixtureBase):
    ...
    def _strict_BGM_fit(self, x):
        ...
        value given by 'n_components'. This is a special case of the regular
        Bayesian Gaussian Mixture in which the number of components is
        allowed to be lower than 'n_components'.
    ...
    def _calc_secondary_centers_unc(self, c1s, c1s_err, c2s,
        ...
        """Calculate the coordinates of the cluster centers for the coordinate system that was not used for the fit.
    ...
    def fit_over_one_dimensional_histograms(self, fig, axs,
        ...
        function will graph a GMM fit over each dimension.
