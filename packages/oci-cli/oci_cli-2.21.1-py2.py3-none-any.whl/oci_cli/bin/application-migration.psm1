...
function GetOciCommandsToLongParams_application_migration() {
    $ociCommandsToLongParams = @{
        ...
        'application-migration migration create' = 'application-config application-name compartment-id defined-tags description discovery-details display-name freeform-tags from-json help max-wait-seconds pre-created-target-database-type service-config source-id wait-for-state wait-interval-seconds'
        ...
        'application-migration migration update' = 'application-config defined-tags description discovery-details display-name force freeform-tags from-json help if-match max-wait-seconds migration-id service-config wait-for-state wait-interval-seconds'
