...
class Api :
    ...
    def __init__(this) :
        ...
        this.TDeviceDD_DSIM_MipiReadReg.argtypes=[c_void_p, c_char, c_int, c_int, c_char_p]
        ...
        this.TDeviceDD_DSIM_MipiReadReg1Byte.argtypes=[c_void_p, c_char, c_int, c_char_p]
        ...
        this.TDeviceDD_DSIM_MipiWriteReg.argtypes=[c_void_p, c_char, c_int, c_int, c_char_p]
        ...
        this.TDeviceDD_DSIM_MipiWriteReg1Byte.argtypes=[c_void_p, c_char, c_int, c_char]
        ...
        this.TDeviceAdcGetVoltFloatByPsID.restype=c_int;
        ...
        this.TDeviceAdcGetCurrent.argtypes=[c_void_p, c_int, c_int, c_char_p]
        ...
        this.TDeviceAdcGetCurrFloatByPsID.restype=c_int;
