...
class ListCertificatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCertificates.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.7/reference/services/acm.html#ACM.Paginator.ListCertificates.paginate)
        """
