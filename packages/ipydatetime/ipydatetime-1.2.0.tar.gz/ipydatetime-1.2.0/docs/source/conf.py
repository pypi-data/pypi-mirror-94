...
# -*- coding: utf-8 -*-
#
# ipydatetime documentation build configuration file
#
...
_version_py = os.path.join(repo, "ipydatetime", "_version.py")
version_ns = {}
...
htmlhelp_basename = "ipydatetimedoc"
...
man_pages = [(master_doc, "ipydatetime", "ipydatetime Documentation", [author], 1)]
