...
"""Setup.py for the apache-airflow-backport-providers-sqlite package."""
...
def do_setup():
    """Perform the package apache-airflow-backport-providers-sqlite setup."""
    setup(
        name='apache-airflow-backport-providers-sqlite',
        description='Backport provider package '
        'apache-airflow-backport-providers-sqlite for Apache Airflow',
