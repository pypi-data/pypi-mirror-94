...
from ae.base import NAME_PARTS_SEP, duplicates, now_str, snake_to_camel                                 # type: ignore
...
class MainAppBase(ConsoleApp, ABC):
    ...
    def backup_config_resources() -> str:   # pragma: no cover
        ...
        config files are collected from from {app}, {usr} or {cwd} (the first found file name only).
