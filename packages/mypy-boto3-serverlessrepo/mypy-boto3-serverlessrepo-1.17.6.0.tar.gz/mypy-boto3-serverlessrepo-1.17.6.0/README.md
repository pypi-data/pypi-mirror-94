...
[boto3.ServerlessApplicationRepository 1.17.6](https://boto3.amazonaws.com/v1/documentation/api/1.17.6/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
compatible with
