...
# Cell
def splot_bz(path_pos_bz = None, ax = None, plane=None,color='blue',fill=True,vectors=True,v3=False,vname='b',color_map='plasma',light_from=(1,1,1),alpha=0.4):
    """
...
def splot_lat(poscar,sizes=50,color_map=None,
    ...
    ax = splot_bz(bz,ax=ax,vname='a',
                color=edge_color,color_map=color_map,
