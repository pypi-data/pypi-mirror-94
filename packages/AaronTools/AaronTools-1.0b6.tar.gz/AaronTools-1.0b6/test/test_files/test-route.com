%NProcShared=2
#n B3LYP/aug-cc-pVDZ EmpiricalDispersion=GD3 Integral=(grid=SuperFineGrid) scrf=(PCM,solvent=1,1,1-TriChloroEthane) opt freq=(temperature=298.15,Numerical,Raman,HPModes) 
