...
class MessageViewer:
    ...
    def __init__(self,
        ...
        self._message_div = bokeh.models.PreText(text='', width=width, height=height, sizing_mode=sizing_mode)
    ...
    def _safe_modify_log(self):
        ...
        self._message_div.text = '\n'.join([self.msgs[i] for i in range(self.rows) if n_rows >= i+1])
