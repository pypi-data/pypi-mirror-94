...
class SelectorPresenter:
    ...
    def __init__(self, name: str, view: SelectorViewBase, default: Option = '', logger=None) -> None:
        ...
        self.selector_values = [default]
        self.selected_values = [default]
        ...
        # initialize
        self.set_selector_options(self._unpack_options(options=[default]), callback=False)
        self.set_selector_value(default)
    ...
    def _receive_state(self, state: States) -> None:
        if state != self.state:
            ...
            if state == States.DEACTIVE:
                self.send_view_options([self.default])
    ...
    def set_selector_options(self, options: Optional[Options] = None, sort: bool = True,
        ...
        if isinstance(options, list):
            ...
            self.set_selector_value(self.default, callback=False)
