...
EXTERNAL_PORT_APIS=('apigateway','athena','cloudfront','codecommit','ecs','elasticache','mediastore','rds','transfer','kafka','neptune')
def register_localstack_plugins():
 ...
 if KXgaB([is_api_enabled(api)for api in EXTERNAL_PORT_APIS]):
...
def load_plugin_files():
 try:
  ...
  if 'No module named' not in KXgav(e):
   print(e)
...
def api_key_configured():
 return KXgak(os.environ.get('LOCALSTACK_API_KEY'))
