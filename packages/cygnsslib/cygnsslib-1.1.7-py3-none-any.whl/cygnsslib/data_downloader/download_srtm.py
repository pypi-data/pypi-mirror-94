...
def download_srtm_ght_files(list_lat, list_lon, out_folder=None, earthdata_usr_pass=None, save_pass=True, unzipfile=False, remove_zipedfile=True):
    """
    ...
    :type unzipfile: bool
    :param remove_zipedfile: delete the unzipped file after unzipping?
    ...
    for lat in list_lat:
        for lon in list_lon:
            d_file_paths.append(download_srtm_ght_single_file(lat, lon, out_folder=out_folder, earthdata_usr_pass=earthdata_usr_pass,
                                                              save_pass=save_pass, unzipfile=unzipfile, remove_zipedfile=remove_zipedfile))
...
def download_srtm_ght_single_file(lat, lon, out_folder=None, earthdata_usr_pass=None, save_pass=True, unzipfile=False, remove_zipedfile=True):
    ...
    unziped_file = os.path.join(out_folder, get_srtm_unzipped_file_name(file_name))
    if remove_zipedfile:
