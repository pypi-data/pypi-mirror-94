...
L1_OCEAN_FOLDER = "v2.1"


def get_land_prod_info_from_ocean_prod(year, day, sc_num, l1_ocean_sample, cygnss_l1_path=None, l1_ocean_folder_name=None, l1_land_folder_name=None):
    """
    ...
    cygnss_l1_path = os.environ["CYGNSS_L1_PATH"] if cygnss_l1_path is None else cygnss_l1_path
...
def find_cygnss_file(data_year, data_day, sc_num, cygnss_l1_path=None):
    """
...
class CygDdmId:
    ...
    def fill_file_name(self, cygnss_l1_path=None):
        """
