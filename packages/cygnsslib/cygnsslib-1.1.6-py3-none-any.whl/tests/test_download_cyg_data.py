...
if __name__ == '__main__':
    ...
    cygnss_download.download_cyg_files(data_year, data_day, list_sc_num=sc_num, cyg_data_ver=cyg_data_ver, cyg_data_lvl='L1',
                                       cygnss_l1_path=cygnss_l1_path, re_download=re_download)
    ...
    cygnss_download.download_cyg_rawif_files(data_year=2020, list_data_day=227)

    st_date = dt.date(year=2020, month=8, day=4)
    end_date = dt.date(year=2020, month=8, day=4)
    cygnss_download.download_rawif_cyg_files_between_date(st_date, end_date, download_l1_data=True)
