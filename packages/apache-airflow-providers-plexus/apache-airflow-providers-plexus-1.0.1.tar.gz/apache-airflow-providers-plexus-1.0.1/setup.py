...
def do_setup():
    ...
    setup(
        ...
        description='Provider package ' 'apache-airflow-providers-plexus for Apache Airflow',
        ...
        install_requires=['apache-airflow>=2.0.0', 'arrow>=0.16.0'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-plexus/1.0.1/',
