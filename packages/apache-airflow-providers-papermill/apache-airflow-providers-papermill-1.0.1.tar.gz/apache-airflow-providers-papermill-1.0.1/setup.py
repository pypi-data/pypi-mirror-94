...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.0.0', 'nteract-scrapbook[all]>=0.3.1', 'papermill[all]>=1.2.1'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-papermill/1.0.1/',
