...
class CfnChannel(
    ...
    class HlsIngestProperty:
        def __init__(
            self,
            *,
            ingest_endpoints: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.List[typing.Union["CfnChannel.IngestEndpointProperty", _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            """
