...
class CfnPortal(
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_iotsitewise.CfnPortal.MonitorErrorDetailsProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="monocdk.aws_iotsitewise.CfnPortal.PortalStatusProperty",
        jsii_struct_bases=[],
    ...
    class PortalStatusProperty:
        def __init__(
            ...
            *,
            state: builtins.str,
            error: typing.Optional[typing.Union["CfnPortal.MonitorErrorDetailsProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
            """
        ...
        def error(
            self,
        ) -> typing.Optional[typing.Union["CfnPortal.MonitorErrorDetailsProperty", _IResolvable_a771d0ef]]:
