...
class _BaseListenerProxy(
    BaseListener, jsii.proxy_for(_Resource_abff4495) # type: ignore
):
    pass
...
class _BaseLoadBalancerProxy(
    BaseLoadBalancer, jsii.proxy_for(_Resource_abff4495) # type: ignore
):
    pass
...
class _INetworkLoadBalancerProxy(
    ...
    jsii.proxy_for(_IVpcEndpointServiceLoadBalancer_00f65efa), # type: ignore
):
    """(experimental) A network load balancer.
...
class ApplicationTargetGroup(
    ...
    def enable_cookie_stickiness(self, duration: _Duration_070aa057) -> None:
