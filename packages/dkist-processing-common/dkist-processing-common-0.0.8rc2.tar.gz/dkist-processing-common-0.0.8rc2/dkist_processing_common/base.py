...
class TaskBaseExt(TaskBase, ABC):
    ...
    def purge_file_system(self) -> None:
        """
        Wrapper for the purge method in
        :return:
        """
        self._scratch.purge()
    ...
    def globus_path(self, *args) -> Path:
        ...
        """
        globus_base_path = self._scratch.workflow_base_path.relative_to(
            self._scratch.scratch_base_path
        )
        return globus_base_path / Path(*args)
