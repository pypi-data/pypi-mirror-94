...
import wpilib._wpilib.SerialPort
...
class AHRS(wpilib._wpilib.SendableBase, wpilib._wpilib.Sendable, wpilib._wpilib.ErrorBase, wpilib.interfaces._interfaces.PIDSource, wpilib.interfaces._interfaces.Gyro):
    """
    ...
    class BoardAxis():
        ...
        def value(self) -> int:
            ...
            :type: int
            """
        __members__: dict # value = {'kBoardAxisX': <BoardAxis.kBoardAxisX: 0>, 'kBoardAxisY': <BoardAxis.kBoardAxisY: 1>, 'kBoardAxisZ': <BoardAxis.kBoardAxisZ: 2>}
        kBoardAxisX: navx._navx.AHRS.BoardAxis # value = <BoardAxis.kBoardAxisX: 0>
        kBoardAxisY: navx._navx.AHRS.BoardAxis # value = <BoardAxis.kBoardAxisY: 1>
        kBoardAxisZ: navx._navx.AHRS.BoardAxis # value = <BoardAxis.kBoardAxisZ: 2>
        pass
    class BoardYawAxis():
        """
    ...
    class SerialDataType():
        ...
        def value(self) -> int:
            ...
            :type: int
            """
        __members__: dict # value = {'kProcessedData': <SerialDataType.kProcessedData: 0>, 'kRawData': <SerialDataType.kRawData: 1>}
        kProcessedData: navx._navx.AHRS.SerialDataType # value = <SerialDataType.kProcessedData: 0>
        kRawData: navx._navx.AHRS.SerialDataType # value = <SerialDataType.kRawData: 1>
        pass
    @typing.overload
    ...
    def calibrate(self) -> None: 
        ...
        """
    @staticmethod
    def create_i2c(port: wpilib._wpilib.I2C.Port = Port.kMXP, update_rate_hz: int = 60) -> AHRS: 
        """
        ...
        """
    @staticmethod
    def create_spi(port: wpilib._wpilib.SPI.Port = Port.kMXP, bitrate: int = 500000, update_rate_hz: int = 60) -> AHRS: 
        """
