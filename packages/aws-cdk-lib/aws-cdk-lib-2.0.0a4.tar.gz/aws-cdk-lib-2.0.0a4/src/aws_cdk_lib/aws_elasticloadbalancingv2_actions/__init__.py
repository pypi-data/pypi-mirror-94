...
from ..aws_cognito import (
    IUserPool as _IUserPool_149c8c9a,
    IUserPoolClient as _IUserPoolClient_76666f44,
    IUserPoolDomain as _IUserPoolDomain_9cfccfc8,
)
from ..aws_elasticloadbalancingv2 import (
    ListenerAction as _ListenerAction_b40b79ed,
    UnauthenticatedAction as _UnauthenticatedAction_848e589c,
)


class AuthenticateCognitoAction(
    _ListenerAction_b40b79ed,
    ...
    def __init__(
        self,
        *,
        next: _ListenerAction_b40b79ed,
        user_pool: _IUserPool_149c8c9a,
        user_pool_client: _IUserPoolClient_76666f44,
        user_pool_domain: _IUserPoolDomain_9cfccfc8,
        authentication_request_extra_params: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        on_unauthenticated_request: typing.Optional[_UnauthenticatedAction_848e589c] = None,
...
class AuthenticateCognitoActionProps:
    ...
    @builtins.property
    def next(self) -> _ListenerAction_b40b79ed:
    ...
    @builtins.property
    def user_pool_client(self) -> _IUserPoolClient_76666f44:
    ...
    @builtins.property
    def user_pool_domain(self) -> _IUserPoolDomain_9cfccfc8:
    ...
    def on_unauthenticated_request(
        self,
    ) -> typing.Optional[_UnauthenticatedAction_848e589c]:
