...
from ..aws_ses import (
    IReceiptRule as _IReceiptRule_5387b2cf,
    IReceiptRuleAction as _IReceiptRuleAction_2c9dd6fe,
    ReceiptRuleActionConfig as _ReceiptRuleActionConfig_f1b26600,
)
from ..aws_sns import ITopic as _ITopic_2a3c8549


@jsii.implements(_IReceiptRuleAction_2c9dd6fe)
class AddHeader(
    ...
    def bind(self, _rule: _IReceiptRule_5387b2cf) -> _ReceiptRuleActionConfig_f1b26600:
...
class Bounce(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_ses_actions.Bounce"):
    ...
    def __init__(
        ...
        *,
        ...
        topic: typing.Optional[_ITopic_2a3c8549] = None,
    ) -> None:
        """
...
class BounceProps:
    ...
    @builtins.property
    def topic(self) -> typing.Optional[_ITopic_2a3c8549]:
...
class Lambda(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_ses_actions.Lambda"):
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, rule: _IReceiptRule_5387b2cf) -> _ReceiptRuleActionConfig_f1b26600:
        """(experimental) Returns the receipt rule action specification.
...
class LambdaProps:
    ...
    @builtins.property
    def function(self) -> _IFunction_9c701b6f:
...
class Stop(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_ses_actions.Stop"):
    ...
    def __init__(self, *, topic: typing.Optional[_ITopic_2a3c8549] = None) -> None:
        """
