...
from ..aws_iam import (
    ...
    PrincipalBase as _PrincipalBase_637ce519,
...
class CfnKey(
    ...
    def __init__(
        ...
        *,
        ...
        enable_key_rotation: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
...
class IKey(_IResource_80e4520a, typing_extensions.Protocol):
    ...
    def grant_decrypt(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
    ...
    def grant_encrypt(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
    ...
    def grant_encrypt_decrypt(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
...
class Key(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        admins: typing.Optional[typing.List[_IPrincipal_280b818f]] = None,
        alias: typing.Optional[builtins.str] = None,
        description: typing.Optional[builtins.str] = None,
        enabled: typing.Optional[builtins.bool] = None,
        enable_key_rotation: typing.Optional[builtins.bool] = None,
        pending_window: typing.Optional[_Duration_16d61c1f] = None,
        policy: typing.Optional[_PolicyDocument_ca1df618] = None,
        removal_policy: typing.Optional[_RemovalPolicy_815be1ab] = None,
    ...
    def grant_admin(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
    ...
    def _policy(self) -> typing.Optional[_PolicyDocument_ca1df618]:
...
class KeyProps:
    ...
    @builtins.property
    def admins(self) -> typing.Optional[typing.List[_IPrincipal_280b818f]]:
    ...
    @builtins.property
    def pending_window(self) -> typing.Optional[_Duration_16d61c1f]:
    ...
    @builtins.property
    def policy(self) -> typing.Optional[_PolicyDocument_ca1df618]:
...
class ViaServicePrincipal(
    ...
    def __init__(
        ...
        base_principal: typing.Optional[_IPrincipal_280b818f] = None,
    ) -> None:
        """
        :param service_name: -
