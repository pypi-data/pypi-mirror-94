...
class BucketDeployment(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        destination_bucket: _IBucket_feab190d,
        ...
        distribution: typing.Optional[_IDistribution_d112ed76] = None,
...
class BucketDeploymentProps:
    ...
    @builtins.property
    def destination_bucket(self) -> _IBucket_feab190d:
    ...
    @builtins.property
    def distribution(self) -> typing.Optional[_IDistribution_d112ed76]:
...
class DeploymentSourceContext:
    def __init__(self, *, handler_role: _IRole_ecc6f9f1) -> None:
    ...
    @builtins.property
    def handler_role(self) -> _IRole_ecc6f9f1:
...
class Expires(
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.aws_s3_deployment.Expires",
):
    ...
    @builtins.classmethod
    def after(cls, t: _Duration_16d61c1f) -> "Expires":
...
class Source(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_s3_deployment.Source"):
    ...
    @builtins.classmethod
    def bucket(cls, bucket: _IBucket_feab190d, zip_object_key: builtins.str) -> ISource:
