...
class CfnQueue(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        content_based_deduplication: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
        delay_seconds: typing.Optional[jsii.Number] = None,
        fifo_queue: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
...
class IQueue(_IResource_80e4520a, typing_extensions.Protocol):
    ...
    def encryption_master_key(self) -> typing.Optional[_IKey_8849766e]:
    ...
    def grant_consume_messages(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
    ...
    def grant_purge(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
    ...
    def grant_send_messages(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
...
class _QueueBaseProxy(
    QueueBase, jsii.proxy_for(_Resource_d91827d0) # type: ignore
):
    @builtins.property # type: ignore
    @jsii.member(jsii_name="autoCreatePolicy")
    def _auto_create_policy(self) -> builtins.bool:
...
class QueueProps:
    def __init__(
        ...
        *,
        ...
        data_key_reuse: typing.Optional[_Duration_16d61c1f] = None,
        dead_letter_queue: typing.Optional[DeadLetterQueue] = None,
        delivery_delay: typing.Optional[_Duration_16d61c1f] = None,
        encryption: typing.Optional[QueueEncryption] = None,
        encryption_master_key: typing.Optional[_IKey_8849766e] = None,
        fifo: typing.Optional[builtins.bool] = None,
        max_message_size_bytes: typing.Optional[jsii.Number] = None,
        queue_name: typing.Optional[builtins.str] = None,
        receive_message_wait_time: typing.Optional[_Duration_16d61c1f] = None,
        retention_period: typing.Optional[_Duration_16d61c1f] = None,
        visibility_timeout: typing.Optional[_Duration_16d61c1f] = None,
    ) -> None:
    ...
    @builtins.property
    def data_key_reuse(self) -> typing.Optional[_Duration_16d61c1f]:
    ...
    @builtins.property
    def delivery_delay(self) -> typing.Optional[_Duration_16d61c1f]:
    ...
    @builtins.property
    def receive_message_wait_time(self) -> typing.Optional[_Duration_16d61c1f]:
    ...
    @builtins.property
    def visibility_timeout(self) -> typing.Optional[_Duration_16d61c1f]:
