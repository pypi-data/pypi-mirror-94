...
import constructs
from .. import Duration as _Duration_16d61c1f, Reference as _Reference_766c2e2d
from ..aws_cloudformation import (
    CustomResourceProviderConfig as _CustomResourceProviderConfig_dad9ffe4,
    ICustomResourceProvider as _ICustomResourceProvider_055f647c,
)
from ..aws_ec2 import (
    IVpc as _IVpc_eba56bde, SubnetSelection as _SubnetSelection_a3effb51
)
from ..aws_iam import (
...
class AwsCustomResourcePolicy(
    ...
    def from_statements(
        cls,
        statements: typing.List[_PolicyStatement_68f9b23a],
    ) -> "AwsCustomResourcePolicy":
    ...
    def statements(self) -> typing.List[_PolicyStatement_68f9b23a]:
...
@jsii.implements(_ICustomResourceProvider_055f647c)
class Provider(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        on_event_handler: _IFunction_9c701b6f,
        is_complete_handler: typing.Optional[_IFunction_9c701b6f] = None,
        log_retention: typing.Optional[_RetentionDays_2e011834] = None,
        query_interval: typing.Optional[_Duration_16d61c1f] = None,
        total_timeout: typing.Optional[_Duration_16d61c1f] = None,
    ...
    def bind(self, _: constructs.Construct) -> _CustomResourceProviderConfig_dad9ffe4:
    ...
    def on_event_handler(self) -> _IFunction_9c701b6f:
    ...
    def is_complete_handler(self) -> typing.Optional[_IFunction_9c701b6f]:
...
class ProviderProps:
    ...
    @builtins.property
    def query_interval(self) -> typing.Optional[_Duration_16d61c1f]:
    ...
    @builtins.property
    def total_timeout(self) -> typing.Optional[_Duration_16d61c1f]:
