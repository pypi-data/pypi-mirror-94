...
class AuthorizationToken(
    ...
    def grant_read(cls, grantee: _IGrantable_2a849680) -> None:
...
class CfnRepository(
    ...
    def __init__(
        ...
        *,
        ...
        lifecycle_policy: typing.Optional[typing.Union["CfnRepository.LifecyclePolicyProperty", _IResolvable_6e2f5d88]] = None,
        repository_name: typing.Optional[builtins.str] = None,
        repository_policy_text: typing.Any = None,
    ...
    def lifecycle_policy(
        self,
    ) -> typing.Optional[typing.Union["CfnRepository.LifecyclePolicyProperty", _IResolvable_6e2f5d88]]:
    ...
    def lifecycle_policy(
        self,
        value: typing.Optional[typing.Union["CfnRepository.LifecyclePolicyProperty", _IResolvable_6e2f5d88]],
    ) -> None:
...
class IRepository(_IResource_80e4520a, typing_extensions.Protocol):
    ...
    def grant_pull(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
    ...
    def grant_pull_push(self, grantee: _IGrantable_2a849680) -> _Grant_83432421:
...
class LifecycleRule:
    def __init__(
        ...
        *,
        description: typing.Optional[builtins.str] = None,
        max_image_age: typing.Optional[_Duration_16d61c1f] = None,
    ...
    @builtins.property
    def max_image_age(self) -> typing.Optional[_Duration_16d61c1f]:
...
class OnCloudTrailImagePushedOptions(_OnEventOptions_d5835226):
    def __init__(
        self,
        *,
        description: typing.Optional[builtins.str] = None,
...
class OnImageScanCompletedOptions(_OnEventOptions_d5835226):
    def __init__(
        self,
        *,
        description: typing.Optional[builtins.str] = None,
...
class _RepositoryBaseProxy(
    RepositoryBase, jsii.proxy_for(_Resource_d91827d0) # type: ignore
):
    @jsii.member(jsii_name="addToResourcePolicy")
    def add_to_resource_policy(
        self,
