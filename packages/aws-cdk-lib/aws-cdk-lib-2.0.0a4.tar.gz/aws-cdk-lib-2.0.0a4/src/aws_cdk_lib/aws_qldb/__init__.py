...
class CfnStream(
    ...
    def __init__(
        ...
        *,
        ...
        kinesis_configuration: typing.Union["CfnStream.KinesisConfigurationProperty", _IResolvable_6e2f5d88],
    ...
    def kinesis_configuration(
        self,
    ) -> typing.Union["CfnStream.KinesisConfigurationProperty", _IResolvable_6e2f5d88]:
    ...
    def kinesis_configuration(
        self,
        value: typing.Union["CfnStream.KinesisConfigurationProperty", _IResolvable_6e2f5d88],
    ) -> None:
    ...
    class KinesisConfigurationProperty:
        def __init__(
            self,
            *,
            aggregation_enabled: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
