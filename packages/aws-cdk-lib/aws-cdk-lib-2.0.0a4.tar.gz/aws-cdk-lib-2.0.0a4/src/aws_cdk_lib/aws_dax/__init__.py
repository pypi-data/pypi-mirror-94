...
class CfnCluster(
    ...
    def __init__(
        ...
        *,
        ...
        sse_specification: typing.Optional[typing.Union["CfnCluster.SSESpecificationProperty", _IResolvable_6e2f5d88]] = None,
    ...
    def sse_specification(
        self,
    ) -> typing.Optional[typing.Union["CfnCluster.SSESpecificationProperty", _IResolvable_6e2f5d88]]:
    ...
    def sse_specification(
        self,
        value: typing.Optional[typing.Union["CfnCluster.SSESpecificationProperty", _IResolvable_6e2f5d88]],
    ) -> None:
