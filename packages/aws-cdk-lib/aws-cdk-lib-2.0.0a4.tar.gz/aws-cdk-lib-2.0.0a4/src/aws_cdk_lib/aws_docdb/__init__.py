...
class BackupProps:
    ...
    @builtins.property
    def retention(self) -> _Duration_16d61c1f:
...
class DatabaseInstanceProps:
    def __init__(
        ...
        *,
        ...
        instance_class: _InstanceType_8dace4ef,
    ...
    @builtins.property
    def instance_class(self) -> _InstanceType_8dace4ef:
...
class DatabaseSecret(
    ...
    def __init__(
        ...
        *,
        ...
        master_secret: typing.Optional[_ISecret_6affcb67] = None,
...
class DatabaseSecretProps:
    ...
    @builtins.property
    def master_secret(self) -> typing.Optional[_ISecret_6affcb67]:
...
class IDatabaseInstance(_IResource_80e4520a, typing_extensions.Protocol):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_docdb.InstanceProps",
    jsii_struct_bases=[],
    name_mapping={
