...
class CfnGitHubRepository(
    ...
    def __init__(
        ...
        *,
        ...
        code: typing.Optional[typing.Union["CfnGitHubRepository.CodeProperty", _IResolvable_6e2f5d88]] = None,
        connection_arn: typing.Optional[builtins.str] = None,
        enable_issues: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
        is_private: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
    ...
    def code(
        self,
    ) -> typing.Optional[typing.Union["CfnGitHubRepository.CodeProperty", _IResolvable_6e2f5d88]]:
    ...
    def code(
        self,
        value: typing.Optional[typing.Union["CfnGitHubRepository.CodeProperty", _IResolvable_6e2f5d88]],
    ) -> None:
    ...
    class CodeProperty:
        def __init__(
            self,
            *,
            s3: typing.Union["CfnGitHubRepository.S3Property", _IResolvable_6e2f5d88],
        ) -> None:
            """
        ...
        def s3(
            self,
        ) -> typing.Union["CfnGitHubRepository.S3Property", _IResolvable_6e2f5d88]:
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_codestar.GitHubRepositoryProps",
    jsii_struct_bases=[],
    name_mapping={
...
class GitHubRepositoryProps:
    def __init__(
        ...
        *,
        ...
        contents_bucket: _IBucket_feab190d,
    ...
    @builtins.property
    def contents_bucket(self) -> _IBucket_feab190d:
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_codestar.IGitHubRepository")
class IGitHubRepository(_IResource_80e4520a, typing_extensions.Protocol):
...
class _IGitHubRepositoryProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_codestar.IGitHubRepository"
...
@jsii.enum(jsii_type="aws-cdk-lib.aws_codestar.RepositoryVisibility")
...
class GitHubRepository(
    _Resource_d91827d0,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.aws_codestar.GitHubRepository",
):
