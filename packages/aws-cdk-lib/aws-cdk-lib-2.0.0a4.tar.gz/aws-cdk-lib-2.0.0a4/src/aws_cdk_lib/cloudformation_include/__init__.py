...
import constructs
from .. import (
    CfnCondition as _CfnCondition_0b9a74e4,
    CfnElement as _CfnElement_df67fe86,
    CfnHook as _CfnHook_2d3a9939,
    CfnMapping as _CfnMapping_e799f021,
    CfnOutput as _CfnOutput_135c341b,
    CfnParameter as _CfnParameter_54798864,
    CfnResource as _CfnResource_f7d91f4b,
    CfnRule as _CfnRule_fe75e829,
    NestedStack as _NestedStack_4b13b4d4,
)


class CfnInclude(
    _CfnElement_df67fe86,
    ...
    def get_condition(self, condition_name: builtins.str) -> _CfnCondition_0b9a74e4:
    ...
    def get_hook(self, hook_logical_id: builtins.str) -> _CfnHook_2d3a9939:
    ...
    def get_mapping(self, mapping_name: builtins.str) -> _CfnMapping_e799f021:
    ...
    def get_output(self, logical_id: builtins.str) -> _CfnOutput_135c341b:
    ...
    def get_parameter(self, parameter_name: builtins.str) -> _CfnParameter_54798864:
    ...
    def get_resource(self, logical_id: builtins.str) -> _CfnResource_f7d91f4b:
    ...
    def get_rule(self, rule_name: builtins.str) -> _CfnRule_fe75e829:
...
class IncludedNestedStack:
    ...
    @builtins.property
    def stack(self) -> _NestedStack_4b13b4d4:
