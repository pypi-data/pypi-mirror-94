...
from .. import (
    ...
    AssetOptions as _AssetOptions_fecb484b,
    BundlingOptions as _BundlingOptions_274211ce,
    CfnResource as _CfnResource_f7d91f4b,
    IAsset as _IAsset_1bac8f47,
    IgnoreMode as _IgnoreMode_32b624fb,
)
from ..assets import (
    CopyOptions as _CopyOptions_65bbd489, FollowMode as _FollowMode_e1e723bb
)
from ..aws_iam import IGrantable as _IGrantable_2a849680
from ..aws_s3 import IBucket as _IBucket_feab190d


@jsii.implements(_IAsset_1bac8f47)
class Asset(
    ...
    def grant_read(self, grantee: _IGrantable_2a849680) -> None:
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_CopyOptions_65bbd489, _AssetOptions_fecb484b],
    name_mapping={
        "exclude": "exclude",
        "follow": "follow",
...
class AssetOptions(_CopyOptions_65bbd489, _AssetOptions_fecb484b):
    def __init__(
        self,
        *,
        exclude: typing.Optional[typing.List[builtins.str]] = None,
        ...
        if isinstance(bundling, dict):
            bundling = _BundlingOptions_274211ce(**bundling)
    ...
    @builtins.property
    def asset_hash_type(self) -> typing.Optional[_AssetHashType_2d8a5090]:
    ...
    @builtins.property
    def bundling(self) -> typing.Optional[_BundlingOptions_274211ce]:
    ...
    @builtins.property
    def readers(self) -> typing.Optional[typing.List[_IGrantable_2a849680]]:
