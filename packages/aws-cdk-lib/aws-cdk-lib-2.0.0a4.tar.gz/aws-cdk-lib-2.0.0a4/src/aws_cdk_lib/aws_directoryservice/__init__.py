...
class CfnMicrosoftAD(
    ...
    def __init__(
        ...
        *,
        ...
        vpc_settings: typing.Union["CfnMicrosoftAD.VpcSettingsProperty", _IResolvable_6e2f5d88],
        create_alias: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
        edition: typing.Optional[builtins.str] = None,
        enable_sso: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
    ...
    def vpc_settings(
        self,
    ) -> typing.Union["CfnMicrosoftAD.VpcSettingsProperty", _IResolvable_6e2f5d88]:
    ...
    def vpc_settings(
        self,
        value: typing.Union["CfnMicrosoftAD.VpcSettingsProperty", _IResolvable_6e2f5d88],
    ) -> None:
...
class CfnSimpleAD(
    ...
    def __init__(
        ...
        *,
        ...
        password: builtins.str,
        size: builtins.str,
        vpc_settings: typing.Union["CfnSimpleAD.VpcSettingsProperty", _IResolvable_6e2f5d88],
        create_alias: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
    ...
    def vpc_settings(
        self,
    ) -> typing.Union["CfnSimpleAD.VpcSettingsProperty", _IResolvable_6e2f5d88]:
    ...
    def vpc_settings(
        self,
        value: typing.Union["CfnSimpleAD.VpcSettingsProperty", _IResolvable_6e2f5d88],
    ) -> None:
        jsii.set(self, "vpcSettings", value)
