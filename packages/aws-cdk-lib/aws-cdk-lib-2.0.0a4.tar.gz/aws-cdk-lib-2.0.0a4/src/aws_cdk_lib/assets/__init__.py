...
import constructs
from .. import (
    AssetStaging as _AssetStaging_8e3ef68b, IgnoreMode as _IgnoreMode_32b624fb
)


@jsii.data_type(
    jsii_type="aws-cdk-lib.assets.CopyOptions",
    jsii_struct_bases=[],
    name_mapping={
        "exclude": "exclude",
        "follow": "follow",
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.assets.FingerprintOptions",
...
@jsii.enum(jsii_type="aws-cdk-lib.assets.FollowMode")
...
@jsii.interface(jsii_type="aws-cdk-lib.assets.IAsset")
...
class _IAssetProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.assets.IAsset"
...
class Staging(
    _AssetStaging_8e3ef68b,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.assets.Staging",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.assets.StagingProps",
