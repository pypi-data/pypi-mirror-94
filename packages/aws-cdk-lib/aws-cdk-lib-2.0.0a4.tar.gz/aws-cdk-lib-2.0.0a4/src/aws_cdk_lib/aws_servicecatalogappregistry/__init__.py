...
class CfnAttributeGroup(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        attributes: typing.Union["CfnAttributeGroup.AttributesProperty", _IResolvable_6e2f5d88],
        name: builtins.str,
        description: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
    ) -> None:
    ...
    def attributes(
        self,
    ) -> typing.Union["CfnAttributeGroup.AttributesProperty", _IResolvable_6e2f5d88]:
    ...
    def attributes(
        self,
        value: typing.Union["CfnAttributeGroup.AttributesProperty", _IResolvable_6e2f5d88],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_servicecatalogappregistry.CfnAttributeGroup.AttributesProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
