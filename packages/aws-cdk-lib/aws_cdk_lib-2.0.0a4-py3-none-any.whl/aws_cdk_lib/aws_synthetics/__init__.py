...
from ..aws_iam import IGrantable as _IGrantable_2a849680, IRole as _IRole_ecc6f9f1
...
class Canary(
    ...
    def __init__(
        ...
        *,
        ...
        failure_retention_period: typing.Optional[_Duration_16d61c1f] = None,
        role: typing.Optional[_IRole_ecc6f9f1] = None,
        schedule: typing.Optional["Schedule"] = None,
        start_after_creation: typing.Optional[builtins.bool] = None,
        success_retention_period: typing.Optional[_Duration_16d61c1f] = None,
        time_to_live: typing.Optional[_Duration_16d61c1f] = None,
    ) -> None:
        """
        :param scope: -
        :param id: -
    ...
    def metric_duration(
        ...
        *,
        ...
        :stability: experimental
        """
        options = _MetricOptions_3df7ed6c(
            account=account,
            color=color,
    ...
    def artifacts_bucket(self) -> _IBucket_feab190d:
...
class CanaryProps:
    ...
    @builtins.property
    def failure_retention_period(self) -> typing.Optional[_Duration_16d61c1f]:
    ...
    @builtins.property
    def success_retention_period(self) -> typing.Optional[_Duration_16d61c1f]:
    ...
    @builtins.property
    def time_to_live(self) -> typing.Optional[_Duration_16d61c1f]:
...
class CfnCanary(
    ...
    def __init__(
        ...
        *,
        ...
        code: typing.Union["CfnCanary.CodeProperty", _IResolvable_6e2f5d88],
        execution_role_arn: builtins.str,
        name: builtins.str,
        runtime_version: builtins.str,
        schedule: typing.Union["CfnCanary.ScheduleProperty", _IResolvable_6e2f5d88],
        start_canary_after_creation: typing.Union[builtins.bool, _IResolvable_6e2f5d88],
        failure_retention_period: typing.Optional[jsii.Number] = None,
        run_config: typing.Optional[typing.Union["CfnCanary.RunConfigProperty", _IResolvable_6e2f5d88]] = None,
        success_retention_period: typing.Optional[jsii.Number] = None,
        tags: typing.Optional[typing.List[_CfnTag_c592b05a]] = None,
        vpc_config: typing.Optional[typing.Union["CfnCanary.VPCConfigProperty", _IResolvable_6e2f5d88]] = None,
    ) -> None:
    ...
    def code(self) -> typing.Union["CfnCanary.CodeProperty", _IResolvable_6e2f5d88]:
    ...
    def code(
        self,
        value: typing.Union["CfnCanary.CodeProperty", _IResolvable_6e2f5d88],
    ) -> None:
    ...
    def schedule(
        self,
    ) -> typing.Union["CfnCanary.ScheduleProperty", _IResolvable_6e2f5d88]:
    ...
    def schedule(
        self,
        value: typing.Union["CfnCanary.ScheduleProperty", _IResolvable_6e2f5d88],
    ) -> None:
    ...
    def run_config(
        self,
    ) -> typing.Optional[typing.Union["CfnCanary.RunConfigProperty", _IResolvable_6e2f5d88]]:
    ...
    def run_config(
        self,
        value: typing.Optional[typing.Union["CfnCanary.RunConfigProperty", _IResolvable_6e2f5d88]],
    ) -> None:
    ...
    def vpc_config(
        self,
    ) -> typing.Optional[typing.Union["CfnCanary.VPCConfigProperty", _IResolvable_6e2f5d88]]:
    ...
    def vpc_config(
        self,
        value: typing.Optional[typing.Union["CfnCanary.VPCConfigProperty", _IResolvable_6e2f5d88]],
    ) -> None:
    ...
    class RunConfigProperty:
        def __init__(
            ...
            *,
            ...
            active_tracing: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
            environment_variables: typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.Mapping[builtins.str, builtins.str]]] = None,
...
class Code(
    ...
    @abc.abstractmethod
    def bind(self, scope: constructs.Construct, handler: builtins.str) -> "CodeConfig":
...
class InlineCode(
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, _scope: constructs.Construct, handler: builtins.str) -> CodeConfig:
        """(experimental) Called when the canary is initialized to allow this object to bind to the stack, add resources and have fun.
...
class Runtime(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_synthetics.Runtime"):
    ...
    def SYNTHETICS_NODEJS_2_1(cls) -> "Runtime":
        ...
        :stability: experimental
        """
        return jsii.sget(cls, "SYNTHETICS_NODEJS_2_1")
    ...
    def SYNTHETICS_NODEJS_2_2(cls) -> "Runtime":
        ...
        :stability: experimental
        """
        return jsii.sget(cls, "SYNTHETICS_NODEJS_2_2")
...
class S3Code(
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, _scope: constructs.Construct, _handler: builtins.str) -> CodeConfig:
        """(experimental) Called when the canary is initialized to allow this object to bind to the stack, add resources and have fun.
...
class Schedule(
    ...
    @builtins.classmethod
    def rate(cls, interval: _Duration_16d61c1f) -> "Schedule":
