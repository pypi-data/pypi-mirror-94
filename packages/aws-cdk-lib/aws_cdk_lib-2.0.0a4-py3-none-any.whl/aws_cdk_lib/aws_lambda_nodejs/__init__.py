...
class BundlingOptions:
    def __init__(
        ...
        *,
        ...
        docker_image: typing.Optional[_BundlingDockerImage_905f3cec] = None,
    ...
    @builtins.property
    def docker_image(self) -> typing.Optional[_BundlingDockerImage_905f3cec]:
...
class NodejsFunctionProps(_FunctionOptions_c43cd565):
    def __init__(
        self,
        *,
        max_event_age: typing.Optional[_Duration_16d61c1f] = None,
