...
import constructs
from .cx_api import (
    CloudAssembly as _CloudAssembly_496ddbf6,
    CloudAssemblyBuilder as _CloudAssemblyBuilder_3dc1a20e,
    MissingContext as _MissingContext_e1fcd192,
)
...
class BundlingDockerImage(
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.BundlingDockerImage",
):
...
class CfnInclude(
    CfnElement,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.CfnInclude",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.CfnIncludeProps",
    jsii_struct_bases=[],
...
class DependableTrait(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="aws-cdk-lib.DependableTrait",
):
    ...
    @abc.abstractmethod
    def dependency_roots(self) -> typing.List[constructs.IConstruct]:
...
class Fn(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.Fn"):
    ...
    def import_list_value(
        ...
        :stability: experimental
        """
        return jsii.sinvoke(cls, "importListValue", [shared_value_to_import, assumed_length, delimiter])
    ...
    def split(
        ...
        *longer* than the number you pass, but not *shorter*.
        ...
        :stability: experimental
        """
        return jsii.sinvoke(cls, "split", [delimiter, source, assumed_length])
...
@jsii.interface(jsii_type="aws-cdk-lib.IDependable")
...
class _IDependableProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.IDependable"
    pass
...
class ISynthesisSession(typing_extensions.Protocol):
    ...
    def assembly(self) -> _CloudAssemblyBuilder_3dc1a20e:
    ...
    def assembly(self, value: _CloudAssemblyBuilder_3dc1a20e) -> None:
        ...
...
class Stack(
    ...
    def export_value(
        ...
        *,
        ...
        return jsii.invoke(self, "exportValue", [exported_value, options])
    ...
    def report_missing_context(
        ...
        *,
        ...
        :stability: experimental
        """
        report = _MissingContext_e1fcd192(key=key, props=props, provider=provider)
...
class Tokenization(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.Tokenization"):
    ...
    @builtins.classmethod
    def reverse(cls, x: typing.Any) -> typing.Optional[IResolvable]:
        ...
        :stability: experimental
        """
        return jsii.sinvoke(cls, "reverse", [x])
    ...
    def reverse_complete_string(cls, s: builtins.str) -> typing.Optional[IResolvable]:
        ...
        :stability: experimental
        """
        return jsii.sinvoke(cls, "reverseCompleteString", [s])
...
class ConcreteDependable(
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.ConcreteDependable",
):
    ...
    @jsii.member(jsii_name="add")
    def add(self, construct: constructs.IConstruct) -> None:
