...
from ..aws_applicationautoscaling import (
    StepScalingAction as _StepScalingAction_1205f40a
)
from ..aws_autoscaling import StepScalingAction as _StepScalingAction_093e193d
from ..aws_cloudwatch import (
    AlarmActionConfig as _AlarmActionConfig_2a86af86,
    IAlarm as _IAlarm_f8d92702,
    IAlarmAction as _IAlarmAction_3e7ea663,
)
from ..aws_sns import ITopic as _ITopic_2a3c8549


@jsii.implements(_IAlarmAction_3e7ea663)
class ApplicationScalingAction(
    ...
    def __init__(self, step_scaling_action: _StepScalingAction_1205f40a) -> None:
        """
    ...
    def bind(
        ...
        _alarm: _IAlarm_f8d92702,
    ) -> _AlarmActionConfig_2a86af86:
...
class AutoScalingAction(
    ...
    def __init__(self, step_scaling_action: _StepScalingAction_093e193d) -> None:
        """
        :param step_scaling_action: -
