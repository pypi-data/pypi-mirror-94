...
class CertificateValidation(
    ...
    def from_dns(
        cls,
        hosted_zone: typing.Optional[_IHostedZone_8c9385e3] = None,
    ...
    def from_dns_multi_zone(
        cls,
        hosted_zones: typing.Mapping[builtins.str, _IHostedZone_8c9385e3],
    ) -> "CertificateValidation":
...
class CertificationValidationProps:
    def __init__(
        ...
        *,
        hosted_zone: typing.Optional[_IHostedZone_8c9385e3] = None,
        hosted_zones: typing.Optional[typing.Mapping[builtins.str, _IHostedZone_8c9385e3]] = None,
    ...
    @builtins.property
    def hosted_zone(self) -> typing.Optional[_IHostedZone_8c9385e3]:
    ...
    def hosted_zones(
        self,
    ) -> typing.Optional[typing.Mapping[builtins.str, _IHostedZone_8c9385e3]]:
...
class CfnCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        domain_validation_options: typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnCertificate.DomainValidationOptionProperty", _IResolvable_6e2f5d88]]]] = None,
        subject_alternative_names: typing.Optional[typing.List[builtins.str]] = None,
    ...
    def domain_validation_options(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnCertificate.DomainValidationOptionProperty", _IResolvable_6e2f5d88]]]]:
    ...
    def domain_validation_options(
        self,
        value: typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnCertificate.DomainValidationOptionProperty", _IResolvable_6e2f5d88]]]],
    ) -> None:
...
class DnsValidatedCertificateProps(CertificateProps):
    def __init__(
        ...
        *,
        ...
        validation_domains: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        validation_method: typing.Optional["ValidationMethod"] = None,
        hosted_zone: _IHostedZone_8c9385e3,
        custom_resource_role: typing.Optional[_IRole_ecc6f9f1] = None,
    ...
    @builtins.property
    def hosted_zone(self) -> _IHostedZone_8c9385e3:
    ...
    @builtins.property
    def custom_resource_role(self) -> typing.Optional[_IRole_ecc6f9f1]:
...
class ICertificate(_IResource_80e4520a, typing_extensions.Protocol):
