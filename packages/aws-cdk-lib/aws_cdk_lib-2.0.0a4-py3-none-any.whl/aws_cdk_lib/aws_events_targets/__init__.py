...
from ..aws_codebuild import IProject as _IProject_6492bc1f
from ..aws_codepipeline import IPipeline as _IPipeline_d50f819b
from ..aws_ec2 import (
...
from ..aws_events import (
    IRule as _IRule_9dbe731d,
    IRuleTarget as _IRuleTarget_58db40b3,
    RuleTargetConfig as _RuleTargetConfig_c217598c,
    RuleTargetInput as _RuleTargetInput_79a4a67d,
)
from ..aws_iam import (
...
from ..aws_kinesisfirehose import CfnDeliveryStream as _CfnDeliveryStream_787b6aaf
...
@jsii.implements(_IRuleTarget_58db40b3)
class AwsApi(
    ...
    def __init__(
        self,
        *,
        policy_statement: typing.Optional[_PolicyStatement_68f9b23a] = None,
        action: builtins.str,
    ...
    def bind(
        self,
        rule: _IRule_9dbe731d,
        id: typing.Optional[builtins.str] = None,
    ) -> _RuleTargetConfig_c217598c:
...
class AwsApiProps(AwsApiInput):
    ...
    @builtins.property
    def policy_statement(self) -> typing.Optional[_PolicyStatement_68f9b23a]:
...
class BatchJob(
    ...
    def __init__(
        ...
        *,
        ...
        event: typing.Optional[_RuleTargetInput_79a4a67d] = None,
...
class BatchJobProps:
    ...
    @builtins.property
    def event(self) -> typing.Optional[_RuleTargetInput_79a4a67d]:
...
class CodePipelineTargetOptions:
    def __init__(self, *, event_role: typing.Optional[_IRole_ecc6f9f1] = None) -> None:
...
class KinesisFirehoseStream(
    ...
    def __init__(
        self,
        stream: _CfnDeliveryStream_787b6aaf,
        *,
        message: typing.Optional[_RuleTargetInput_79a4a67d] = None,
    ) -> None:
        """
        :param stream: -
...
class KinesisFirehoseStreamProps:
    ...
    @builtins.property
    def message(self) -> typing.Optional[_RuleTargetInput_79a4a67d]:
...
class SfnStateMachine(
    ...
    def __init__(
        self,
        machine: _IStateMachine_d6faa049,
        *,
        input: typing.Optional[_RuleTargetInput_79a4a67d] = None,
        role: typing.Optional[_IRole_ecc6f9f1] = None,
    ) -> None:
        """
        :param machine: -
    ...
    def machine(self) -> _IStateMachine_d6faa049:
        """
        :stability: experimental
        """
...
class SfnStateMachineProps:
    ...
    @builtins.property
    def input(self) -> typing.Optional[_RuleTargetInput_79a4a67d]:
