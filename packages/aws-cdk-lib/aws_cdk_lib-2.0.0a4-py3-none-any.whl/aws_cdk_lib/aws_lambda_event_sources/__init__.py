...
from ..aws_apigateway import (
    AuthorizationType as _AuthorizationType_3d4e9a4c,
    IAuthorizer as _IAuthorizer_c6dea837,
    IModel as _IModel_8fefe196,
    IRequestValidator as _IRequestValidator_28700650,
    MethodOptions as _MethodOptions_9b62ddbc,
    MethodResponse as _MethodResponse_af3c8c56,
    RequestValidatorOptions as _RequestValidatorOptions_e87802b1,
)
from ..aws_dynamodb import ITable as _ITable_5428523e
from ..aws_kinesis import IStream as _IStream_778702ee
from ..aws_lambda import (
    DlqDestinationConfig as _DlqDestinationConfig_84601acc,
    ...
    IEventSourceMapping as _IEventSourceMapping_f871ef0b,
    IFunction as _IFunction_9c701b6f,
    StartingPosition as _StartingPosition_39042023,
)
from ..aws_s3 import (
    Bucket as _Bucket_866d2129,
    EventType as _EventType_f14ffb73,
    NotificationKeyFilter as _NotificationKeyFilter_2e2c134a,
)
from ..aws_sns import (
    ITopic as _ITopic_2a3c8549, SubscriptionFilter as _SubscriptionFilter_3a8bad28
)
from ..aws_sns_subscriptions import (
    LambdaSubscriptionProps as _LambdaSubscriptionProps_9271333e
)
from ..aws_sqs import IQueue as _IQueue_728eee9f


@jsii.implements(_IEventSource_fe27fb59)
class ApiEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        authorization_type: typing.Optional[_AuthorizationType_3d4e9a4c] = None,
        authorizer: typing.Optional[_IAuthorizer_c6dea837] = None,
        method_responses: typing.Optional[typing.List[_MethodResponse_af3c8c56]] = None,
        operation_name: typing.Optional[builtins.str] = None,
        request_models: typing.Optional[typing.Mapping[builtins.str, _IModel_8fefe196]] = None,
        request_parameters: typing.Optional[typing.Mapping[builtins.str, builtins.bool]] = None,
        request_validator: typing.Optional[_IRequestValidator_28700650] = None,
        request_validator_options: typing.Optional[_RequestValidatorOptions_e87802b1] = None,
    ) -> None:
        """
        :param method: -
        :param path: -
        ...
        :stability: experimental
        """
        options = _MethodOptions_9b62ddbc(
    ...
    def bind(self, target: _IFunction_9c701b6f) -> None:
...
class S3EventSource(
    ...
    def __init__(
        self,
        bucket: _Bucket_866d2129,
        *,
        events: typing.List[_EventType_f14ffb73],
        filters: typing.Optional[typing.List[_NotificationKeyFilter_2e2c134a]] = None,
    ) -> None:
        """
        :param bucket: -
    ...
    def bucket(self) -> _Bucket_866d2129:
        """
        :stability: experimental
        """
...
class S3EventSourceProps:
    ...
    @builtins.property
    def events(self) -> typing.List[_EventType_f14ffb73]:
    ...
    @builtins.property
    def filters(self) -> typing.Optional[typing.List[_NotificationKeyFilter_2e2c134a]]:
...
@jsii.implements(_IEventSourceDlq_5caed029)
class SnsDlq(
    metaclass=jsii.JSIIMeta,
    ...
    def bind(
        self,
        _target: _IEventSourceMapping_f871ef0b,
        target_handler: _IFunction_9c701b6f,
    ) -> _DlqDestinationConfig_84601acc:
...
class SnsEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        filter_policy: typing.Optional[typing.Mapping[builtins.str, _SubscriptionFilter_3a8bad28]] = None,
    ) -> None:
        """
        :param topic: -
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_LambdaSubscriptionProps_9271333e],
    name_mapping={
        "dead_letter_queue": "deadLetterQueue",
        "filter_policy": "filterPolicy",
    },
)
class SnsEventSourceProps(_LambdaSubscriptionProps_9271333e):
    def __init__(
        self,
        *,
        dead_letter_queue: typing.Optional[_IQueue_728eee9f] = None,
    ...
    def filter_policy(
        self,
    ) -> typing.Optional[typing.Mapping[builtins.str, _SubscriptionFilter_3a8bad28]]:
...
class StreamEventSource(
    ...
    def __init__(
        self,
        *,
        starting_position: _StartingPosition_39042023,
        batch_size: typing.Optional[jsii.Number] = None,
    ...
    @jsii.member(jsii_name="bind")
    @abc.abstractmethod
    def bind(self, _target: _IFunction_9c701b6f) -> None:
        """(experimental) Called by ``lambda.addEventSource`` to allow the event source to bind to this function.
    ...
    ) -> _EventSourceMappingOptions_4d300186:
        """
...
class StreamEventSourceProps:
    ...
    @builtins.property
    def starting_position(self) -> _StartingPosition_39042023:
    ...
    @builtins.property
    def on_failure(self) -> typing.Optional[_IEventSourceDlq_5caed029]:
...
class KinesisEventSource(
    ...
    def stream(self) -> _IStream_778702ee:
        """
        :stability: experimental
        """
