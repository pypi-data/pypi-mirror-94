...
class CfnChannel(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        authorized: typing.Optional[typing.Union[builtins.bool, _IResolvable_6e2f5d88]] = None,
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_ivs.ChannelProps",
    jsii_struct_bases=[],
    name_mapping={
        "authorized": "authorized",
        "latency_mode": "latencyMode",
...
@jsii.enum(jsii_type="aws-cdk-lib.aws_ivs.ChannelType")
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_ivs.IChannel")
class IChannel(_IResource_80e4520a, typing_extensions.Protocol):
...
class _IChannelProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_ivs.IChannel"
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_ivs.IPlaybackKeyPair")
class IPlaybackKeyPair(_IResource_80e4520a, typing_extensions.Protocol):
...
class _IPlaybackKeyPairProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_ivs.IPlaybackKeyPair"
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_ivs.IStreamKey")
class IStreamKey(_IResource_80e4520a, typing_extensions.Protocol):
...
class _IStreamKeyProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_ivs.IStreamKey"
...
@jsii.enum(jsii_type="aws-cdk-lib.aws_ivs.LatencyMode")
...
class PlaybackKeyPair(
    _Resource_d91827d0,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.aws_ivs.PlaybackKeyPair",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_ivs.PlaybackKeyPairProps",
    jsii_struct_bases=[],
...
class StreamKey(
    _Resource_d91827d0,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.aws_ivs.StreamKey",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_ivs.StreamKeyProps",
    jsii_struct_bases=[],
...
class Channel(
    _Resource_d91827d0,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.aws_ivs.Channel",
):
