...
from ..aws_ec2 import Instance as _Instance_7a1a6a02
...
@jsii.implements(_IApplicationLoadBalancerTarget_10dcb925, _INetworkLoadBalancerTarget_86da9fc5)
...
@jsii.implements(_IApplicationLoadBalancerTarget_10dcb925)
class LambdaTarget(
    metaclass=jsii.JSIIMeta,
