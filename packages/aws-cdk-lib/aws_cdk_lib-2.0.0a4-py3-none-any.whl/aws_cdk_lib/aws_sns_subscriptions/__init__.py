...
from ..aws_sns import (
    ITopic as _ITopic_2a3c8549,
    ITopicSubscription as _ITopicSubscription_64a37928,
    SubscriptionFilter as _SubscriptionFilter_3a8bad28,
    SubscriptionProtocol as _SubscriptionProtocol_8defe820,
    TopicSubscriptionConfig as _TopicSubscriptionConfig_38496e0c,
)
from ..aws_sqs import IQueue as _IQueue_728eee9f


@jsii.implements(_ITopicSubscription_64a37928)
class EmailSubscription(
    ...
    def bind(self, _topic: _ITopic_2a3c8549) -> _TopicSubscriptionConfig_38496e0c:
...
class LambdaSubscription(
    ...
    @jsii.member(jsii_name="bind")
    def bind(self, topic: _ITopic_2a3c8549) -> _TopicSubscriptionConfig_38496e0c:
...
class UrlSubscription(
    ...
    def __init__(
        ...
        url: builtins.str,
        *,
        protocol: typing.Optional[_SubscriptionProtocol_8defe820] = None,
        raw_message_delivery: typing.Optional[builtins.bool] = None,
        dead_letter_queue: typing.Optional[_IQueue_728eee9f] = None,
        filter_policy: typing.Optional[typing.Mapping[builtins.str, _SubscriptionFilter_3a8bad28]] = None,
    ) -> None:
...
class UrlSubscriptionProps(SubscriptionProps):
    ...
    @builtins.property
    def protocol(self) -> typing.Optional[_SubscriptionProtocol_8defe820]:
