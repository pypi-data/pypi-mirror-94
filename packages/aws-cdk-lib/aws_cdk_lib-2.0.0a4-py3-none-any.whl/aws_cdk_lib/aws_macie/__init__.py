...
class CfnCustomDataIdentifier(
    ...
    def attr_deleted(self) -> _IResolvable_6e2f5d88:
        """
...
class CfnFindingsFilter(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        finding_criteria: typing.Union["CfnFindingsFilter.FindingCriteriaProperty", _IResolvable_6e2f5d88],
        name: builtins.str,
    ...
    def attr_findings_filter_list_items(self) -> _IResolvable_6e2f5d88:
        """
    ...
    def finding_criteria(
        self,
    ) -> typing.Union["CfnFindingsFilter.FindingCriteriaProperty", _IResolvable_6e2f5d88]:
    ...
    def finding_criteria(
        self,
        value: typing.Union["CfnFindingsFilter.FindingCriteriaProperty", _IResolvable_6e2f5d88],
    ) -> None:
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_macie.CfnFindingsFilter.CriterionProperty",
        jsii_struct_bases=[],
        name_mapping={},
    )
    ...
    class FindingCriteriaProperty:
        def __init__(
            self,
            *,
            criterion: typing.Optional[typing.Union["CfnFindingsFilter.CriterionProperty", _IResolvable_6e2f5d88]] = None,
        ) -> None:
            """
        ...
        def criterion(
            self,
        ) -> typing.Optional[typing.Union["CfnFindingsFilter.CriterionProperty", _IResolvable_6e2f5d88]]:
