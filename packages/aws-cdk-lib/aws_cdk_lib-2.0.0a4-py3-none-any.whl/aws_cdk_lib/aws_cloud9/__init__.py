...
class CfnEnvironmentEC2(
    ...
    def __init__(
        ...
        *,
        ...
        repositories: typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnEnvironmentEC2.RepositoryProperty", _IResolvable_6e2f5d88]]]] = None,
    ...
    def repositories(
        self,
    ) -> typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnEnvironmentEC2.RepositoryProperty", _IResolvable_6e2f5d88]]]]:
    ...
    def repositories(
        self,
        value: typing.Optional[typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnEnvironmentEC2.RepositoryProperty", _IResolvable_6e2f5d88]]]],
    ) -> None:
...
class CloneRepository(
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.aws_cloud9.CloneRepository",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_cloud9.Ec2EnvironmentProps",
    jsii_struct_bases=[],
    name_mapping={
        "vpc": "vpc",
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_cloud9.IEc2Environment")
class IEc2Environment(_IResource_80e4520a, typing_extensions.Protocol):
...
class _IEc2EnvironmentProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_cloud9.IEc2Environment"
...
class Ec2Environment(
    _Resource_d91827d0,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.aws_cloud9.Ec2Environment",
):
