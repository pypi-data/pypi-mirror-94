...
from ..aws_ec2 import IVpc as _IVpc_eba56bde
...
class CfnService(
    ...
    def __init__(
        ...
        *,
        description: typing.Optional[builtins.str] = None,
        dns_config: typing.Optional[typing.Union["CfnService.DnsConfigProperty", _IResolvable_6e2f5d88]] = None,
        health_check_config: typing.Optional[typing.Union["CfnService.HealthCheckConfigProperty", _IResolvable_6e2f5d88]] = None,
        health_check_custom_config: typing.Optional[typing.Union["CfnService.HealthCheckCustomConfigProperty", _IResolvable_6e2f5d88]] = None,
        name: typing.Optional[builtins.str] = None,
    ...
    def dns_config(
        self,
    ) -> typing.Optional[typing.Union["CfnService.DnsConfigProperty", _IResolvable_6e2f5d88]]:
    ...
    def dns_config(
        self,
        value: typing.Optional[typing.Union["CfnService.DnsConfigProperty", _IResolvable_6e2f5d88]],
    ) -> None:
    ...
    def health_check_config(
        self,
    ) -> typing.Optional[typing.Union["CfnService.HealthCheckConfigProperty", _IResolvable_6e2f5d88]]:
    ...
    def health_check_config(
        self,
        value: typing.Optional[typing.Union["CfnService.HealthCheckConfigProperty", _IResolvable_6e2f5d88]],
    ) -> None:
    ...
    def health_check_custom_config(
        self,
    ) -> typing.Optional[typing.Union["CfnService.HealthCheckCustomConfigProperty", _IResolvable_6e2f5d88]]:
    ...
    def health_check_custom_config(
        self,
        value: typing.Optional[typing.Union["CfnService.HealthCheckCustomConfigProperty", _IResolvable_6e2f5d88]],
    ) -> None:
    ...
    class DnsConfigProperty:
        def __init__(
            self,
            *,
            dns_records: typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnService.DnsRecordProperty", _IResolvable_6e2f5d88]]],
            namespace_id: typing.Optional[builtins.str] = None,
        ...
        def dns_records(
            self,
        ) -> typing.Union[_IResolvable_6e2f5d88, typing.List[typing.Union["CfnService.DnsRecordProperty", _IResolvable_6e2f5d88]]]:
...
class DnsServiceProps(BaseServiceProps):
    def __init__(
        ...
        *,
        ...
        dns_ttl: typing.Optional[_Duration_16d61c1f] = None,
    ...
    @builtins.property
    def dns_ttl(self) -> typing.Optional[_Duration_16d61c1f]:
...
class IInstance(_IResource_80e4520a, typing_extensions.Protocol):
    """
    :stability: experimental
    """
...
class INamespace(_IResource_80e4520a, typing_extensions.Protocol):
    """
    :stability: experimental
    """
...
class IService(_IResource_80e4520a, typing_extensions.Protocol):
    """
    :stability: experimental
    """
...
class _InstanceBaseProxy(
    InstanceBase, jsii.proxy_for(_Resource_d91827d0) # type: ignore
):
    @builtins.property # type: ignore
    @jsii.member(jsii_name="instanceId")
    def instance_id(self) -> builtins.str:
...
class Service(
    ...
    def register_load_balancer(
        self,
        id: builtins.str,
        load_balancer: _ILoadBalancerV2_4d58258a,
        custom_attributes: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
    ) -> IInstance:
