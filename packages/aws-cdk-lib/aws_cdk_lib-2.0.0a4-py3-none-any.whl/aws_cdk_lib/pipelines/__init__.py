...
import constructs
from .. import CfnOutput as _CfnOutput_135c341b, Stage as _Stage_ba8cab35
from ..aws_codebuild import (
    BuildEnvironment as _BuildEnvironment_036ca9de,
...
from ..aws_codepipeline import (
    ...
    Pipeline as _Pipeline_ac279bc5,
)
from ..aws_ec2 import (
...
from ..cx_api import (
    CloudFormationStackArtifact as _CloudFormationStackArtifact_f422f605
)


@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.AddManualApprovalOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.AddStackOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.AddStageOptions",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.AdditionalArtifact",
    jsii_struct_bases=[],
...
class AdditionalArtifact:
    ...
    @builtins.property
    def artifact(self) -> _Artifact_18a071fb:
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.AssetPublishingCommand",
    jsii_struct_bases=[],
    name_mapping={
        "asset_id": "assetId",
...
class CdkPipeline(
    ...
    jsii_type="aws-cdk-lib.pipelines.CdkPipeline",
):
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        cloud_assembly_artifact: _Artifact_18a071fb,
        cdk_cli_version: typing.Optional[builtins.str] = None,
        code_pipeline: typing.Optional[_Pipeline_ac279bc5] = None,
        ...
        source_action: typing.Optional[_IAction_25ca9e01] = None,
        subnet_selection: typing.Optional[_SubnetSelection_a3effb51] = None,
        synth_action: typing.Optional[_IAction_25ca9e01] = None,
    ...
    def stack_output(self, cfn_output: _CfnOutput_135c341b) -> "StackOutput":
    ...
    def stage(self, stage_name: builtins.str) -> _IStage_d6c78f11:
    ...
    def code_pipeline(self) -> _Pipeline_ac279bc5:
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.CdkPipelineProps",
    jsii_struct_bases=[],
    name_mapping={
...
class CdkPipelineProps:
    ...
    @builtins.property
    def cloud_assembly_artifact(self) -> _Artifact_18a071fb:
    ...
    @builtins.property
    def code_pipeline(self) -> typing.Optional[_Pipeline_ac279bc5]:
    ...
    @builtins.property
    def source_action(self) -> typing.Optional[_IAction_25ca9e01]:
    ...
    @builtins.property
    def synth_action(self) -> typing.Optional[_IAction_25ca9e01]:
...
class CdkStage(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.pipelines.CdkStage",
):
    ...
    def __init__(
        ...
        *,
        cloud_assembly_artifact: _Artifact_18a071fb,
        host: "IStageHost",
        pipeline_stage: _IStage_d6c78f11,
    ...
    def add_actions(self, *actions: _IAction_25ca9e01) -> None:
    ...
    def add_stack_artifact_deployment(
        self,
        stack_artifact: _CloudFormationStackArtifact_f422f605,
        *,
        execute_run_order: typing.Optional[jsii.Number] = None,
        run_order: typing.Optional[jsii.Number] = None,
    ) -> None:
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.CdkStageProps",
    jsii_struct_bases=[],
    name_mapping={
        "cloud_assembly_artifact": "cloudAssemblyArtifact",
        "host": "host",
...
class CdkStageProps:
    ...
    @builtins.property
    def pipeline_stage(self) -> _IStage_d6c78f11:
...
class DeployCdkStackAction(
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.pipelines.DeployCdkStackAction",
):
    ...
    def __init__(
        self,
        *,
        action_role: _IRole_ecc6f9f1,
        stack_name: builtins.str,
        template_path: builtins.str,
        cloud_formation_execution_role: typing.Optional[_IRole_ecc6f9f1] = None,
        ...
        cloud_assembly_input: _Artifact_18a071fb,
    ...
    def from_stack_artifact(
        cls,
        scope: constructs.Construct,
        artifact: _CloudFormationStackArtifact_f422f605,
        *,
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.DeployCdkStackActionOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class DeployCdkStackActionOptions:
    ...
    @builtins.property
    def cloud_assembly_input(self) -> _Artifact_18a071fb:
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.DeployCdkStackActionProps",
...
class DeployCdkStackActionProps(DeployCdkStackActionOptions):
    ...
    @builtins.property
    def action_role(self) -> _IRole_ecc6f9f1:
    ...
    @builtins.property
    def cloud_formation_execution_role(self) -> typing.Optional[_IRole_ecc6f9f1]:
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.FromStackArtifactOptions",
    jsii_struct_bases=[],
    name_mapping={
        "cloud_assembly_input": "cloudAssemblyInput",
        "execute_run_order": "executeRunOrder",
...
@jsii.interface(jsii_type="aws-cdk-lib.pipelines.IStageHost")
class IStageHost(typing_extensions.Protocol):
    ...
    ) -> typing.Optional[_Artifact_18a071fb]:
...
class _IStageHostProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.pipelines.IStageHost"
...
class PublishAssetsAction(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.pipelines.PublishAssetsAction",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.PublishAssetsActionProps",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.implements(_IAction_25ca9e01, _IGrantable_2a849680)
class ShellScriptAction(
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.pipelines.ShellScriptAction",
):
    ...
    def __init__(
        ...
        *,
        ...
        additional_artifacts: typing.Optional[typing.List[_Artifact_18a071fb]] = None,
        bash_options: typing.Optional[builtins.str] = None,
        environment: typing.Optional[_BuildEnvironment_036ca9de] = None,
        environment_variables: typing.Optional[typing.Mapping[builtins.str, _BuildEnvironmentVariable_85b991ce]] = None,
        role_policy_statements: typing.Optional[typing.List[_PolicyStatement_68f9b23a]] = None,
        run_order: typing.Optional[jsii.Number] = None,
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.ShellScriptActionProps",
    jsii_struct_bases=[],
    name_mapping={
        "action_name": "actionName",
        "commands": "commands",
...
class ShellScriptActionProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(environment, dict):
            environment = _BuildEnvironment_036ca9de(**environment)
        if isinstance(subnet_selection, dict):
            subnet_selection = _SubnetSelection_a3effb51(**subnet_selection)
        self._values: typing.Dict[str, typing.Any] = {
            "action_name": action_name,
    ...
    @builtins.property
    def additional_artifacts(self) -> typing.Optional[typing.List[_Artifact_18a071fb]]:
    ...
    @builtins.property
    def environment(self) -> typing.Optional[_BuildEnvironment_036ca9de]:
...
class SimpleSynthAction(
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.pipelines.SimpleSynthAction",
):
    ...
    def __init__(
        ...
        *,
        ...
        cloud_assembly_artifact: _Artifact_18a071fb,
        source_artifact: _Artifact_18a071fb,
        action_name: typing.Optional[builtins.str] = None,
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.SimpleSynthOptions",
    jsii_struct_bases=[],
    name_mapping={
        "cloud_assembly_artifact": "cloudAssemblyArtifact",
...
class SimpleSynthOptions:
    ...
    @builtins.property
    def source_artifact(self) -> _Artifact_18a071fb:
...
class StackOutput(
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.pipelines.StackOutput",
):
    ...
    def __init__(
        self,
        artifact_file: _ArtifactPath_03fe5e27,
    ...
    def artifact_file(self) -> _ArtifactPath_03fe5e27:
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.StandardNpmSynthOptions",
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.StandardYarnSynthOptions",
    jsii_struct_bases=[SimpleSynthOptions],
    name_mapping={
        "cloud_assembly_artifact": "cloudAssemblyArtifact",
        "source_artifact": "sourceArtifact",
...
class UpdatePipelineAction(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="aws-cdk-lib.pipelines.UpdatePipelineAction",
):
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.UpdatePipelineActionProps",
    jsii_struct_bases=[],
    name_mapping={
        "cloud_assembly_input": "cloudAssemblyInput",
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.CdkStackActionFromArtifactOptions",
    jsii_struct_bases=[DeployCdkStackActionOptions],
    name_mapping={
        "cloud_assembly_input": "cloudAssemblyInput",
        "base_action_name": "baseActionName",
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.pipelines.SimpleSynthActionProps",
    jsii_struct_bases=[SimpleSynthOptions],
    name_mapping={
        "cloud_assembly_artifact": "cloudAssemblyArtifact",
        "source_artifact": "sourceArtifact",
