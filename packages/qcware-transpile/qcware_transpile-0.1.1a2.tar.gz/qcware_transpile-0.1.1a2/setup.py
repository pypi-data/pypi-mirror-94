...
package_data = \
{'': ['*'],
 'qcware_transpile.dialects.quasar': ['.mypy_cache/*',
                                      '.mypy_cache/3.8/*',
                                      ...
                                      '.mypy_cache/3.8/os/*',
                                      '.mypy_cache/3.8/pyrsistent/*',
                                      '.mypy_cache/3.8/qcware_transpile/*',
                                      '.mypy_cache/3.8/qcware_transpile/dialects/*',
                                      '.mypy_cache/3.8/qcware_transpile/dialects/quasar/*']}
