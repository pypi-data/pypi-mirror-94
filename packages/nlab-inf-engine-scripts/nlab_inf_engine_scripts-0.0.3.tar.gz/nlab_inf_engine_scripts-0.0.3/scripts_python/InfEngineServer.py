...
# Paths.
from scripts_python.functions import create_temp_dir
from scripts_python.InfEngineServerEngine import InfEngineServerEngine
...
class InfEngineServer:
    ...
    def __init__(self, root_path: Path = None, logging_level: int = logging.ERROR):
    ...
    def update_data(
        self, dldata: str = None, dlsources: str = None, strict: bool = False
    ):
        """ Update DL data. """
        ...
        engine.install(dldata, dlsources)
