...
API_URL = 'https://datarobot.orm.datarobot.com/predApi/v1.0/deployments/{deployment_id}/predictions'
API_KEY = 'NWQzZjM1NjU1YWZjOGE0NTcxYzBiMmNkOmhPSTFWYjl1OUxheldRRW1qa2FkbE9XR3FjYUFjRERZ'
DATAROBOT_KEY = '74195484-be46-a062-8517-f351c4ee38da'

DEPLOYMENT_ID = '601cf5db91d51cf92184c237'
...
def make_datarobot_deployment_predictions(data, deployment_id):
    ...
    See docs for details:
         https://staging.datarobot.com/docs/users-guide/predictions/api/new-prediction-api.html
    ...
    -------
    Response schema:
        https://staging.datarobot.com/docs/users-guide/predictions/api/new-prediction-api.html#response-schema
    ...
    # https://staging.datarobot.com/docs/users-guide/predictions/api/new-prediction-api.html#request-pred-explanations
