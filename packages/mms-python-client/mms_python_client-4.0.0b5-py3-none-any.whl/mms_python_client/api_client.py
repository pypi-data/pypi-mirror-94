...
from mms_python_client import rest
from mms_python_client.configuration import Configuration
from mms_python_client.exceptions import ApiTypeError, ApiValueError, ApiException
from mms_python_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/4.0.0.b5/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_or_update_artifacts  # this is an instance of the class Endpoint
        api_instance.create_or_update_artifacts()  # this invokes api_instance.create_or_update_artifacts.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_or_update_artifacts.callable or self.callable in this class
