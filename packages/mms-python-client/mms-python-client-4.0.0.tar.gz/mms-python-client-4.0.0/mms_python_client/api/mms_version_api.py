...
class MMSVersionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_mms_version(
            self,
            **kwargs
        ):
            """get_mms_version  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_mms_version(async_req=True)
            >>> result = thread.get()
        ...
        self.get_mms_version = _Endpoint(
            settings={
                'response_type': (InlineResponse200,),
                'auth': [],
                'endpoint_path': '/mmsversion',
                'operation_id': 'get_mms_version',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
