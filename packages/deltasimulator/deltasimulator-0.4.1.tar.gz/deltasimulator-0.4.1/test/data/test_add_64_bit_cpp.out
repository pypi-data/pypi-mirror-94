...
int sc_main(int argc, char* argv[]) {
    ...
    sc_trace_file *Tf = sc_create_vcd_trace_file("test_add_64_bit");
    Test_Add_64_Bit test_add_64_bit("test_add_64_bit", Tf);
    sc_clock clk("clk", sc_time(1, SC_NS)); sc_trace(Tf, clk, "clk");
    sc_signal<bool> rst; sc_trace(Tf, rst, "rst");
    rst.write(0);
    test_add_64_bit.clk.bind(clk);
    test_add_64_bit.rst.bind(rst);
