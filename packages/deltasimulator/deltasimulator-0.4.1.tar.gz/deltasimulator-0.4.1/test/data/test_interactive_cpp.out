...
int sc_main(int argc, char* argv[]) {
    ...
    sc_trace_file *Tf = sc_create_vcd_trace_file("test_interactive");
    Test_Interactive test_interactive("test_interactive", Tf);
    sc_clock clk("clk", sc_time(1, SC_NS)); sc_trace(Tf, clk, "clk");
    sc_signal<bool> rst; sc_trace(Tf, rst, "rst");
    rst.write(0);
    test_interactive.clk.bind(clk);
    test_interactive.rst.bind(rst);
