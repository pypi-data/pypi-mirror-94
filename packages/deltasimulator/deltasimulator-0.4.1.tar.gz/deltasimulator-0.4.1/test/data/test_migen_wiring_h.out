...
#ifndef _VCOUNTER2_2_H_
#define _VCOUNTER2_2_H_  // guard

#include "systemc.h"
#include "verilated_sc.h"
#include "verilated.h"

class Vcounter2_2__Syms;

//----------

SC_MODULE(Vcounter2_2) {
  public:
    ...
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    WData/*999:0*/ counter2_2__DOT__counter[32];
    IData/*31:0*/ counter2_2__DOT__mem1[100];
    IData/*31:0*/ counter2_2__DOT__mem2[100];
    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*0:0*/ __Vcellinp__counter2_2__sys_clk;
    CData/*0:0*/ __Vcellinp__counter2_2__sys_rst;
    CData/*0:0*/ __Vcellinp__counter2_2__o1_out_ready;
    CData/*0:0*/ __Vcellout__counter2_2__o1_out_valid;
    CData/*0:0*/ __Vcellout__counter2_2__i1_in_ready;
    CData/*0:0*/ __Vclklast__TOP____Vcellinp__counter2_2__sys_clk;
    IData/*31:0*/ __Vcellout__counter2_2__o1_out_data;
    IData/*31:0*/ __Vcellinp__counter2_2__i1_in_data;
    
    // INTERNAL VARIABLES
    // Internals; generally not touched by application code
    Vcounter2_2__Syms* __VlSymsp;  // Symbol table
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vcounter2_2);  ///< Copying not allowed
  public:
    SC_CTOR(Vcounter2_2);
    virtual ~Vcounter2_2();
  ...
  public:
    ...
    // INTERNAL METHODS
  private:
    static void _eval_initial_loop(Vcounter2_2__Syms* __restrict vlSymsp);
  public:
    void __Vconfigure(Vcounter2_2__Syms* symsp, bool first);
  private:
    static QData _change_request(Vcounter2_2__Syms* __restrict vlSymsp);
  public:
    static void _combo__TOP__2(Vcounter2_2__Syms* __restrict vlSymsp);
    static void _combo__TOP__5(Vcounter2_2__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    static void _eval(Vcounter2_2__Syms* __restrict vlSymsp);
  private:
#ifdef VL_DEBUG
    void _eval_debug_assertions();
#endif  // VL_DEBUG
  public:
    static void _eval_initial(Vcounter2_2__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _eval_settle(Vcounter2_2__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _initial__TOP__1(Vcounter2_2__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _sequent__TOP__4(Vcounter2_2__Syms* __restrict vlSymsp);
    static void _settle__TOP__3(Vcounter2_2__Syms* __restrict vlSymsp) VL_ATTR_COLD;
} VL_ATTR_ALIGNED(128);
...
#ifndef __TEST_MIGEN_WIRING__
#define __TEST_MIGEN_WIRING__
#include <systemc>
using namespace sc_core;
...
sc_signal<sc_bv<32>> wire_1_0_2_0_data;
sc_signal<sc_bv<1>> wire_1_0_2_0_valid;
sc_signal<sc_bv<1>> wire_1_0_2_0_ready;
...
// to a queue
sc_fifo<sc_dt::sc_bv<32>> wire_2_0_3_0_py_in;
sc_signal<sc_bv<32>> wire_2_0_3_0_migen_out;
sc_signal<sc_bv<1>> wire_2_0_3_0_out_valid;
sc_signal<sc_bv<1>> wire_2_0_3_0_out_ready;
MigenToPython<sc_bv<32>> wire_2_0_3_0_adaptor;
...
Vcounter2_2 counter2_2;
ClkToBV counter2_2_clk;
sc_signal<sc_bv<1>> counter2_2_sysclk;

// Constructor first initialises queues, modules and adaptors
typedef Test_Migen_Wiring SC_CURRENT_USER_MODULE;
Test_Migen_Wiring(sc_module_name name, sc_trace_file *Tf):
wire_0_0_1_0_py_out("wire_0_0_1_0_py_out"),
wire_0_0_1_0_adaptor("wire_0_0_1_0_adaptor"),
wire_2_0_3_0_py_in("wire_2_0_3_0_py_in"),
wire_2_0_3_0_adaptor("wire_2_0_3_0_adaptor"),
...
counter2_2_clk("counter2_2_clk")
{
    ...
    counter2_2_clk.clk(clk);
    counter2_2_clk.clkout.bind(counter2_2_sysclk);
    counter2_2.sys_clk.bind(counter2_2_sysclk);
    sc_trace(Tf, counter2_2_sysclk, "counter2_2_sysclk");
    counter2_2.sys_rst.bind(rst_bv);

    // Wiring the Python to Python nodes

    // Wiring the Migen to Migen nodes
    counter1_1.o1_out_data.bind(wire_1_0_2_0_data);
    counter2_2.i1_in_data.bind(wire_1_0_2_0_data);
    counter1_1.o1_out_valid.bind(wire_1_0_2_0_valid);
    counter2_2.i1_in_valid.bind(wire_1_0_2_0_valid);
    counter1_1.o1_out_ready.bind(wire_1_0_2_0_ready);
    ...
    wire_2_0_3_0_adaptor.clk(clk);
    wire_2_0_3_0_adaptor.migen_in.bind(wire_2_0_3_0_migen_out);
    wire_2_0_3_0_adaptor.migen_valid_in.bind(wire_2_0_3_0_out_valid);
    wire_2_0_3_0_adaptor.migen_ready_out.bind(wire_2_0_3_0_out_ready);
    wire_2_0_3_0_adaptor.py_out = &wire_2_0_3_0_py_in;
    counter2_2.o1_out_data.bind(wire_2_0_3_0_migen_out);
    counter2_2.o1_out_valid.bind(wire_2_0_3_0_out_valid);
    counter2_2.o1_out_ready.bind(wire_2_0_3_0_out_ready);
    print_then_exit_3.sysc_n = &wire_2_0_3_0_py_in;
    ...
    sc_trace(Tf, wire_1_0_2_0_data, "wire_1_0_2_0_data");
    sc_trace(Tf, wire_1_0_2_0_valid, "wire_1_0_2_0_valid");
    sc_trace(Tf, wire_1_0_2_0_ready, "wire_1_0_2_0_ready");
    ...
    wire_2_0_3_0_py_in.trace(Tf);
    sc_trace(Tf, wire_2_0_3_0_migen_out, "wire_2_0_3_0_migen_out");
    sc_trace(Tf, wire_2_0_3_0_out_valid, "wire_2_0_3_0_out_valid");
    sc_trace(Tf, wire_2_0_3_0_out_ready, "wire_2_0_3_0_out_ready");
