...
int sc_main(int argc, char* argv[]) {
    ...
    sc_trace_file *Tf = sc_create_vcd_trace_file("test_migen_wiring");
    Test_Migen_Wiring test_migen_wiring("test_migen_wiring", Tf);
    sc_clock clk("clk", sc_time(1, SC_NS)); sc_trace(Tf, clk, "clk");
    sc_signal<bool> rst; sc_trace(Tf, rst, "rst");
    rst.write(0);
    test_migen_wiring.clk.bind(clk);
    test_migen_wiring.rst.bind(rst);
