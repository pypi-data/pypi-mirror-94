...
package_data = \
{'': ['*'],
 'ovretl.shipment_orchestration_utils': ['.pytest_cache/*',
                                         '.pytest_cache/v/cache/*'],
 'ovretl.shipment_orchestration_utils.tests': ['.pytest_cache/*',
                                               '.pytest_cache/v/cache/*'],
 'ovretl.shipments_utils.tests': ['.pytest_cache/*', '.pytest_cache/v/cache/*'],
 'ovretl.tasks_utils.tests': ['.pytest_cache/*', '.pytest_cache/v/cache/*']}
