...
class DataBarAxisPosition(IntEnum):
    AUTOMATIC = 0,
    DATA_BAR_AXIS_AUTOMATIC = 0,
    DATA_BAR_AXIS_MIDPOINT = 1,
    DATA_BAR_AXIS_NONE = 2,
    MIDPOINT = 1,
    NONE = 2,
class DataBarBorderType(IntEnum):
    DATA_BAR_BORDER_NONE = 0,
    DATA_BAR_BORDER_SOLID = 1,
    NONE = 0,
    SOLID = 1,
class DataBarFillType(IntEnum):
    DATA_BAR_FILL_GRADIENT = 1,
    DATA_BAR_FILL_SOLID = 0,
    GRADIENT = 1,
    SOLID = 0,
class DataBarNegativeColorType(IntEnum):
    COLOR = 0,
    DATA_BAR_COLOR = 0,
    DATA_BAR_SAME_AS_POSITIVE = 1,
    SAME_AS_POSITIVE = 1,
...
from com.aspose.cells import CustomFilter
...
from com.aspose.cells import LocaleNumberFormatConstants
