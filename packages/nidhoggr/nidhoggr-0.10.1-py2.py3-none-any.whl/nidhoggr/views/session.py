...
from nidhoggr.core.texture import TextureType, TextureItem, TextureRequest
...
def profile(
    ...
    textures_result = handle_status(textures.get(request=request))
    ...
    texture_prop = TextureResponse(
        ...
        textures={
            ...
            for kind, url
            in textures_result.textures.items()
        }
    ).pack()
