...
class SetCellStep(object):
    ...
    my_description['description'] : tuple
        A description of the Set Cell step. It must be
    ...
    def description(self):
        ...
        """
        return SetCellStep.my_description
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return set_cell_step.SetCell(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyworded arguments
        ...
        return set_cell_step.TkSetCell(canvas=canvas, **kwargs)
