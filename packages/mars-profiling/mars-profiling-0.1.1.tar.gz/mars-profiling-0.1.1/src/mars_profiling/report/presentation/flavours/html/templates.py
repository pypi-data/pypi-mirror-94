...
from mars_profiling.report.formatters import get_fmt_mapping

# Initializing Jinja
# from mars_profiling.utils.paths import get_html_template_path

package_loader = jinja2.PackageLoader(
    "mars_profiling", "report/presentation/flavours/html/templates"
)
