...
from mars_profiling.report.presentation.core import Container, FrequencyTable, Table
from mars_profiling.report.presentation.frequency_table_utils import freq_table
from mars_profiling.report.structure.variables.render_categorical import (
    render_categorical,
)
