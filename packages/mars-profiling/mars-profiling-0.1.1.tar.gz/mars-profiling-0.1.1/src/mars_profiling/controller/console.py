...
from mars_profiling.__init__ import ProfileReport, __version__
from mars_profiling.config import config
from mars_profiling.utils.dataframe import read_pandas


def parse_args(args: Union[list, None] = None) -> argparse.Namespace:
    """Parse the command line arguments for the `mars_profiling` binary.
...
def main(args=None) -> None:
    """Run the `mars_profiling` package.
