...
class FixFontinfo(BaseFilter):
    ...
    def set_context(self, font: Font, glyphSet: Set[Glyph]):
        ...
        font.info.copyright = "Copyright {} Indian Type Foundry. All rights reserved.".format(release_year_range)
        if not font.info.openTypeNameDesignerURL:
            font.info.openTypeNameDesignerURL = "https://indiantypefoundry.com"
        font.info.openTypeNameManufacturer = 'Indian Type Foundry'
        font.info.openTypeNameManufacturerURL = 'https://indiantypefoundry.com'
        font.info.openTypeNameLicense = "This Font Software is protected under domestic and international trademark and copyright law. You agree to identify the ITF fonts by name and credit the ITF's ownership of the trademarks and copyrights in any design or production credits."
        font.info.openTypeNameLicenseURL = 'https://indiantypefoundry.com/licensing'
        font.info.openTypeOS2VendorID = 'ITFO'

        tm = font.info.familyName.split(" ")
        font.info.trademark = "{} is a trademark of the Indian Type Foundry.".format(tm[0])
