...
class loc_tab(wx.ScrolledWindow):
        def __init__(self, parent,main_frame):
            ...
            add_btn = wx.BitmapButton(self , 0,bitmap=wx.Bitmap(sys.exec_prefix,"Lib\site-packages\WaterOptim",os.path.join(self.main_frame.icons.add), wx.BITMAP_TYPE_ANY))
            rmv_btn = wx.BitmapButton(self , 1,bitmap=wx.Bitmap(sys.exec_prefix,"Lib\site-packages\WaterOptim",os.path.join(self.main_frame.icons.rmv), wx.BITMAP_TYPE_ANY))
            sizer = wx.BoxSizer(wx.VERTICAL)
            btn_sizer = wx.BoxSizer(wx.HORIZONTAL) 
            btn_sizer.Add(add_btn,) 
            btn_sizer.Add(rmv_btn,) 
