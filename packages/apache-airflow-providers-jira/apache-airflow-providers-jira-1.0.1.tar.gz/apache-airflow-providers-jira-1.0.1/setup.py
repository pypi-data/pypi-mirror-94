...
def do_setup():
    ...
    setup(
        ...
        description='Provider package ' 'apache-airflow-providers-jira for Apache Airflow',
        ...
        install_requires=['apache-airflow>=2.0.0', 'JIRA>1.0.7'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-jira/1.0.1/',
