...
# </editor-fold>
# <editor-fold desc="asdict, asdict_exclude, cli_version, dict_sort, pop_default & upper_prefix">
...
class Package(AsDictData):
    ...
    @staticmethod
    def get_version(p: str) -> Optional[str]:
        try:
...
package = Package(version=Package.get_version(Package.name))
