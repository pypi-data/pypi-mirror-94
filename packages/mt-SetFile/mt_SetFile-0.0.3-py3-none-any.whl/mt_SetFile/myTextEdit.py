...
#-- Upper Toolbar -- 
        ...
        newAction = QAction(QIcon("../res/new.png"),"New",self)
        newAction.setShortcut("Ctrl+N")
        newAction.setStatusTip("Create a new document from scratch.")
        newAction.triggered.connect(self.New)
 
        openAction = QAction(QIcon("../res/open.png"),"Open file",self)
        ...
        previewAction = QAction(QIcon("../res/preview.png"),"Page view",self)
        ...
        findAction = QAction(QIcon("../res/find.png"),"Find",self)
        findAction.setStatusTip("Find words in your document")
        findAction.setShortcut("Ctrl+F")
        findAction.triggered.connect(self.Find)
 
        cutAction = QAction(QIcon("../res/cut.png"),"Cut to clipboard",self)
        cutAction.setStatusTip("Delete and copy text to clipboard")
        cutAction.setShortcut("Ctrl+X")
        cutAction.triggered.connect(self.Cut)
 
        copyAction = QAction(QIcon("../res/copy.png"),"Copy to clipboard",self)
        copyAction.setStatusTip("Copy text to clipboard")
        copyAction.setShortcut("Ctrl+C")
        copyAction.triggered.connect(self.Copy)
 
        pasteAction = QAction(QIcon("../res/paste.png"),"Paste from clipboard",self)
        pasteAction.setStatusTip("Paste text from clipboard")
        pasteAction.setShortcut("Ctrl+V")
        pasteAction.triggered.connect(self.Paste)
 
        undoAction = QAction(QIcon("../res/undo.png"),"Undo last action",self)
        undoAction.setStatusTip("Undo last action")
        undoAction.setShortcut("Ctrl+Z")
        undoAction.triggered.connect(self.Undo)
 
        redoAction = QAction(QIcon("../res/redo.png"),"Redo last undone thing",self)
        ...
        printAction = QAction(QIcon("../res/print.png"),"Print document",self)
...
#-------- Toolbar slots -----------------------------------
    ...
    def OpenInitial(self, filename=None):
        f = open(filename, 'r')
        filedata = f.read()
        self.text.setText(filedata)
        f.close()
