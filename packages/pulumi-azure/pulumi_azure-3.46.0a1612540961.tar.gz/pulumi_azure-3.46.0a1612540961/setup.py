...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.46.0-alpha.1612540961+da9fe318'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.46.0-alpha.1612540961+da9fe318`
                """)
            else:
                raise
