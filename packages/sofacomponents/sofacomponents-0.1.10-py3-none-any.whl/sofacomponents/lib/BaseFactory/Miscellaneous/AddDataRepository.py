...
@sofa_component
def AddDataRepository(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, path=None, **kwargs):
    """
    Add a path to DataRepository


    :param name: object name  Default value: AddDataRepository
    ...
    return "AddDataRepository", params
