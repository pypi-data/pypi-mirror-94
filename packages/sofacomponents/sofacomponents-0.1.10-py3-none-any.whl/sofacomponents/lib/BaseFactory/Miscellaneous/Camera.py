...
@sofa_component
def Camera(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, position=None, orientation=None, lookAt=None, distance=None, fieldOfView=None, zNear=None, zFar=None, computeZClip=None, minBBox=None, maxBBox=None, widthViewport=None, heightViewport=None, projectionType=None, activated=None, fixedLookAt=None, modelViewMatrix=None, projectionMatrix=None, **kwargs):
    """
    A Camera that render the scene from a given location & orientation.


    :param name: object name  Default value: Camera
    ...
    :param computeZClip: Compute Z clip planes (Near and Far) according to the bounding box  Default value: 0
