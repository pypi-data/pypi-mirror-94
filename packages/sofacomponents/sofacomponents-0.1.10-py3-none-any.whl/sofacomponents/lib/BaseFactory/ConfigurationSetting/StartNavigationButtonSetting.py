...
@sofa_component
def StartNavigationButtonSetting(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, button=None, **kwargs):
    """
    Start Navigation Button configuration


    :param name: object name  Default value: StartNavigationButtonSetting
    ...
    return "StartNavigationButtonSetting", params
