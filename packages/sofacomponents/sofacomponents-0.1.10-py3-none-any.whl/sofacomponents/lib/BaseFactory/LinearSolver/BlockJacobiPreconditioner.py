...
@sofa_component
def BlockJacobiPreconditioner(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, verbose=None, **kwargs):
    """
    Linear solver based on a NxN bloc diagonal matrix (i.e. block Jacobi preconditioner)


    :param name: object name  Default value: BlockJacobiPreconditioner
    ...
    return "BlockJacobiPreconditioner", params
