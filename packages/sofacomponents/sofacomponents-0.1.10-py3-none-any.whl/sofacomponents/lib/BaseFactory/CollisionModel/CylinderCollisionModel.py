...
@sofa_component
def CylinderCollisionModel(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, active=None, moving=None, simulated=None, selfCollision=None, proximity=None, contactStiffness=None, contactFriction=None, contactRestitution=None, contactResponse=None, color=None, group=None, radii=None, heights=None, defaultRadius=None, defaultHeight=None, defaultLocalAxis=None, **kwargs):
    """
    Collision model which represents a set of rigid cylinders


    :param name: object name  Default value: CylinderCollisionModel
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.  Default value: 
    ...
    :param radii: Radius of each cylinder  Default value: []

    :param heights: The cylinder heights  Default value: []

    :param defaultRadius: The default radius  Default value: 0.5

    :param defaultHeight: The default height  Default value: 2.0

    :param defaultLocalAxis: The default local axis cylinder is modeled around  Default value: [[0.0, 1.0, 0.0]]


    """
    params = dict(name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, active=active, moving=moving, simulated=simulated, selfCollision=selfCollision, proximity=proximity, contactStiffness=contactStiffness, contactFriction=contactFriction, contactRestitution=contactRestitution, contactResponse=contactResponse, color=color, group=group, radii=radii, heights=heights, defaultRadius=defaultRadius, defaultHeight=defaultHeight, defaultLocalAxis=defaultLocalAxis)
    return "CylinderCollisionModel", params
