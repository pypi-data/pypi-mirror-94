...
@sofa_component
def TriangleOctreeModel(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, active=None, moving=None, simulated=None, selfCollision=None, proximity=None, contactStiffness=None, contactFriction=None, contactRestitution=None, contactResponse=None, color=None, group=None, bothSide=None, computeNormals=None, **kwargs):
    """
    collision model using a triangular mesh mapped to an Octree


    :param name: object name  Default value: TriangleOctreeModel
