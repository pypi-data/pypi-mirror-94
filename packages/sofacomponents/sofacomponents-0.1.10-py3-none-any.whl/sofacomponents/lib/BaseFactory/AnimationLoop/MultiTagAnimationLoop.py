...
@sofa_component
def MultiTagAnimationLoop(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, **kwargs):
    """
    Simple animation loop that given a list of tags, animate the graph one tag after another.


    :param name: object name  Default value: MultiTagAnimationLoop
