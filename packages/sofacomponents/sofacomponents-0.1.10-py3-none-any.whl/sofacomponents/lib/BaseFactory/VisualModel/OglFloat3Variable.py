...
@sofa_component
def OglFloat3Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglFloat3Variable


    :param name: object name  Default value: OglFloat3Variable
    ...
    :param value: Set Uniform Value  Default value: [[0.0, 0.0, 0.0]]
    ...
    return "OglFloat3Variable", params
