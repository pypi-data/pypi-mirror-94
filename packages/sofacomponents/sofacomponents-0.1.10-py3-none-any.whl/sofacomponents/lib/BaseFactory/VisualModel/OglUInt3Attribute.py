...
@sofa_component
def OglUInt3Attribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglUInt3Attribute


    :param name: object name  Default value: OglUInt3Attribute
    ...
    return "OglUInt3Attribute", params
