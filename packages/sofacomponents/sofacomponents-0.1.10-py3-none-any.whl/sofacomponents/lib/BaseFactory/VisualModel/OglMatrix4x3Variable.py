...
@sofa_component
def OglMatrix4x3Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, transpose=None, **kwargs):
    """
    OglMatrix4x3Variable


    :param name: object name  Default value: OglMatrix4x3Variable
    ...
    return "OglMatrix4x3Variable", params
