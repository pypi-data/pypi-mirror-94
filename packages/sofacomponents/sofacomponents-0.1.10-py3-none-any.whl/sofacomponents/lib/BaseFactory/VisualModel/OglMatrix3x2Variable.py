...
@sofa_component
def OglMatrix3x2Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, transpose=None, **kwargs):
    """
    OglMatrix3x2Variable


    :param name: object name  Default value: OglMatrix3x2Variable
    ...
    return "OglMatrix3x2Variable", params
