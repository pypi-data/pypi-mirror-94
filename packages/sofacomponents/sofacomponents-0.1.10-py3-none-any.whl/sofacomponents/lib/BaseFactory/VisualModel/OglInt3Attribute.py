...
@sofa_component
def OglInt3Attribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglInt3Attribute


    :param name: object name  Default value: OglInt3Attribute
    ...
    return "OglInt3Attribute", params
