...
@sofa_component
def OglInt4Attribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglInt4Attribute


    :param name: object name  Default value: OglInt4Attribute
    ...
    return "OglInt4Attribute", params
