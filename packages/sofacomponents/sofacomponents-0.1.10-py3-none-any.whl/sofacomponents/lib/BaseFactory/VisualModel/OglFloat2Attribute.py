...
@sofa_component
def OglFloat2Attribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglFloat2Attribute


    :param name: object name  Default value: OglFloat2Attribute
    ...
    return "OglFloat2Attribute", params
