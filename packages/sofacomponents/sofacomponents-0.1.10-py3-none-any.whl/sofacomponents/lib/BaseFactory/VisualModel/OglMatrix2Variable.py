...
@sofa_component
def OglMatrix2Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, transpose=None, **kwargs):
    """
    OglMatrix2Variable


    :param name: object name  Default value: OglMatrix2Variable
    ...
    return "OglMatrix2Variable", params
