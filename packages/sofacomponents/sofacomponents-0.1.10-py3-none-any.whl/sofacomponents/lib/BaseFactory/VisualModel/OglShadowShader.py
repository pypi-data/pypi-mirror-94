...
def OglShadowShader(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, turnOn=None, passive=None, fileVertexShaders=None, fileFragmentShaders=None, fileGeometryShaders=None, fileTessellationControlShaders=None, fileTessellationEvaluationShaders=None, geometryInputType=None, geometryOutputType=None, geometryVerticesOut=None, tessellationOuterLevel=None, tessellationInnerLevel=None, indexActiveShader=None, backfaceWriting=None, clampVertexColor=None, **kwargs):
    ...
    :param fileVertexShaders: Set the vertex shader filename to load  Default value: [ 'shaders/hardShadows/shadowMapping.vert' , 'shaders/hardShadows/shadowMapping.vert' ]

    :param fileFragmentShaders: Set the fragment shader filename to load  Default value: [ 'shaders/hardShadows/shadowMapping.frag' , 'shaders/hardShadows/shadowMapping.frag' ]
