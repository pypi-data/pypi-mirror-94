...
@sofa_component
def OglFloat4Attribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglFloat4Attribute


    :param name: object name  Default value: OglFloat4Attribute
    ...
    return "OglFloat4Attribute", params
