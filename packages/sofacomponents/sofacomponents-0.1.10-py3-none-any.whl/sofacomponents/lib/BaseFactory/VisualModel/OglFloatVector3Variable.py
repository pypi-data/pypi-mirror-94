...
@sofa_component
def OglFloatVector3Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglFloatVector3Variable


    :param name: object name  Default value: OglFloatVector3Variable
    ...
    return "OglFloatVector3Variable", params
