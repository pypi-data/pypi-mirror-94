...
@sofa_component
def PositionalLight(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, color=None, shadowTextureSize=None, drawSource=None, zNear=None, zFar=None, shadowsEnabled=None, softShadows=None, shadowFactor=None, VSMLightBleeding=None, VSMMinVariance=None, textureUnit=None, modelViewMatrix=None, projectionMatrix=None, fixed=None, position=None, attenuation=None, **kwargs):
    """
    ...
    :param name: object name  Default value: PositionalLight
    ...
    """
    params = dict(name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, color=color, shadowTextureSize=shadowTextureSize, drawSource=drawSource, zNear=zNear, zFar=zFar, shadowsEnabled=shadowsEnabled, softShadows=softShadows, shadowFactor=shadowFactor, VSMLightBleeding=VSMLightBleeding, VSMMinVariance=VSMMinVariance, textureUnit=textureUnit, modelViewMatrix=modelViewMatrix, projectionMatrix=projectionMatrix, fixed=fixed, position=position, attenuation=attenuation)
    return "PositionalLight", params
