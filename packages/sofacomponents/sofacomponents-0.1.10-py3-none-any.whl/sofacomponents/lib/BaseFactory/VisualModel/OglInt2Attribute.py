...
@sofa_component
def OglInt2Attribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglInt2Attribute


    :param name: object name  Default value: OglInt2Attribute
    ...
    return "OglInt2Attribute", params
