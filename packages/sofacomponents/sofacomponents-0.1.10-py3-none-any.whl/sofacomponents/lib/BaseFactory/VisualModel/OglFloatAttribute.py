...
@sofa_component
def OglFloatAttribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglFloatAttribute


    :param name: object name  Default value: OglFloatAttribute
    ...
    return "OglFloatAttribute", params
