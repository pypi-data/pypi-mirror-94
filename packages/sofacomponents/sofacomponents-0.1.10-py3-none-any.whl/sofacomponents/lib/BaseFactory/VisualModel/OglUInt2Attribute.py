...
@sofa_component
def OglUInt2Attribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglUInt2Attribute


    :param name: object name  Default value: OglUInt2Attribute
    ...
    return "OglUInt2Attribute", params
