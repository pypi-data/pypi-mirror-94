...
@sofa_component
def OglFloat3Attribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglFloat3Attribute


    :param name: object name  Default value: OglFloat3Attribute
    ...
    return "OglFloat3Attribute", params
