...
@sofa_component
def OglUIntAttribute(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, handleDynamicTopology=None, **kwargs):
    """
    OglUIntAttribute


    :param name: object name  Default value: OglUIntAttribute
    ...
    return "OglUIntAttribute", params
