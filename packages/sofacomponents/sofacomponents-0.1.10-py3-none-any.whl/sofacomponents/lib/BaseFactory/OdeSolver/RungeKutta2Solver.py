...
@sofa_component
def RungeKutta2Solver(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, **kwargs):
    """
    A popular explicit time integrator


    :param name: object name  Default value: RungeKutta2Solver
