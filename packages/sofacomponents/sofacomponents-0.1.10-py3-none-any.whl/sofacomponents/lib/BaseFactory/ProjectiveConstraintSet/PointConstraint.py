...
@sofa_component
def PointConstraint(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, group=None, endTime=None, indices=None, drawSize=None, **kwargs):
    """
    Attach given particles to their initial positions


    :param name: object name  Default value: PointConstraint
...
Use a negative value for infinite constraints  Default value: -1.0
    ...
    """
    params = dict(name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, group=group, endTime=endTime, indices=indices, drawSize=drawSize)
