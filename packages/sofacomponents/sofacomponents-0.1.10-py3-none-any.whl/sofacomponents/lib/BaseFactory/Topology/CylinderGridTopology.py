...
@sofa_component
def CylinderGridTopology(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, filename=None, position=None, edges=None, triangles=None, quads=None, tetrahedra=None, hexahedra=None, uv=None, drawEdges=None, drawTriangles=None, drawQuads=None, drawTetrahedra=None, drawHexahedra=None, n=None, computeHexaList=None, computeQuadList=None, computeTriangleList=None, computeEdgeList=None, computePointList=None, createTexCoords=None, center=None, axis=None, radius=None, length=None, **kwargs):
    """
    Cylinder grid in 3D


    :param name: object name  Default value: CylinderGridTopology
    ...
    :param center: Center of the cylinder  Default value: [[0.0, 0.0, 0.0]]

    :param axis: Main direction of the cylinder  Default value: [[0.0, 0.0, 1.0]]

    :param radius: Radius of the cylinder  Default value: 1.0

    :param length: Length of the cylinder along its axis  Default value: 1.0
