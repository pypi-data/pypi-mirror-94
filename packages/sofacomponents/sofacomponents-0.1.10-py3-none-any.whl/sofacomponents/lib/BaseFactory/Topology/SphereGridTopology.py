...
@sofa_component
def SphereGridTopology(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, filename=None, position=None, edges=None, triangles=None, quads=None, tetrahedra=None, hexahedra=None, uv=None, drawEdges=None, drawTriangles=None, drawQuads=None, drawTetrahedra=None, drawHexahedra=None, n=None, computeHexaList=None, computeQuadList=None, computeTriangleList=None, computeEdgeList=None, computePointList=None, createTexCoords=None, center=None, axis=None, radius=None, **kwargs):
    """
    Sphere grid in 3D


    :param name: object name  Default value: SphereGridTopology
