...
@sofa_component
def RegularGridTopology(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, filename=None, position=None, edges=None, triangles=None, quads=None, tetrahedra=None, hexahedra=None, uv=None, drawEdges=None, drawTriangles=None, drawQuads=None, drawTetrahedra=None, drawHexahedra=None, n=None, computeHexaList=None, computeQuadList=None, computeTriangleList=None, computeEdgeList=None, computePointList=None, createTexCoords=None, min=None, max=None, p0=None, cellWidth=None, **kwargs):
    """
    Regular grid in 3D


    :param name: object name  Default value: RegularGridTopology
    ...
    :param min: Min end of the diagonal  Default value: [[0.0, 0.0, 0.0]]

    :param max: Max end of the diagonal  Default value: [[1.0, 1.0, 1.0]]

    :param p0: Offset all the grid points  Default value: [[0.0, 0.0, 0.0]]

    :param cellWidth: if > 0 : dimension of each cell in the created grid. Otherwise, the cell size is computed based on min, max, and resolution n.  Default value: 0.0
