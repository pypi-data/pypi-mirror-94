...
@sofa_component
def SparseGridMultipleTopology(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, filename=None, position=None, edges=None, triangles=None, quads=None, tetrahedra=None, hexahedra=None, uv=None, drawEdges=None, drawTriangles=None, drawQuads=None, drawTetrahedra=None, drawHexahedra=None, fillWeighted=None, onlyInsideCells=None, n=None, min=None, max=None, cellWidth=None, nbVirtualFinerLevels=None, dataResolution=None, voxelSize=None, marchingCubeStep=None, convolutionSize=None, facets=None, finestConnectivity=None, fileTopologies=None, stiffnessCoefs=None, massCoefs=None, computeRamifications=None, erasePreviousCoef=None, **kwargs):
    """
    Sparse grid in 3D


    :param name: object name  Default value: SparseGridMultipleTopology
    ...
    :param fileTopologies: All topology filenames  Default value: []

    :param stiffnessCoefs: A stiffness coefficient for each topology filename  Default value: []

    :param massCoefs: A mass coefficient for each topology filename  Default value: []

    :param computeRamifications: Are ramifications wanted?  Default value: 1

    :param erasePreviousCoef: Does a new stiffness/mass coefficient replace the previous or blend half/half with it?  Default value: 0


    """
    params = dict(name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, filename=filename, position=position, edges=edges, triangles=triangles, quads=quads, tetrahedra=tetrahedra, hexahedra=hexahedra, uv=uv, drawEdges=drawEdges, drawTriangles=drawTriangles, drawQuads=drawQuads, drawTetrahedra=drawTetrahedra, drawHexahedra=drawHexahedra, fillWeighted=fillWeighted, onlyInsideCells=onlyInsideCells, n=n, min=min, max=max, cellWidth=cellWidth, nbVirtualFinerLevels=nbVirtualFinerLevels, dataResolution=dataResolution, voxelSize=voxelSize, marchingCubeStep=marchingCubeStep, convolutionSize=convolutionSize, facets=facets, finestConnectivity=finestConnectivity, fileTopologies=fileTopologies, stiffnessCoefs=stiffnessCoefs, massCoefs=massCoefs, computeRamifications=computeRamifications, erasePreviousCoef=erasePreviousCoef)
    return "SparseGridMultipleTopology", params
