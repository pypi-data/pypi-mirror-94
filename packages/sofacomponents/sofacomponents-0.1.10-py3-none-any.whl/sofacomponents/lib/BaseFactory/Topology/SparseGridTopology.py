...
@sofa_component
def SparseGridTopology(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, filename=None, position=None, edges=None, triangles=None, quads=None, tetrahedra=None, hexahedra=None, uv=None, drawEdges=None, drawTriangles=None, drawQuads=None, drawTetrahedra=None, drawHexahedra=None, fillWeighted=None, onlyInsideCells=None, n=None, min=None, max=None, cellWidth=None, nbVirtualFinerLevels=None, dataResolution=None, voxelSize=None, marchingCubeStep=None, convolutionSize=None, facets=None, **kwargs):
    """
    Sparse grid in 3D


    :param name: object name  Default value: SparseGridTopology
