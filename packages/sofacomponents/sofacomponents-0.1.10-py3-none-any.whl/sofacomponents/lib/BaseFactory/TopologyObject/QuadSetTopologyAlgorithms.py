...
@sofa_component
def QuadSetTopologyAlgorithms(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, **kwargs):
    """
    Quad set topology algorithms


    :param name: object name  Default value: QuadSetTopologyAlgorithms
