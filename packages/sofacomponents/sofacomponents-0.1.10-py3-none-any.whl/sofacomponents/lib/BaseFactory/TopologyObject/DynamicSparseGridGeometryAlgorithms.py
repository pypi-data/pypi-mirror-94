...
@sofa_component
def DynamicSparseGridGeometryAlgorithms(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, showIndicesScale=None, showPointIndices=None, tagMechanics=None, showEdgeIndices=None, drawEdges=None, drawColorEdges=None, showQuadIndices=None, drawQuads=None, drawColorQuads=None, showHexaIndices=None, drawHexahedra=None, drawScaleHexahedra=None, drawColorHexahedra=None, **kwargs):
    """
    Hexahedron set geometry algorithms


    :param name: object name  Default value: DynamicSparseGridGeometryAlgorithms
    ...
    return "DynamicSparseGridGeometryAlgorithms", params
