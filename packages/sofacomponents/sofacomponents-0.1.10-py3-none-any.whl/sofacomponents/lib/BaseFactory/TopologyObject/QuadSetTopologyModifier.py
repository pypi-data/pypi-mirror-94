...
@sofa_component
def QuadSetTopologyModifier(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, propagateToDOF=None, **kwargs):
    """
    Quad set topology modifier


    :param name: object name  Default value: QuadSetTopologyModifier
