...
@sofa_component
def DynamicSparseGridTopologyModifier(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, propagateToDOF=None, removeIsolated=None, **kwargs):
    """
    Hexahedron set topology modifier


    :param name: object name  Default value: DynamicSparseGridTopologyModifier
    ...
    return "DynamicSparseGridTopologyModifier", params
