...
@sofa_component
def PointSetTopologyModifier(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, propagateToDOF=None, **kwargs):
    """
    Point set topology modifier


    :param name: object name  Default value: PointSetTopologyModifier
