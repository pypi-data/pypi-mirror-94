...
@sofa_component
def HexahedronSetTopologyAlgorithms(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, **kwargs):
    """
    Hexahedron set topology algorithms


    :param name: object name  Default value: HexahedronSetTopologyAlgorithms
