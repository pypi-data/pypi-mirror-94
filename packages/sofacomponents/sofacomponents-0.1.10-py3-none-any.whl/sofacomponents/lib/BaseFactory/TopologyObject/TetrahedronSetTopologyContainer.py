...
@sofa_component
def TetrahedronSetTopologyContainer(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, filename=None, position=None, checkTopology=None, nbPoints=None, points=None, edges=None, checkConnexity=None, triangles=None, createTriangleArray=None, tetrahedra=None, **kwargs):
    """
    Tetrahedron set topology container


    :param name: object name  Default value: TetrahedronSetTopologyContainer
    ...
    :param createTriangleArray: Force the creation of a set of triangles associated with each tetrahedron  Default value: 0

    :param tetrahedra: List of tetrahedron indices  Default value: []


    """
    params = dict(name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, filename=filename, position=position, checkTopology=checkTopology, nbPoints=nbPoints, points=points, edges=edges, checkConnexity=checkConnexity, triangles=triangles, createTriangleArray=createTriangleArray, tetrahedra=tetrahedra)
