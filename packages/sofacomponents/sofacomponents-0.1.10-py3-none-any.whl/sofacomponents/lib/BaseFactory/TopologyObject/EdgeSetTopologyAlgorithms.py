...
@sofa_component
def EdgeSetTopologyAlgorithms(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, **kwargs):
    """
    Edge set topology algorithms


    :param name: object name  Default value: EdgeSetTopologyAlgorithms
