...
@sofa_component
def QuadularBendingSprings(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, isCompliance=None, rayleighStiffness=None, stiffness=None, damping=None, edgeInfo=None, **kwargs):
    """
    Springs added to a quad mesh to prevent bending


    :param name: object name  Default value: QuadularBendingSprings
