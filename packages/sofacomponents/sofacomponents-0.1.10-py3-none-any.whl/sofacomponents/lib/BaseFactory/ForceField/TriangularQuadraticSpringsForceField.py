...
@sofa_component
def TriangularQuadraticSpringsForceField(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, isCompliance=None, rayleighStiffness=None, initialPoints=None, poissonRatio=None, youngModulus=None, dampingRatio=None, useAngularSprings=None, triangleInfo=None, edgeInfo=None, **kwargs):
    """
    Quadratic Springs on a Triangular Mesh


    :param name: object name  Default value: TriangularQuadraticSpringsForceField
