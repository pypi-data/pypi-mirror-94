...
@sofa_component
def NullForceFeedback(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, activate=None, indice=None, **kwargs):
    """
    Null force feedback for haptic feedback device


    :param name: object name  Default value: NullForceFeedback
