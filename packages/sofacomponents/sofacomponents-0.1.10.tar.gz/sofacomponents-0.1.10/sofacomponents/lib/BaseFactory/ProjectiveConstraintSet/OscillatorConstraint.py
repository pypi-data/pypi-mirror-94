...
@sofa_component
def OscillatorConstraint(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, group=None, endTime=None, oscillators=None, **kwargs):
    """
    Apply a sinusoidal trajectory to given points


    :param name: object name  Default value: OscillatorConstraint
...
[index, Mean(x,y,z), amplitude(x,y,z), pulsation, phase]  Default value: 


    """
    params = dict(name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, group=group, endTime=endTime, oscillators=oscillators)
