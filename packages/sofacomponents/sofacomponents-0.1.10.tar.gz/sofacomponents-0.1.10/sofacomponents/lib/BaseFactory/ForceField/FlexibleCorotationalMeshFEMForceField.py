...
"""
Component FlexibleCorotationalMeshFEMForceField

.. autofunction:: FlexibleCorotationalMeshFEMForceField
...
@sofa_component
def FlexibleCorotationalMeshFEMForceField(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, isCompliance=None, rayleighStiffness=None, nbRef=None, position=None, tolerance=None, method=None, order=None, youngModulus=None, poissonRatio=None, viscosity=None, geometricStiffness=None, **kwargs):
    """
    Flexible Tetrahedral finite elements


    :param name: object name  Default value: FlexibleCorotationalMeshFEMForceField
