...
@sofa_component
def TriangularAnisotropicFEMForceField(self, poissonRatio=None, youngModulus=None, transverseYoungModulus=None, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, isCompliance=None, rayleighStiffness=None, triangleInfo=None, vertexInfo=None, edgeInfo=None, method=None, damping=None, rotatedInitialElements=None, initialTransformation=None, fracturable=None, hosfordExponant=None, criteriaValue=None, showStressValue=None, showStressVector=None, showFracturableTriangles=None, computePrincipalStress=None, fiberAngle=None, fiberCenter=None, showFiber=None, localFiberDirection=None, **kwargs):
    """
    Triangular finite element model using anisotropic material


    :param name: object name  Default value: TriangularAnisotropicFEMForceField
    ...
    :param transverseYoungModulus: transverseYoungModulus  Default value: [[1000.0]]

    :param fiberAngle: Fiber angle in global reference frame (in degrees)  Default value: 0.0

    :param fiberCenter: Concentric fiber center in global reference frame  Default value: []

    :param showFiber: Flag activating rendering of fiber directions within each triangle  Default value: 1

    :param localFiberDirection: Computed fibers direction within each triangle  Default value: []


    """
    params = dict(name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, isCompliance=isCompliance, rayleighStiffness=rayleighStiffness, triangleInfo=triangleInfo, vertexInfo=vertexInfo, edgeInfo=edgeInfo, method=method, poissonRatio=poissonRatio, youngModulus=youngModulus, damping=damping, rotatedInitialElements=rotatedInitialElements, initialTransformation=initialTransformation, fracturable=fracturable, hosfordExponant=hosfordExponant, criteriaValue=criteriaValue, showStressValue=showStressValue, showStressVector=showStressVector, showFracturableTriangles=showFracturableTriangles, computePrincipalStress=computePrincipalStress, transverseYoungModulus=transverseYoungModulus, fiberAngle=fiberAngle, fiberCenter=fiberCenter, showFiber=showFiber, localFiberDirection=localFiberDirection)
