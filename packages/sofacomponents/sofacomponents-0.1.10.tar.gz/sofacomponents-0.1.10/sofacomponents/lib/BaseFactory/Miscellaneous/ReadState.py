...
@sofa_component
def ReadState(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, filename=None, interval=None, shift=None, loop=None, scalePos=None, **kwargs):
    """
    Read State vectors from file at each timestep


    :param name: object name  Default value: ReadState
