...
@sofa_component
def PauseAnimationOnEvent(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, **kwargs):
    """
    PauseAnimationOnEvent


    :param name: object name  Default value: PauseAnimationOnEvent
