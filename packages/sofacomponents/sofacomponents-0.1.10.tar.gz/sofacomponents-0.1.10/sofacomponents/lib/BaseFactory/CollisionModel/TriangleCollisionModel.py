...
@sofa_component
def TriangleCollisionModel(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, active=None, moving=None, simulated=None, selfCollision=None, proximity=None, contactStiffness=None, contactFriction=None, contactRestitution=None, contactResponse=None, color=None, group=None, bothSide=None, computeNormals=None, **kwargs):
    """
    collision model using a triangular mesh, as described in BaseMeshTopology


    :param name: object name  Default value: TriangleCollisionModel
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.  Default value: 
    ...
    :param bothSide: activate collision on both side of the triangle model  Default value: 0

    :param computeNormals: set to false to disable computation of triangles normal  Default value: 1
    ...
    return "TriangleCollisionModel", params
