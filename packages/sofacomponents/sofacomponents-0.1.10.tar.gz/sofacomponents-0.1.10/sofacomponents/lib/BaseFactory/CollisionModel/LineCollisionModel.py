...
@sofa_component
def LineCollisionModel(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, active=None, moving=None, simulated=None, selfCollision=None, proximity=None, contactStiffness=None, contactFriction=None, contactRestitution=None, contactResponse=None, color=None, group=None, bothSide=None, displayFreePosition=None, **kwargs):
    """
    collision model using a linear mesh, as described in MeshTopology


    :param name: object name  Default value: LineCollisionModel
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.  Default value: 
    ...
    :param bothSide: activate collision on both side of the line model (when surface normals are defined on these lines)  Default value: 0
    ...
    return "LineCollisionModel", params
