...
@sofa_component
def SphereCollisionModel(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, active=None, moving=None, simulated=None, selfCollision=None, proximity=None, contactStiffness=None, contactFriction=None, contactRestitution=None, contactResponse=None, color=None, group=None, listRadius=None, radius=None, showImpostors=None, **kwargs):
    """
    Collision model which represents a set of Spheres


    :param name: object name  Default value: SphereCollisionModel
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.  Default value: 
    ...
    :param radius: Default Radius. (default=1.0)  Default value: 1.0

    :param showImpostors: Draw spheres as impostors instead of "real" spheres  Default value: 1
    ...
    return "SphereCollisionModel", params
