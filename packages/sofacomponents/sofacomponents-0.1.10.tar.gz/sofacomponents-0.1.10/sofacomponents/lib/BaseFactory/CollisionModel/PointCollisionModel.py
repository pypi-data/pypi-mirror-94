...
@sofa_component
def PointCollisionModel(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, active=None, moving=None, simulated=None, selfCollision=None, proximity=None, contactStiffness=None, contactFriction=None, contactRestitution=None, contactResponse=None, color=None, group=None, bothSide=None, computeNormals=None, displayFreePosition=None, **kwargs):
    """
    Collision model which represents a set of points


    :param name: object name  Default value: PointCollisionModel
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.  Default value: 
    ...
    :param bothSide: activate collision on both side of the point model (when surface normals are defined on these points)  Default value: 0

    :param computeNormals: activate computation of normal vectors (required for some collision detection algorithms)  Default value: 0

    :param displayFreePosition: Display Collision Model Points free position(in green)  Default value: 0
    ...
    return "PointCollisionModel", params
