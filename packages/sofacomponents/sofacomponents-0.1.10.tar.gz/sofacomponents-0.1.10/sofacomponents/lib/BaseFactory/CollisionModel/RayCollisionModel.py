...
@sofa_component
def RayCollisionModel(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, active=None, moving=None, simulated=None, selfCollision=None, proximity=None, contactStiffness=None, contactFriction=None, contactRestitution=None, contactResponse=None, color=None, group=None, **kwargs):
    """
    Collision model representing a ray in space, e.g. a mouse click


    :param name: object name  Default value: RayCollisionModel
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.  Default value: ray
    ...
    return "RayCollisionModel", params
