...
@sofa_component
def MultilevelHexahedronSetTopologyContainer(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, filename=None, position=None, checkTopology=None, nbPoints=None, points=None, edges=None, checkConnexity=None, quads=None, createQuadArray=None, hexahedra=None, level=None, resolution=None, idxInRegularGrid=None, coarseComponents=None, fineComponents=None, **kwargs):
    """
    Hexahedron set topology container


    :param name: object name  Default value: MultilevelHexahedronSetTopologyContainer
