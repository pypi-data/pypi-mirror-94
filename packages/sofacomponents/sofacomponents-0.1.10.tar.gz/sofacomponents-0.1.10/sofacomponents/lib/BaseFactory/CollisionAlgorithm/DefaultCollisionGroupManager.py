...
@sofa_component
def DefaultCollisionGroupManager(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, **kwargs):
    """
    Responsible for gathering colliding objects in the same group, for consistent time integration


    :param name: object name  Default value: DefaultCollisionGroupManager
    ...
    return "DefaultCollisionGroupManager", params
