...
@sofa_component
def LMDNewProximityIntersection(self, alarmDistance=None, contactDistance=None, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, useLineLine=None, **kwargs):
    """
    Filtered optimized proximity intersection.


    :param name: object name  Default value: LMDNewProximityIntersection
    ...
    :param useLineLine: Line-line collision detection enabled  Default value: 1
