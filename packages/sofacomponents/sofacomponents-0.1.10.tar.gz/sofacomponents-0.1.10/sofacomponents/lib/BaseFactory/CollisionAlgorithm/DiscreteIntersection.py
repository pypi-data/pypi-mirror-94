...
@sofa_component
def DiscreteIntersection(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, **kwargs):
    """
    TODO-DiscreteIntersectionClass


    :param name: object name  Default value: DiscreteIntersection
