...
@sofa_component
def OglIntVector3Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglIntVector3Variable


    :param name: object name  Default value: OglIntVector3Variable
    ...
    return "OglIntVector3Variable", params
