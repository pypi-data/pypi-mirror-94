...
@sofa_component
def OglMatrix2x4Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, transpose=None, **kwargs):
    """
    OglMatrix2x4Variable


    :param name: object name  Default value: OglMatrix2x4Variable
    ...
    return "OglMatrix2x4Variable", params
