...
@sofa_component
def OglMatrix3Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, transpose=None, **kwargs):
    """
    OglMatrix3Variable


    :param name: object name  Default value: OglMatrix3Variable
    ...
    return "OglMatrix3Variable", params
