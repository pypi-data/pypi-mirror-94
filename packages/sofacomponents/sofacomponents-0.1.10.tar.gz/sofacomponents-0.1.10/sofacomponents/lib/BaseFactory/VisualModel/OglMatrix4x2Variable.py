...
@sofa_component
def OglMatrix4x2Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, transpose=None, **kwargs):
    """
    OglMatrix4x2Variable


    :param name: object name  Default value: OglMatrix4x2Variable
    ...
    return "OglMatrix4x2Variable", params
