...
@sofa_component
def OglIntVector2Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglIntVector2Variable


    :param name: object name  Default value: OglIntVector2Variable
    ...
    return "OglIntVector2Variable", params
