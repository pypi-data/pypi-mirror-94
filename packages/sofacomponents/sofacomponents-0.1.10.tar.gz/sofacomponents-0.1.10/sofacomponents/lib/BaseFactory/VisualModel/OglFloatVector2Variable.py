...
@sofa_component
def OglFloatVector2Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglFloatVector2Variable


    :param name: object name  Default value: OglFloatVector2Variable
    ...
    return "OglFloatVector2Variable", params
