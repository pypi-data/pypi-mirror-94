...
@sofa_component
def OglInt2Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglInt2Variable


    :param name: object name  Default value: OglInt2Variable
