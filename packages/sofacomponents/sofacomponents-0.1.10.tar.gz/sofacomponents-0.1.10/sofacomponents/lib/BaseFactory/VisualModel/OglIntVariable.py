...
@sofa_component
def OglIntVariable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglIntVariable


    :param name: object name  Default value: OglIntVariable
    ...
    :param value: Set Uniform Value  Default value: 0
