...
@sofa_component
def OglFloatVariable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglFloatVariable


    :param name: object name  Default value: OglFloatVariable
    ...
    :param value: Set Uniform Value  Default value: 0.0
    ...
    return "OglFloatVariable", params
