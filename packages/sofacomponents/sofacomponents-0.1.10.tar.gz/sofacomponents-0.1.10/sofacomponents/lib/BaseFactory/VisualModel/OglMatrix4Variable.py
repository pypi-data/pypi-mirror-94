...
@sofa_component
def OglMatrix4Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, transpose=None, **kwargs):
    """
    OglMatrix4Variable


    :param name: object name  Default value: OglMatrix4Variable
    ...
    return "OglMatrix4Variable", params
