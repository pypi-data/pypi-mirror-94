...
@sofa_component
def OglFloat2Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglFloat2Variable


    :param name: object name  Default value: OglFloat2Variable
    ...
    :param value: Set Uniform Value  Default value: [[0.0, 0.0]]
    ...
    return "OglFloat2Variable", params
