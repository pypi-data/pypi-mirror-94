...
@sofa_component
def OglFloatVectorVariable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglFloatVectorVariable


    :param name: object name  Default value: OglFloatVectorVariable
    ...
    return "OglFloatVectorVariable", params
