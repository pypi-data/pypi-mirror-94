...
@sofa_component
def OglIntVector4Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglIntVector4Variable


    :param name: object name  Default value: OglIntVector4Variable
    ...
    return "OglIntVector4Variable", params
