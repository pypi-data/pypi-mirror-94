...
@sofa_component
def MergeVisualModels(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, position=None, restPosition=None, normal=None, initRestPositions=None, useNormals=None, updateNormals=None, computeTangents=None, updateTangents=None, handleDynamicTopology=None, fixMergedUVSeams=None, keepLines=None, vertices=None, texcoords=None, tangents=None, bitangents=None, edges=None, triangles=None, quads=None, vertPosIdx=None, vertNormIdx=None, filename=None, texturename=None, translation=None, rotation=None, scale3d=None, scaleTex=None, translationTex=None, material=None, putOnlyTexCoords=None, srgbTexturing=None, materials=None, groups=None, blendTranslucency=None, premultipliedAlpha=None, writeZTransparent=None, alphaBlend=None, depthTest=None, cullFace=None, lineWidth=None, pointSize=None, lineSmooth=None, pointSmooth=None, isEnabled=None, primitiveType=None, blendEquation=None, sfactor=None, dfactor=None, nb=None, **kwargs):
    """
    Merge several visual models


    :param name: object name  Default value: MergeVisualModels
