...
@sofa_component
def OglFloatVector4Variable(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, id=None, indexShader=None, value=None, **kwargs):
    """
    OglFloatVector4Variable


    :param name: object name  Default value: OglFloatVector4Variable
    ...
    return "OglFloatVector4Variable", params
