...
@sofa_component
def CholeskySolver(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, verbose=None, **kwargs):
    """
...
Direct linear solver based on Cholesky factorization, for dense matrices
    ...
    :param name: object name  Default value: CholeskySolver
