...
@sofa_component
def SparseCholeskySolver(self, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, verbose=None, **kwargs):
    """
    Direct linear solver based on Sparse Cholesky factorization, implemented with the CSPARSE library


    :param name: object name  Default value: SparseCholeskySolver
    ...
    return "SparseCholeskySolver", params
