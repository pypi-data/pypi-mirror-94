...
@sofa_component
def LMConstraintDirectSolver(self, numIterations=None, maxError=None, name=None, printLog=None, tags=None, bbox=None, componentState=None, listening=None, constraintAcc=None, constraintVel=None, constraintPos=None, graphGSError=None, traceKineticEnergy=None, graphKineticEnergy=None, solverAlgorithm=None, **kwargs):
    """
    A Direct Constraint Solver working specifically with LMConstraint based components


    :param name: object name  Default value: LMConstraintDirectSolver
    ...
    :param solverAlgorithm: Algorithm used to solve the system W.Lambda=c  Default value: SVD


    """
    params = dict(name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, constraintAcc=constraintAcc, constraintVel=constraintVel, constraintPos=constraintPos, numIterations=numIterations, maxError=maxError, graphGSError=graphGSError, traceKineticEnergy=traceKineticEnergy, graphKineticEnergy=graphKineticEnergy, solverAlgorithm=solverAlgorithm)
