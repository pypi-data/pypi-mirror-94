...
def write_latex(
    ...
    *,
    ...
    with open(outfile, "w") as handle, open(curr_path + "/latex/template.tex", "r") as template:
        with open(curr_path + "/latex/" + scheme + ".tex", "r") as colors:
            color_definitions = colors.read()

        line = template.readline()
        while line:
            if line == "((colors))\n":
                handle.write(color_definitions)
            else:
                handle.write(line)
            line = template.readline()
