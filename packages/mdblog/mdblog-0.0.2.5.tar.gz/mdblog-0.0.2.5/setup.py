...
setuptools.setup(
    executable=True,
    name="mdblog",  # Replace with your own username
    version=version,
    author="Wang Pei",
    author_email="1535376447@qq.com",
    description="markdown blog server",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="http://github.com/Peiiii/blog.md",
    packages=packages,
    package_dir={'mdblog': 'mdblog'},
    install_requires=['sanic','jinja2','fire','toml'],
    entry_points={
        'console_scripts': [
            'mdblog = mdblog.clitools.cli:main',
        ]
    },
