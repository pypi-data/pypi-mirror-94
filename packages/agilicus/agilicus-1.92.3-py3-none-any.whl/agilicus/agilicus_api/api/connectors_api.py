...
class ConnectorsApi(object):
    ...
    def list_agent_connector(self, **kwargs):  # noqa: E501
        ...
        list agent connectors. By default, agentConnectors will not show stats when listed to speed up the query. Setting the show_stats parameter to true retrieve the stats for every AgentConnector.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_agent_connector_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'org_id', 'name', 'show_stats']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_connector_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'org_id', 'name', 'type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
