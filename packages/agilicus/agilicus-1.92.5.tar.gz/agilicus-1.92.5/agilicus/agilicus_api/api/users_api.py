...
class UsersApi(object):
    ...
    def list_combined_user_details(self, **kwargs):  # noqa: E501
        ...
        :param str search_param: A string to perform a case-insensitive search on all relevant fields in the database for a given collection 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def list_combined_user_details_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['email', 'previous_email', 'org_id', 'limit', 'type', 'user_id', 'status', 'mfa_enrolled', 'auto_created', 'search_direction', 'prefix_email_search', 'allow_partial_match', 'first_name', 'last_name', 'search_param']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'search_param' in local_var_params and local_var_params['search_param'] is not None:  # noqa: E501
            query_params.append(('search_param', local_var_params['search_param']))  # noqa: E501
    ...
    def list_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['email', 'previous_email', 'provider', 'org_id', 'issuer', 'limit', 'type', 'upstream_user_id', 'upstream_idp_id', 'status', 'search_direction', 'has_roles', 'has_resource_roles', 'prefix_email_search', 'orgless_users', 'allow_partial_match', 'first_name', 'last_name', 'user_id', 'search_param']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
