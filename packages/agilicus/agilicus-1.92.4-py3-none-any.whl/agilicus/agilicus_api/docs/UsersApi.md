...
search_param = 'mat' # str | A string to perform a case-insensitive search on all relevant fields in the database for a given collection  (optional)
 ...
 **search_param** | **str**| A string to perform a case-insensitive search on all relevant fields in the database for a given collection  | [optional] 
