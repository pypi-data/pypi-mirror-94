import{_ as i,H as o,p as t,I as e,h as a,w as r,J as s,K as n,N as d,O as c,s as l,g as p,c as h}from"./e.0123aca4.js";import"./c.1f852ac8.js";import"./c.f038c8a3.js";import"./c.ce4d09bf.js";import"./c.20b0af85.js";import"./c.ffe212a3.js";import"./c.128de42a.js";let u=i([h("hacs-custom-repositories-dialog")],(function(i,o){return{F:class extends o{constructor(...o){super(...o),i(this)}},d:[{kind:"field",decorators:[t()],key:"_inputRepository",value:void 0},{kind:"field",decorators:[t()],key:"_error",value:void 0},{kind:"field",decorators:[e("#add-input")],key:"_addInput",value:void 0},{kind:"field",decorators:[e("#category")],key:"_addCategory",value:void 0},{kind:"method",key:"shouldUpdate",value:function(i){return i.has("narrow")||i.has("active")||i.has("_error")||i.has("repositories")}},{kind:"method",key:"render",value:function(){var i;if(!this.active)return a``;const o=null===(i=this.repositories)||void 0===i?void 0:i.filter(i=>i.custom);return a`
      <hacs-dialog
        .active=${this.active}
        .hass=${this.hass}
      ...
      >
        <div class="content">
          <div class="list">
            ...
            ${null==o?void 0:o.filter(i=>this.hacs.configuration.categories.includes(i.category)).map(i=>a`<paper-icon-item>
                  ${"integration"===i.category?a`
                        <img
                        ...
                        />
                      `:a`<ha-svg-icon .path=${r} slot="item-icon"></ha-svg-icon>`}
                  <paper-item-body
        ...
        <div class="add" slot="primaryaction" ?narrow=${this.narrow}>
          ...
          >
            <paper-listbox id="category" slot="dropdown-content" selected="-1">
              ${this.hacs.configuration.categories.map(i=>a`
